...
#ifndef __PINCTRL_MTK_MT6989_H
#define __PINCTRL_MTK_MT6989_H

#include "pinctrl-paris.h"

static const struct mtk_pin_desc mtk_pins_mt6989[] = {
	MTK_PIN_NODRV(
		0, "GPIO0",
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(3, "MD_GPS_L1_BLANK"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(1, "UARTHUB_UART_TX"),
		MTK_FUNCTION(2, "MD_MCIF_UTXD0"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(1, "UARTHUB_UART_RX"),
		MTK_FUNCTION(2, "MD_MCIF_URXD0"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(1, "BSI_CNS_VFE28_EN")
	),
	MTK_PIN_NODRV(
		148, "GPIO148",
		MTK_EINT_FUNCTION(NO_EINT_SUPPORT, NO_EINT_SUPPORT),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(3, "DMIC2_CLK"),
		MTK_FUNCTION(4, "TSFDC_RCK_SELB"),
		MTK_FUNCTION(5, "MD1_SIM2_SCLK")
	),
	MTK_PIN_NODRV(
		154, "GPIO154",
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(2, "PMSR_SMAP"),
		MTK_FUNCTION(3, "I2SIN3_BCK"),
		MTK_FUNCTION(4, "TSFDC_TSSEL0"),
		MTK_FUNCTION(5, "MD1_SIM2_SRST")
	),
	MTK_PIN_NODRV(
		156, "GPIO156",
		...
		MTK_FUNCTION(3, "I2SIN3_LRCK"),
		MTK_FUNCTION(4, "TSFDC_TSSEL1"),
		MTK_FUNCTION(5, "MD1_SIM2_SIO")
	),
	MTK_PIN_NODRV(
		157, "GPIO157",
		...
		MTK_FUNCTION(2, "CONN_TCXOENA_REQ"),
		MTK_FUNCTION(3, "I2SIN3_DI"),
		MTK_FUNCTION(4, "TSFDC_TSSEL2"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(2, "MD32_1_GPIO0"),
		MTK_FUNCTION(3, "I2SOUT3_DO"),
		MTK_FUNCTION(4, "TSFDC_EN"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(6, "HFRP_JTAG0_TRSTN"),
