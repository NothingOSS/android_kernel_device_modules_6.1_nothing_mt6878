...
#ifndef __PINCTRL_MTK_MT6985_H
#define __PINCTRL_MTK_MT6985_H

#include "pinctrl-paris.h"

static const struct mtk_pin_desc mtk_pins_mt6985[] = {
	MTK_PIN_NODRV(
		0, "GPIO0",
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(4, "PCIE_CLKREQN_P1"),
		MTK_FUNCTION(5, "I2S1_MCK"),
		MTK_FUNCTION(6, "TP_GPIO2_AO"),
		MTK_FUNCTION(7, "SDA12")
	),
	MTK_PIN_NODRV(
		3, "GPIO3",
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(2, "MD32_0_GPIO2"),
		MTK_FUNCTION(3, "MD32_2_GPIO2"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(2, "MD32_0_JTAG_TDO"),
		MTK_FUNCTION(3, "MD32_2_JTAG_TDO"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(2, "MD32_0_JTAG_TDI"),
		MTK_FUNCTION(3, "MD32_2_JTAG_TDI"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(2, "MD32_0_JTAG_TMS"),
		MTK_FUNCTION(3, "MD32_2_JTAG_TMS"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(4, "SF_D0"),
		MTK_FUNCTION(5, "HFRP_JTAG0_TRSTN"),
		MTK_FUNCTION(6, "CONN_BG_GPS_MCU_TRST_B"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(4, "SF_D1"),
		MTK_FUNCTION(5, "HFRP_JTAG0_TMS"),
		MTK_FUNCTION(6, "CONN_BG_GPS_MCU_TMS"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(4, "SF_D2"),
		MTK_FUNCTION(5, "HFRP_JTAG0_TCK"),
		MTK_FUNCTION(6, "CONN_BG_GPS_MCU_TCK"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(4, "SF_D3"),
		MTK_FUNCTION(5, "HFRP_JTAG0_TDI"),
		MTK_FUNCTION(6, "CONN_BG_GPS_MCU_TDI"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(4, "SF_CK"),
		MTK_FUNCTION(5, "HFRP_JTAG0_TDO"),
		MTK_FUNCTION(6, "CONN_BG_GPS_MCU_TDO"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(2, "I2S6_BCK"),
		MTK_FUNCTION(3, "MRG_CLK"),
		MTK_FUNCTION(4, "UCTS3"),
		MTK_FUNCTION(5, "I2S10_BCK"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(2, "I2S6_LRCK"),
		MTK_FUNCTION(3, "MRG_SYNC"),
		MTK_FUNCTION(4, "URTS3"),
		MTK_FUNCTION(5, "I2S10_LRCK"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(2, "MD32_0_JTAG_TCK"),
		MTK_FUNCTION(3, "MD32_2_JTAG_TCK"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(2, "MD32_0_JTAG_TRST"),
		MTK_FUNCTION(3, "MD32_2_JTAG_TRST"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(2, "I2S10_BCK"),
		MTK_FUNCTION(3, "CONN_BG_GPS_MCU_AICE_TCKC"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(2, "I2S10_LRCK"),
		MTK_FUNCTION(3, "CONN_BG_GPS_MCU_AICE_TMSC"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(3, "PTA_TXD1"),
		MTK_FUNCTION(4, "DSI2_TE"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(5, "MFG_TSFDC_TSSEL2"),
		MTK_FUNCTION(6, "SPM_JTAG_TCK_VCORE"),
		MTK_FUNCTION(7, "TSFDC_TSSEL2")
	),
	MTK_PIN_NODRV(
		104, "GPIO104",
		...
		MTK_FUNCTION(5, "MFG_TSFDC_TSSEL1"),
		MTK_FUNCTION(6, "SPM_JTAG_TMS_VCORE"),
		MTK_FUNCTION(7, "TSFDC_TSSEL1")
	),
	MTK_PIN_NODRV(
		105, "GPIO105",
		...
		MTK_FUNCTION(5, "MFG_TSFDC_TSSEL0"),
		MTK_FUNCTION(6, "SPM_JTAG_TDI_VCORE"),
		MTK_FUNCTION(7, "TSFDC_TSSEL0")
	),
	MTK_PIN_NODRV(
		106, "GPIO106",
		...
		MTK_FUNCTION(5, "MFG_TSFDC_RCK_SELB"),
		MTK_FUNCTION(6, "SPM_JTAG_TDO_VCORE"),
		MTK_FUNCTION(7, "TSFDC_RCK_SELB")
	),
	MTK_PIN_NODRV(
		107, "GPIO107",
		...
		MTK_FUNCTION(5, "MFG_TSFDC_EN"),
		MTK_FUNCTION(6, "SPM_JTAG_TRSTN_VCORE"),
		MTK_FUNCTION(7, "TSFDC_EN")
	),
	MTK_PIN_NODRV(
		108, "GPIO108",
		...
		MTK_FUNCTION(5, "MFG_TSFDC_VCO_RST"),
		MTK_FUNCTION(6, "SSPM_URXD_AO_VCORE"),
		MTK_FUNCTION(7, "TSFDC_VCO_RST")
	),
	MTK_PIN_NODRV(
		109, "GPIO109",
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(2, "MFG_TSFDC_SDI"),
		MTK_FUNCTION(3, "MIPI3_D_SDATA"),
		MTK_FUNCTION(4, "CLKM1"),
		MTK_FUNCTION(5, "MFG_TSFDC_SDI"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(2, "MFG_TSFDC_FOUT"),
		MTK_FUNCTION(4, "DSI_TE"),
		MTK_FUNCTION(5, "UFS_MPHY_SDA"),
		MTK_FUNCTION(6, "TP_UTXD3_VCORE")
	),
	MTK_PIN_NODRV(
		125, "GPIO125",
		MTK_EINT_FUNCTION(NO_EINT_SUPPORT, NO_EINT_SUPPORT),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(7, "CONN_BG_GPS_MCU_UART1_RXD")
	),
	MTK_PIN_NODRV(
		142, "GPIO142",
		...
		MTK_FUNCTION(7, "CONN_BG_GPS_MCU_UART1_TXD")
	),
	MTK_PIN_NODRV(
		143, "GPIO143",
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(1, "I2S6_BCK")
	),
	MTK_PIN_NODRV(
		200, "GPIO200",
		MTK_EINT_FUNCTION(0, 200),
		MTK_FUNCTION(0, "GPIO200"),
		MTK_FUNCTION(1, "I2S6_LRCK"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(1, "SPI4_B_MO")
	),
	MTK_PIN_NODRV(
		205, "GPIO205",
		MTK_EINT_FUNCTION(NO_EINT_SUPPORT, NO_EINT_SUPPORT),
		MTK_FUNCTION(0, "GPIO205"),
		MTK_FUNCTION(1, "SPI4_B_CSB")
	),
	MTK_PIN_NODRV(
		206, "GPIO206",
		MTK_EINT_FUNCTION(NO_EINT_SUPPORT, NO_EINT_SUPPORT),
		MTK_FUNCTION(0, "GPIO206"),
		MTK_FUNCTION(1, "SPI4_B_MI")
	),
	MTK_PIN_NODRV(
		207, "GPIO207",
		MTK_EINT_FUNCTION(NO_EINT_SUPPORT, NO_EINT_SUPPORT),
		MTK_FUNCTION(0, "GPIO207"),
		MTK_FUNCTION(1, "SPI4_B_CLK")
	),
	MTK_PIN_NODRV(
		208, "GPIO208",
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(1, "MMW_MIPI0_SCLK"),
		MTK_FUNCTION(3, "SCL12"),
		MTK_FUNCTION(4, "LCM2_RST"),
		MTK_FUNCTION(5, "UCTS2"),
		MTK_FUNCTION(6, "DMIC1_CLK")
	),
	MTK_PIN_NODRV(
		212, "GPIO212",
		...
		MTK_FUNCTION(1, "MMW_MIPI0_SDATA"),
		MTK_FUNCTION(3, "SDA12"),
		MTK_FUNCTION(5, "URTS2"),
		MTK_FUNCTION(6, "DMIC1_DAT")
	),
	MTK_PIN_NODRV(
		213, "GPIO213",
		...
		MTK_FUNCTION(1, "MMW_MIPI1_SCLK"),
		MTK_FUNCTION(3, "SCL13"),
		MTK_FUNCTION(6, "DMIC2_CLK")
	),
	MTK_PIN_NODRV(
		214, "GPIO214",
		...
		MTK_FUNCTION(1, "MMW_MIPI1_SDATA"),
		MTK_FUNCTION(3, "SDA13"),
		MTK_FUNCTION(6, "DMIC2_DAT")
	),
	MTK_PIN_NODRV(
		215, "GPIO215",
		...
		MTK_FUNCTION(1, "MMW_DIQ_MIPI_M_SCLK"),
		MTK_FUNCTION(2, "SCL11"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(1, "MMW_DIQ_MIPI_M_SDATA"),
		MTK_FUNCTION(2, "SDA11"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(4, "I2S9_MCK"),
		MTK_FUNCTION(5, "SRCLKENAI1"),
		MTK_FUNCTION(6, "DSI2_TE")
	),
	MTK_PIN_NODRV(
		218, "GPIO218",
		MTK_EINT_FUNCTION(NO_EINT_SUPPORT, NO_EINT_SUPPORT),
		MTK_FUNCTION(0, "GPIO218"),
		MTK_FUNCTION(1, "MMW_IRQ"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(1, "MD_DATAACNT_A_TGL"),
		MTK_FUNCTION(2, "MD_UCNT_A_TGL"),
		MTK_FUNCTION(3, "I2S6_DI"),
		MTK_FUNCTION(4, "SCL4")
	),
	MTK_PIN_NODRV(
		220, "GPIO220",
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(2, "UARTHUB_UART_TX"),
		MTK_FUNCTION(3, "URXD3"),
		MTK_FUNCTION(4, "MD_MCIF_UTXD0")
	),
	MTK_PIN_NODRV(
		225, "GPIO225",
		...
		MTK_FUNCTION(2, "UARTHUB_UART_RX"),
		MTK_FUNCTION(3, "UTXD3"),
		MTK_FUNCTION(4, "MD_MCIF_URXD0")
	),
	MTK_PIN_NODRV(
		226, "GPIO226",
		...
		MTK_FUNCTION(2, "PTA_TXD1"),
		MTK_FUNCTION(3, "PTA_RXD0")
	),
	MTK_PIN_NODRV(
		227, "GPIO227",
		...
		MTK_FUNCTION(2, "PTA_RXD1"),
		MTK_FUNCTION(3, "PTA_TXD0")
	),
	MTK_PIN_NODRV(
		228, "GPIO228",
		MTK_EINT_FUNCTION(0, 228),
		MTK_FUNCTION(0, "GPIO228"),
		MTK_FUNCTION(1, "TP_UTXD3_VLP"),
		MTK_FUNCTION(2, "TP_URXD3_VLP")
	),
	MTK_PIN_NODRV(
		229, "GPIO229",
		MTK_EINT_FUNCTION(0, 229),
		MTK_FUNCTION(0, "GPIO229"),
		MTK_FUNCTION(1, "TP_URXD3_VLP"),
		MTK_FUNCTION(2, "TP_UTXD3_VLP")
	),
	MTK_PIN_NODRV(
		230, "GPIO230",
