...
#ifndef __PINCTRL_MTK_MT6897_H
#define __PINCTRL_MTK_MT6897_H

#include "pinctrl-paris.h"

static const struct mtk_pin_desc mtk_pins_mt6897[] = {
	MTK_PIN_NODRV(
		0, "GPIO0",
		MTK_EINT_FUNCTION(0, 0),
		MTK_FUNCTION(0, "GPIO0"),
		MTK_FUNCTION(3, "FMI2S_LRCK"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(2, "DSI2_TE_VLP"),
		MTK_FUNCTION(3, "FMI2S_DI"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(4, "BPI_BUS23"),
		MTK_FUNCTION(5, "CONN_BPI_BUS23")
	),
	MTK_PIN_NODRV(
		9, "GPIO9",
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(3, "DMIC4_DAT"),
		MTK_FUNCTION(4, "ANT_SEL17"),
		MTK_FUNCTION(5, "BPI_BUS17"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(5, "ADSP_JTAG1_TRSTN"),
		MTK_FUNCTION(6, "SCP_JTAG0_TRSTN_VCORE"),
		MTK_FUNCTION(7, "CONN_WF_MCU_TRST_B")
	),
	MTK_PIN_NODRV(
		21, "GPIO21",
		...
		MTK_FUNCTION(5, "ADSP_JTAG1_TCK"),
		MTK_FUNCTION(6, "SCP_JTAG0_TCK_VCORE"),
		MTK_FUNCTION(7, "CONN_WF_MCU_TCK")
	),
	MTK_PIN_NODRV(
		22, "GPIO22",
		...
		MTK_FUNCTION(5, "ADSP_JTAG1_TMS"),
		MTK_FUNCTION(6, "SCP_JTAG0_TMS_VCORE"),
		MTK_FUNCTION(7, "CONN_WF_MCU_TMS")
	),
	MTK_PIN_NODRV(
		23, "GPIO23",
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(5, "ADSP_JTAG1_TDI"),
		MTK_FUNCTION(6, "SCP_JTAG0_TDI_VCORE"),
		MTK_FUNCTION(7, "CONN_WF_MCU_TDI")
	),
	MTK_PIN_NODRV(
		25, "GPIO25",
		...
		MTK_FUNCTION(4, "CONN_BPI_BUS20"),
		MTK_FUNCTION(5, "ANT_SEL20")
	),
	MTK_PIN_NODRV(
		26, "GPIO26",
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(3, "DMIC3_DAT"),
		MTK_FUNCTION(4, "ANT_SEL15"),
		MTK_FUNCTION(5, "BPI_BUS15"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(1, "SPI0_HOLD"),
		MTK_FUNCTION(2, "MD_INT3"),
		MTK_FUNCTION(3, "TP_GPIO15_AO"),
		MTK_FUNCTION(6, "SRCLKENA1")
	),
	MTK_PIN_NODRV(
		45, "GPIO45",
		MTK_EINT_FUNCTION(0, 45),
		MTK_FUNCTION(0, "GPIO45"),
		MTK_FUNCTION(1, "SPI0_WP"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(7, "CONN_WF_MCU_AICE_TCKC")
	),
	MTK_PIN_NODRV(
		77, "GPIO77",
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(2, "I2SIN6_0_BCK"),
		MTK_FUNCTION(3, "TP_GPIO11_AO"),
		MTK_FUNCTION(4, "CONN_BGF_DSP_L1_JCK"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(2, "I2SIN6_0_LRCK"),
		MTK_FUNCTION(3, "TP_GPIO12_AO"),
		MTK_FUNCTION(4, "CONN_BGF_DSP_L1_JMS"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(2, "I2SIN6_0_DI"),
		MTK_FUNCTION(3, "TP_GPIO13_AO"),
		MTK_FUNCTION(4, "CONN_BGF_DSP_L1_JDI"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(2, "SCP_SCL6"),
		MTK_FUNCTION(3, "TP_GPIO14_AO"),
		MTK_FUNCTION(4, "CONN_BGF_DSP_L1_JDO"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(2, "SCP_SDA6"),
		MTK_FUNCTION(3, "TP_GPIO15_AO"),
		MTK_FUNCTION(4, "CONN_BGF_DSP_L1_JINTP"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(2, "CONN_MIPI2_SCLK"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(2, "CONN_MIPI2_SDATA"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(1, "PWM_1"),
		MTK_FUNCTION(2, "I2SOUT0_DO"),
		MTK_FUNCTION(3, "BPI_BUS19"),
		MTK_FUNCTION(4, "ANT_SEL19"),
		MTK_FUNCTION(5, "CMVREF7")
	),
	MTK_PIN_NODRV(
		121, "GPIO121",
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(2, "I2SIN0_DI"),
		MTK_FUNCTION(3, "BPI_BUS18"),
		MTK_FUNCTION(4, "ANT_SEL18"),
		MTK_FUNCTION(5, "CMVREF6")
	),
	MTK_PIN_NODRV(
		129, "GPIO129",
		MTK_EINT_FUNCTION(NO_EINT_SUPPORT, NO_EINT_SUPPORT),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(3, "SPMI_M_TRIG_FLAG")
	),
	MTK_PIN_NODRV(
		135, "GPIO135",
		MTK_EINT_FUNCTION(NO_EINT_SUPPORT, NO_EINT_SUPPORT),
		MTK_FUNCTION(0, "GPIO135"),
		MTK_FUNCTION(1, "SCP_DMIC_CLK"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(4, "DSI_TE"),
		MTK_FUNCTION(6, "MD32_2_GPIO0"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(4, "LCM_RST"),
		MTK_FUNCTION(6, "MD32_3_GPIO0"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(1, "SCL4"),
		MTK_FUNCTION(5, "UDI_TDO_2"),
		MTK_FUNCTION(6, "MFG_TSFDC_TSSEL2")
	),
	MTK_PIN_NODRV(
		146, "GPIO146",
		MTK_EINT_FUNCTION(NO_EINT_SUPPORT, NO_EINT_SUPPORT),
		...
		MTK_FUNCTION(1, "SDA4"),
		MTK_FUNCTION(5, "UDI_TDO_3"),
		MTK_FUNCTION(6, "MFG_TSFDC_TSSEL1")
	),
	MTK_PIN_NODRV(
		147, "GPIO147",
		MTK_EINT_FUNCTION(NO_EINT_SUPPORT, NO_EINT_SUPPORT),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(5, "UDI_TDO_4"),
		MTK_FUNCTION(6, "MFG_TSFDC_26M")
	),
	MTK_PIN_NODRV(
		154, "GPIO154",
		MTK_EINT_FUNCTION(NO_EINT_SUPPORT, NO_EINT_SUPPORT),
		...
		MTK_FUNCTION(5, "UDI_TDO_5"),
		MTK_FUNCTION(6, "MFG_TSFDC_SCF")
	),
	MTK_PIN_NODRV(
		155, "GPIO155",
		MTK_EINT_FUNCTION(NO_EINT_SUPPORT, NO_EINT_SUPPORT),
		...
		MTK_FUNCTION(5, "UDI_TDO_6"),
		MTK_FUNCTION(6, "MFG_TSFDC_FOUT")
	),
	MTK_PIN_NODRV(
		156, "GPIO156",
		MTK_EINT_FUNCTION(NO_EINT_SUPPORT, NO_EINT_SUPPORT),
		...
		MTK_FUNCTION(5, "UDI_TDO_7"),
		MTK_FUNCTION(6, "MFG_TSFDC_SDO")
	),
	MTK_PIN_NODRV(
		157, "GPIO157",
		MTK_EINT_FUNCTION(NO_EINT_SUPPORT, NO_EINT_SUPPORT),
		...
		MTK_FUNCTION(3, "URXD2"),
		MTK_FUNCTION(4, "BPI_BUS13"),
		MTK_FUNCTION(5, "CMVREF0"),
		MTK_FUNCTION(6, "MFG_TSFDC_EN")
	),
	MTK_PIN_NODRV(
		158, "GPIO158",
		MTK_EINT_FUNCTION(NO_EINT_SUPPORT, NO_EINT_SUPPORT),
		...
		MTK_FUNCTION(5, "CMVREF1"),
		MTK_FUNCTION(6, "MFG_TSFDC_VCO_RST")
	),
	MTK_PIN_NODRV(
		159, "GPIO159",
		MTK_EINT_FUNCTION(NO_EINT_SUPPORT, NO_EINT_SUPPORT),
		...
		MTK_FUNCTION(6, "MFG_TSFDC_TSSEL0")
	),
	MTK_PIN_NODRV(
		160, "GPIO160",
		MTK_EINT_FUNCTION(NO_EINT_SUPPORT, NO_EINT_SUPPORT),
		...
		MTK_FUNCTION(4, "ANT_SEL17"),
		MTK_FUNCTION(5, "CMVREF5"),
		MTK_FUNCTION(6, "MFG_TSFDC_RCK_SELB")
	),
	MTK_PIN_NODRV(
		161, "GPIO161",
		MTK_EINT_FUNCTION(NO_EINT_SUPPORT, NO_EINT_SUPPORT),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(2, "PCIE_PERSTN"),
		MTK_FUNCTION(4, "BPI_BUS0"),
		MTK_FUNCTION(5, "CMVREF0")
	),
	MTK_PIN_NODRV(
		174, "GPIO174",
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(3, "TP_URXD_CONSYS_VLP"),
		MTK_FUNCTION(4, "CONN_BGF_DSP_L5_JDO"),
		MTK_FUNCTION(5, "SCP_JTAG_LITTLE_TDO_VLP"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(3, "TP_UTXD_CONSYS_VLP"),
		MTK_FUNCTION(4, "CONN_BGF_DSP_L5_JINTP"),
		MTK_FUNCTION(5, "SCP_JTAG_LITTLE_TRSTN_VLP"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(2, "PRE_ANT_TRIG"),
		MTK_FUNCTION(4, "CONN_BGF_DSP_L5_JCK"),
		MTK_FUNCTION(5, "SCP_JTAG_LITTLE_TCK_VLP"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(2, "CONN_VFE_REQ"),
		MTK_FUNCTION(4, "CONN_BGF_DSP_L5_JMS"),
		MTK_FUNCTION(5, "SCP_JTAG_LITTLE_TMS_VLP"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(3, "UARTHUB_UART_RX"),
		MTK_FUNCTION(4, "CONN_BGF_DSP_L5_JDI"),
		MTK_FUNCTION(5, "SCP_JTAG_LITTLE_TDI_VLP"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(3, "UARTHUB_UART_TX"),
		MTK_FUNCTION(4, "BPI_BUS8"),
		MTK_FUNCTION(5, "CMVREF1")
	),
	MTK_PIN_NODRV(
		182, "GPIO182",
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(1, "ANT_SEL11"),
		MTK_FUNCTION(2, "I2SIN6_0_BCK"),
		MTK_FUNCTION(3, "PTA_EXT_FREQ"),
		MTK_FUNCTION(4, "BPI_BUS11"),
		MTK_FUNCTION(5, "CMVREF4"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(1, "ANT_SEL12"),
		MTK_FUNCTION(2, "I2SIN6_0_LRCK"),
		MTK_FUNCTION(3, "PTA_EXT_ACT"),
		MTK_FUNCTION(4, "BPI_BUS12"),
		MTK_FUNCTION(5, "CMVREF5"),
	...
	MTK_PIN_NODRV(
		...
		MTK_FUNCTION(3, "CONN_BPI_BUS23")
	),
	MTK_PIN_NODRV(
		189, "GPIO189",
		MTK_EINT_FUNCTION(NO_EINT_SUPPORT, NO_EINT_SUPPORT),
		MTK_FUNCTION(0, "GPIO189"),
		MTK_FUNCTION(4, "LCM2_RST")
	),
	MTK_PIN_NODRV(
		190, "GPIO190",
		MTK_EINT_FUNCTION(NO_EINT_SUPPORT, NO_EINT_SUPPORT),
	...
	MTK_PIN_EINT(232, 232),
	MTK_PIN_EINT(233, 233),
	...
	MTK_PIN_EINT(245, 245),
	MTK_PIN_EINT(246, 246),
	MTK_PIN_EINT(247, 247),
	MTK_PIN_EINT(248, 248),
	MTK_PIN_EINT(249, 249),
};

#endif /* __PINCTRL_MTK_MT6897_H */
