		...
		void __iomem *apmixed_base)
{
	...
	while (data->dds_mask != 0) {
		...
		FHDBG("pll<%s>, dds_mask<%d>, data<%lx> offset<%lx> regs<%lx>\n",
				data->name, data->dds_mask, (unsigned long)data,
				(unsigned long)offset, (unsigned long)regs);
		data++;
		offset++;
		regs++;
	}
...
/* 6886 begin */
#define SIZE_6886_MCU0 (sizeof(mt6886_mcu0_data)\
	/sizeof(struct fh_pll_data))
#define SIZE_6886_MCU1 (sizeof(mt6886_mcu1_data)\
	/sizeof(struct fh_pll_data))
#define SIZE_6886_MCU2 (sizeof(mt6886_mcu2_data)\
	/sizeof(struct fh_pll_data))
#define SIZE_6886_MCU3 (sizeof(mt6886_mcu3_data)\
	/sizeof(struct fh_pll_data))
#define SIZE_6886_TOP (sizeof(mt6886_top_data)\
	/sizeof(struct fh_pll_data))
#define SIZE_6886_APU0 (sizeof(mt6886_apu0_data)\
	/sizeof(struct fh_pll_data))
#define SIZE_6886_APU1 (sizeof(mt6886_apu1_data)\
	/sizeof(struct fh_pll_data))
#define SIZE_6886_APU2 (sizeof(mt6886_apu2_data)\
	/sizeof(struct fh_pll_data))
#define SIZE_6886_GPU0 (sizeof(mt6886_gpu0_data)\
	/sizeof(struct fh_pll_data))
#define SIZE_6886_GPU1 (sizeof(mt6886_gpu1_data)\
	/sizeof(struct fh_pll_data))
#define SIZE_6886_GPU2 (sizeof(mt6886_gpu2_data)\
	/sizeof(struct fh_pll_data))
#define SIZE_6886_GPU3 (sizeof(mt6886_gpu3_data)\
	/sizeof(struct fh_pll_data))

#define DATA_6886_CONVERT(_name) {				\
		.name = _name,						\
		.dds_mask = GENMASK(21, 0),			\
		.slope0_value = 0x6003c97,			\
		.slope1_value = 0x6003c97,			\
...
#define REG_6886_CONVERT(_fhctl, _con_pcw) {	\
		.offset_fhctl = _fhctl,				\
		.offset_con_pcw = _con_pcw,			\
		.offset_hp_en = 0x0,				\
		.offset_clk_con = 0x8,				\
...
#define REG_6886_TINYSYS_CONVERT(_fhctl, _con_pcw) {	\
		.offset_fhctl = _fhctl,				\
		.offset_con_pcw = _con_pcw,			\
		.offset_hp_en = 0x0,				\
		.offset_clk_con = 0x8,				\
...
static struct fh_pll_data mt6886_top_data[] = {
	DATA_6886_CONVERT("emptypll1"),
	DATA_6886_CONVERT("emptypll2"),
	DATA_6886_CONVERT("emptypll3"),
	DATA_6886_CONVERT("emptypll4"),
	DATA_6886_CONVERT("mempll "),
	DATA_6886_CONVERT("emipll"),
	DATA_6886_CONVERT("mpll"),
	DATA_6886_CONVERT("mmpll"),
	DATA_6886_CONVERT("mainpll"),
	DATA_6886_CONVERT("msdcpll "),
	DATA_6886_CONVERT("adsppll"),
	DATA_6886_CONVERT("imgpll"),
	DATA_6886_CONVERT("ufspll"),
	{}
};
static struct fh_pll_offset mt6886_top_offset[SIZE_6886_TOP] = {
	REG_6886_CONVERT(0x003C, 0x020C),  //	DATA_6886_CONVERT("emptypll1"),
	REG_6886_CONVERT(0x0050, 0x021C),  //	DATA_6886_CONVERT("emptypll2"),
	REG_6886_CONVERT(0x0064, 0x022C),  //	DATA_6886_CONVERT("emptypll3"),
	REG_6886_CONVERT(0x0078, 0x023C),  //	DATA_6886_CONVERT("emptypll4"),
	REG_6886_CONVERT(0x008C, 0xffff),  //	DATA_6886_CONVERT("mempll"),
	REG_6886_CONVERT(0x00A0, 0x03B4),  //	DATA_6886_CONVERT("emipll"),
	REG_6886_CONVERT(0x00B4, 0x0394),  //	DATA_6886_CONVERT("mpll"),
	REG_6886_CONVERT(0x00C8, 0x03A4),  //	DATA_6886_CONVERT("mmpll"),
	REG_6886_CONVERT(0x00DC, 0x0354),  //	DATA_6886_CONVERT("mainpll"),
	REG_6886_CONVERT(0x00F0, 0x0364),  //	DATA_6886_CONVERT("msdcpll "),
	REG_6886_CONVERT(0x0104, 0x0384),  //	DATA_6886_CONVERT("adsppll"),
	REG_6886_CONVERT(0x0118, 0x0374),  //	DATA_6886_CONVERT("imgpll"),
	REG_6886_CONVERT(0x012c, 0x024c),  //	DATA_6886_CONVERT("ufspll"),
	{}
};
static struct fh_pll_regs mt6886_top_regs[SIZE_6886_TOP];
static struct fh_pll_domain mt6886_top = {
	.name = "top",
	.data = (struct fh_pll_data *)&mt6886_top_data,
	.offset = (struct fh_pll_offset *)&mt6886_top_offset,
	.regs = (struct fh_pll_regs *)&mt6886_top_regs,
	.init = &init_v1,
};
///////////////////////////////////MCU0
static struct fh_pll_data mt6886_mcu0_data[] = {
	DATA_6886_CONVERT("ccipll"),
	{}
};
static struct fh_pll_offset mt6886_mcu0_offset[SIZE_6886_MCU0] = {
	REG_6886_TINYSYS_CONVERT(0x14, 0xC),
	{}
};
static struct fh_pll_regs mt6886_mcu0_regs[SIZE_6886_MCU0];
static struct fh_pll_domain mt6886_mcu0 = {
	.name = "mcu0",
	.data = (struct fh_pll_data *)&mt6886_mcu0_data,
	.offset = (struct fh_pll_offset *)&mt6886_mcu0_offset,
	.regs = (struct fh_pll_regs *)&mt6886_mcu0_regs,
	.init = &init_v1,
};
///////////////////////////////////MCU1
static struct fh_pll_data mt6886_mcu1_data[] = {
	DATA_6886_CONVERT("armpll_ll"),
	{}
};
static struct fh_pll_offset mt6886_mcu1_offset[SIZE_6886_MCU1] = {
	REG_6886_TINYSYS_CONVERT(0x14, 0xC),
	{}
};
static struct fh_pll_regs mt6886_mcu1_regs[SIZE_6886_MCU1];
static struct fh_pll_domain mt6886_mcu1 = {
	.name = "mcu1",
	.data = (struct fh_pll_data *)&mt6886_mcu1_data,
	.offset = (struct fh_pll_offset *)&mt6886_mcu1_offset,
	.regs = (struct fh_pll_regs *)&mt6886_mcu1_regs,
	.init = &init_v1,
};
///////////////////////////////////MCU2
static struct fh_pll_data mt6886_mcu2_data[] = {
	DATA_6886_CONVERT("armpll_bl"),
	{}
};
static struct fh_pll_offset mt6886_mcu2_offset[SIZE_6886_MCU2] = {
	REG_6886_TINYSYS_CONVERT(0x14, 0xC),
	{}
};
static struct fh_pll_regs mt6886_mcu2_regs[SIZE_6886_MCU2];
static struct fh_pll_domain mt6886_mcu2 = {
	.name = "mcu2",
	.data = (struct fh_pll_data *)&mt6886_mcu2_data,
	.offset = (struct fh_pll_offset *)&mt6886_mcu2_offset,
	.regs = (struct fh_pll_regs *)&mt6886_mcu2_regs,
	.init = &init_v1,
};
///////////////////////////////////MCU3
static struct fh_pll_data mt6886_mcu3_data[] = {
	DATA_6886_CONVERT("ptppll"),
	{}
};
static struct fh_pll_offset mt6886_mcu3_offset[SIZE_6886_MCU3] = {
	REG_6886_TINYSYS_CONVERT(0x14, 0xC),
	{}
};
static struct fh_pll_regs mt6886_mcu3_regs[SIZE_6886_MCU3];
static struct fh_pll_domain mt6886_mcu3 = {
	.name = "mcu3",
	.data = (struct fh_pll_data *)&mt6886_mcu3_data,
	.offset = (struct fh_pll_offset *)&mt6886_mcu3_offset,
	.regs = (struct fh_pll_regs *)&mt6886_mcu3_regs,
	.init = &init_v1,
};
///////////////////////////////////APU0
static struct fh_pll_data mt6886_apu0_data[] = {
	DATA_6886_CONVERT("apu_accgrp_0"),
	{}
};
static struct fh_pll_offset mt6886_apu0_offset[SIZE_6886_APU0] = {
	REG_6886_TINYSYS_CONVERT(0x14, 0xC),
	{}
};
static struct fh_pll_regs mt6886_apu0_regs[SIZE_6886_APU0];
static struct fh_pll_domain mt6886_apu0 = {
	.name = "apu0",
	.data = (struct fh_pll_data *)&mt6886_apu0_data,
	.offset = (struct fh_pll_offset *)&mt6886_apu0_offset,
	.regs = (struct fh_pll_regs *)&mt6886_apu0_regs,
	.init = &init_v1,
};
///////////////////////////////////APU1

static struct fh_pll_data mt6886_apu1_data[] = {
	DATA_6886_CONVERT("apu_accgrp_1"),
	{}
};
static struct fh_pll_offset mt6886_apu1_offset[SIZE_6886_APU1] = {
	REG_6886_TINYSYS_CONVERT(0x14, 0xC),
	{}
};
static struct fh_pll_regs mt6886_apu1_regs[SIZE_6886_APU1];
static struct fh_pll_domain mt6886_apu1 = {
	.name = "apu1",
	.data = (struct fh_pll_data *)&mt6886_apu1_data,
	.offset = (struct fh_pll_offset *)&mt6886_apu1_offset,
	.regs = (struct fh_pll_regs *)&mt6886_apu1_regs,
	.init = &init_v1,
};

///////////////////////////////////APU2
static struct fh_pll_data mt6886_apu2_data[] = {
	DATA_6886_CONVERT("apu_accgrp_2"),
	{}
};
static struct fh_pll_offset mt6886_apu2_offset[SIZE_6886_APU2] = {
	REG_6886_TINYSYS_CONVERT(0x14, 0xC),
	{}
};
static struct fh_pll_regs mt6886_apu2_regs[SIZE_6886_APU2];
static struct fh_pll_domain mt6886_apu2 = {
	.name = "apu2",
	.data = (struct fh_pll_data *)&mt6886_apu2_data,
	.offset = (struct fh_pll_offset *)&mt6886_apu2_offset,
	.regs = (struct fh_pll_regs *)&mt6886_apu2_regs,
	.init = &init_v1,
};

///////////////////////////////////gpu0
static struct fh_pll_data mt6886_gpu0_data[] = {
	DATA_6886_CONVERT("mfgpll"),
	{}
};
static struct fh_pll_offset mt6886_gpu0_offset[SIZE_6886_GPU0] = {
	REG_6886_TINYSYS_CONVERT(0x14, 0xC),
	{}
};
static struct fh_pll_regs mt6886_gpu0_regs[SIZE_6886_GPU0];
static struct fh_pll_domain mt6886_gpu0 = {
	.name = "gpu0",
	.data = (struct fh_pll_data *)&mt6886_gpu0_data,
	.offset = (struct fh_pll_offset *)&mt6886_gpu0_offset,
	.regs = (struct fh_pll_regs *)&mt6886_gpu0_regs,
	.init = &init_v1,
};
///////////////////////////////////gpu1

static struct fh_pll_data mt6886_gpu1_data[] = {
	DATA_6886_CONVERT("mfg_nr_clk"),
	{}
};
static struct fh_pll_offset mt6886_gpu1_offset[SIZE_6886_GPU1] = {
	REG_6886_TINYSYS_CONVERT(0x14, 0xC),
	{}
};
static struct fh_pll_regs mt6886_gpu1_regs[SIZE_6886_GPU1];
static struct fh_pll_domain mt6886_gpu1 = {
	.name = "gpu1",
	.data = (struct fh_pll_data *)&mt6886_gpu1_data,
	.offset = (struct fh_pll_offset *)&mt6886_gpu1_offset,
	.regs = (struct fh_pll_regs *)&mt6886_gpu1_regs,
	.init = &init_v1,
};

///////////////////////////////////gpu2
static struct fh_pll_data mt6886_gpu2_data[] = {
	DATA_6886_CONVERT("gpuebpll"),
	{}
};
static struct fh_pll_offset mt6886_gpu2_offset[SIZE_6886_GPU2] = {
	REG_6886_TINYSYS_CONVERT(0x14, 0xC),
	{}
};
static struct fh_pll_regs mt6886_gpu2_regs[SIZE_6886_GPU2];
static struct fh_pll_domain mt6886_gpu2 = {
	.name = "gpu2",
	.data = (struct fh_pll_data *)&mt6886_gpu2_data,
	.offset = (struct fh_pll_offset *)&mt6886_gpu2_offset,
	.regs = (struct fh_pll_regs *)&mt6886_gpu2_regs,
	.init = &init_v1,
};
///////////////////////////////////gpu3
static struct fh_pll_data mt6886_gpu3_data[] = {
	DATA_6886_CONVERT("mfgscpll"),
	{}
};
static struct fh_pll_offset mt6886_gpu3_offset[SIZE_6886_GPU3] = {
	REG_6886_TINYSYS_CONVERT(0x14, 0xC),
	{}
};
static struct fh_pll_regs mt6886_gpu3_regs[SIZE_6886_GPU3];
static struct fh_pll_domain mt6886_gpu3 = {
	.name = "gpu3",
	.data = (struct fh_pll_data *)&mt6886_gpu3_data,
	.offset = (struct fh_pll_offset *)&mt6886_gpu3_offset,
	.regs = (struct fh_pll_regs *)&mt6886_gpu3_regs,
	.init = &init_v1,
};

static struct fh_pll_domain *mt6886_domain[] = {
	&mt6886_mcu0,
	&mt6886_mcu1,
	&mt6886_mcu2,
	&mt6886_mcu3,
...
static struct match mt6886_match = {
	...
	.domain_list = (struct fh_pll_domain **)mt6886_domain,
};
/* 6886 end */
...
/* 6985 begin */
#define SIZE_6985_TOP (sizeof(mt6985_top_data)\
	/sizeof(struct fh_pll_data))
...
static struct fh_pll_data mt6985_top_data[] = {
...
static struct fh_pll_offset mt6985_top_offset[SIZE_6985_TOP] = {
...
static struct fh_pll_regs mt6985_top_regs[SIZE_6985_TOP];
static struct fh_pll_domain mt6985_top = {
	.name = "top",
	.data = (struct fh_pll_data *)&mt6985_top_data,
	.offset = (struct fh_pll_offset *)&mt6985_top_offset,
	.regs = (struct fh_pll_regs *)&mt6985_top_regs,
	.init = &init_v1,
};
