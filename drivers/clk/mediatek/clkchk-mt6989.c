...
enum {
	...
	CLK_PERAOP_AUDIO_SLV_CG = 410,
	CLK_PERAOP_AUDIO_MST_CG = 411,
	CLK_PERAOP_AUDIO_INTBUS_CG = 412,
	CLK_PERAOP_AUDIO_ENGEN1_CG = 413,
	CLK_PERAOP_AUDIO_ENGEN2_CG = 414,
	CLK_PERAOP_AUDIO_TDMOUT_B_CG = 415,
	CLK_PERAOP_AUDIO_H_AUD_CG = 416,
	CLK_PEXTP_P0_MAC_REF_CG = 417,
	CLK_PEXTP_P0_MAC_PL_P_CG = 418,
	CLK_PEXTP_P0_MAC_TL_CG = 419,
	CLK_PEXTP_P0_MAC_AXI_CG = 420,
	CLK_PEXTP_P0_MAC_AHB_APB_CG = 421,
	CLK_PEXTP_P0_PHY_REF_CG = 422,
	CLK_PEXTP_P0_PHY_MCU_BUS_CG = 423,
	CLK_PEXTP_P1_MAC_REF_CG = 424,
	CLK_PEXTP_P1_MAC_PL_P_CG = 425,
	CLK_PEXTP_P1_MAC_TL_CG = 426,
	CLK_PEXTP_P1_MAC_AXI_CG = 427,
	CLK_PEXTP_P1_MAC_AHB_APB_CG = 428,
	CLK_PEXTP_P1_PHY_REF_CG = 429,
	CLK_PEXTP_P1_PHY_MCU_BUS_CG = 430,
	CLK_UFSAO_UNIPRO_TX_SYM_CG = 431,
	CLK_UFSAO_UNIPRO_RX_SYM0_CG = 432,
	CLK_UFSAO_UNIPRO_RX_SYM1_CG = 433,
	CLK_UFSAO_UNIPRO_SYS_CG = 434,
	CLK_UFSAO_UNIPRO_PHY_SAP_CG = 435,
	CLK_UFSAO_PERI2UFS_BRIDGE_H_CG = 436,
	CLK_UFSPDN_UFSHCI_UFS_CG = 437,
	CLK_UFSPDN_UFSHCI_AES_CG = 438,
	CLK_UFSPDN_UFSHCI_U_AHB_CG = 439,
	CLK_UFSPDN_UFSHCI_U_AXI_CG = 440,
	CLK_IFRAO_DPMAIF_MAIN_CG = 441,
	CLK_IFRAO_RG_MMW_DPMAIF26M_CG = 442,
	CLK_IFRAO_RG_SOCSYS_FATB_CG = 443,
	CLK_IFRAO_RG_SOCSYS_SDF_CG = 444,
	CLK_MDP1_MDP_MUTEX0_CG = 445,
	CLK_MDP1_APB_BUS_CG = 446,
	CLK_MDP1_SMI0_CG = 447,
	CLK_MDP1_MDP_RDMA0_CG = 448,
	CLK_MDP1_MDP_RDMA2_CG = 449,
	CLK_MDP1_MDP_HDR0_CG = 450,
	CLK_MDP1_MDP_AAL0_CG = 451,
	CLK_MDP1_MDP_RSZ0_CG = 452,
	CLK_MDP1_MDP_TDSHP0_CG = 453,
	CLK_MDP1_MDP_COLOR0_CG = 454,
	CLK_MDP1_MDP_WROT0_CG = 455,
	CLK_MDP1_MDP_FAKE_ENG0_CG = 456,
	CLK_MDP1_MDP_DLI_ASYNC0_CG = 457,
	CLK_MDP1_MDP_DLI_ASYNC1_CG = 458,
	CLK_MDP1_APB_DB_CG = 459,
	CLK_MDP1_MDP_RDMA1_CG = 460,
	CLK_MDP1_MDP_RDMA3_CG = 461,
	CLK_MDP1_MDP_HDR1_CG = 462,
	CLK_MDP1_MDP_AAL1_CG = 463,
	CLK_MDP1_MDP_RSZ1_CG = 464,
	CLK_MDP1_MDP_TDSHP1_CG = 465,
	CLK_MDP1_MDP_COLOR1_CG = 466,
	CLK_MDP1_MDP_WROT1_CG = 467,
	CLK_MDP1_MDP_RSZ2_CG = 468,
	CLK_MDP1_MDP_WROT2_CG = 469,
	CLK_MDP1_MDP_DLO_ASYNC0_CG = 470,
	CLK_MDP1_MDP_RSZ3_CG = 471,
	CLK_MDP1_MDP_WROT3_CG = 472,
	CLK_MDP1_MDP_DLO_ASYNC1_CG = 473,
	CLK_MDP1_MDP_DLI_ASYNC2_CG = 474,
	CLK_MDP1_MDP_DLI_ASYNC3_CG = 475,
	CLK_MDP1_MDP_DLO_ASYNC2_CG = 476,
	CLK_MDP1_MDP_DLO_ASYNC3_CG = 477,
	CLK_MDP1_MDP_BIRSZ0_CG = 478,
	CLK_MDP1_MDP_BIRSZ1_CG = 479,
	CLK_MDP1_IMG_DL_ASYNC0_CG = 480,
	CLK_MDP1_IMG_DL_ASYNC1_CG = 481,
	CLK_MDP1_HRE_TOP_MDPSYS_CG = 482,
	CLK_MDP1_MDP_RROT0_CG = 483,
	CLK_MDP1_MDP_RROT0_2ND_CG = 484,
	CLK_MDP1_MDP_MERGE0_CG = 485,
	CLK_MDP1_MDP_C3D0_CG = 486,
	CLK_MDP1_MDP_FG0_CG = 487,
	CLK_MDP1_IMG_DL_RELAY0_CG = 488,
	CLK_MDP1_IMG_DL_RELAY1_CG = 489,
	CLK_MDP_MUTEX0_CG = 490,
	CLK_MDP_APB_BUS_CG = 491,
	CLK_MDP_SMI0_CG = 492,
	CLK_MDP_RDMA0_CG = 493,
	CLK_MDP_RDMA2_CG = 494,
	CLK_MDP_HDR0_CG = 495,
	CLK_MDP_AAL0_CG = 496,
	CLK_MDP_RSZ0_CG = 497,
	CLK_MDP_TDSHP0_CG = 498,
	CLK_MDP_COLOR0_CG = 499,
	CLK_MDP_WROT0_CG = 500,
	CLK_MDP_FAKE_ENG0_CG = 501,
	CLK_MDP_DLI_ASYNC0_CG = 502,
	CLK_MDP_DLI_ASYNC1_CG = 503,
	CLK_MDP_APB_DB_CG = 504,
	CLK_MDP_RDMA1_CG = 505,
	CLK_MDP_RDMA3_CG = 506,
	CLK_MDP_HDR1_CG = 507,
	CLK_MDP_AAL1_CG = 508,
	CLK_MDP_RSZ1_CG = 509,
	CLK_MDP_TDSHP1_CG = 510,
	CLK_MDP_COLOR1_CG = 511,
	CLK_MDP_WROT1_CG = 512,
	CLK_MDP_RSZ2_CG = 513,
	CLK_MDP_WROT2_CG = 514,
	CLK_MDP_DLO_ASYNC0_CG = 515,
	CLK_MDP_RSZ3_CG = 516,
	CLK_MDP_WROT3_CG = 517,
	CLK_MDP_DLO_ASYNC1_CG = 518,
	CLK_MDP_DLI_ASYNC2_CG = 519,
	CLK_MDP_DLI_ASYNC3_CG = 520,
	CLK_MDP_DLO_ASYNC2_CG = 521,
	CLK_MDP_DLO_ASYNC3_CG = 522,
	CLK_MDP_BIRSZ0_CG = 523,
	CLK_MDP_BIRSZ1_CG = 524,
	CLK_MDP_IMG_DL_ASYNC0_CG = 525,
	CLK_MDP_IMG_DL_ASYNC1_CG = 526,
	CLK_MDP_HRE_TOP_MDPSYS_CG = 527,
	CLK_MDP_RROT0_CG = 528,
	CLK_MDP_RROT0_2ND_CG = 529,
	CLK_MDP_MERGE0_CG = 530,
	CLK_MDP_C3D0_CG = 531,
	CLK_MDP_FG0_CG = 532,
	CLK_MDP_IMG_DL_RELAY0_CG = 533,
