...
static const struct mtk_gate afe_clks[] = {
	...
	/* AFE2 */
	GATE_AFE2(CLK_AFE_DMIC1_ADC_HIRES_TML, "afe_dmic1_adc_tml",
			"audio_h_ck"/* parent */, 0),
	...
	GATE_AFE2(CLK_AFE_DMIC1_ADC, "afe_dmic1_adc",
			"f26m_ck"/* parent */, 3),
	GATE_AFE2(CLK_AFE_DMIC0_ADC_HIRES_TML, "afe_dmic0_adc_tml",
			"audio_h_ck"/* parent */, 4),
	...
	GATE_AFE2(CLK_AFE_DMIC0_ADC, "afe_dmic0_adc",
			"f26m_ck"/* parent */, 7),
	GATE_AFE2(CLK_AFE_UL1_ADC_HIRES_TML, "afe_ul1_adc_tml",
	...
	GATE_AFE2(CLK_AFE_UL1_ADC, "afe_ul1_adc",
			"f26m_ck"/* parent */, 19),
	GATE_AFE2(CLK_AFE_UL0_ADC_HIRES_TML, "afe_ul0_adc_tml",
	...
	GATE_AFE3(CLK_AFE_ETDM_IN2, "afe_etdm_in2",
			"audio_h_ck"/* parent */, 10),
	GATE_AFE3(CLK_AFE_ETDM_IN1, "afe_etdm_in1",
			"audio_h_ck"/* parent */, 11),
...
static const struct of_device_id of_match_clk_mt6897_adsp[] = {
	{
		.compatible = "mediatek,mt6897-audiosys",
		.data = &afe_mcd,
	}, {
		/* sentinel */
	}
...
static int clk_mt6897_adsp_grp_probe(struct platform_device *pdev)
{
	int r;
...
static struct platform_driver clk_mt6897_adsp_drv = {
	.probe = clk_mt6897_adsp_grp_probe,
	.driver = {
		.name = "clk-mt6897-adsp",
		.of_match_table = of_match_clk_mt6897_adsp,
	},
};

module_platform_driver(clk_mt6897_adsp_drv);
MODULE_LICENSE("GPL");
