...
static const struct mtk_gate ifrao_clks[] = {
	...
	/* IFRAO4 */
	GATE_IFRAO4(CLK_IFRAO_RG_MMW_DPMAIF26M, "ifrao_dpmaif_26m",
...
static const struct of_device_id of_match_clk_mt6878_bus[] = {
	{
		.compatible = "mediatek,mt6878-infra_ao_reg",
		.data = &ifrao_mcd,
	}, {
		/* sentinel */
	}
...
static int clk_mt6878_bus_grp_probe(struct platform_device *pdev)
{
	int r;
...
static struct platform_driver clk_mt6878_bus_drv = {
	.probe = clk_mt6878_bus_grp_probe,
	.driver = {
		.name = "clk-mt6878-bus",
		.of_match_table = of_match_clk_mt6878_bus,
	},
};

module_platform_driver(clk_mt6878_bus_drv);
MODULE_LICENSE("GPL");
