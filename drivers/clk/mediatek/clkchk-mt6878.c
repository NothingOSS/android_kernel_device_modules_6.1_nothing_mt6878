...
enum {
	...
	CLK_PERAOP_SSUSB0_REF_CG = 210,
	CLK_PERAOP_SSUSB0_FRMCNT_CG = 211,
	CLK_PERAOP_SSUSB0_UTMI_CG = 212,
	CLK_PERAOP_SSUSB0_SYS_CG = 213,
	CLK_PERAOP_SSUSB0_XHCI_CG = 214,
	CLK_PERAOP_SSUSB0_F_CG = 215,
	CLK_PERAOP_SSUSB0_H_CG = 216,
	CLK_PERAOP_MSDC0_CG = 217,
	CLK_PERAOP_MSDC0_H_CG = 218,
	CLK_PERAOP_MSDC0_FAES_CG = 219,
	CLK_PERAOP_MSDC0_MST_F_CG = 220,
	CLK_PERAOP_MSDC0_SLV_H_CG = 221,
	CLK_PERAOP_MSDC1_CG = 222,
	CLK_PERAOP_MSDC1_H_CG = 223,
	CLK_PERAOP_MSDC1_MST_F_CG = 224,
	CLK_PERAOP_MSDC1_SLV_H_CG = 225,
	CLK_PERAOP_AO_F32K_CK_OCC_CG = 226,
	CLK_PERAOP_AUDIO0_CG = 227,
	CLK_PERAOP_AUDIO1_CG = 228,
	CLK_PERAOP_AUDIO2_CG = 229,
	CLK_UFSAO_UNIPRO_TX_SYM_CG = 230,
	CLK_UFSAO_UNIPRO_RX_SYM0_CG = 231,
	CLK_UFSAO_UNIPRO_RX_SYM1_CG = 232,
	CLK_UFSAO_UNIPRO_SYS_CG = 233,
	CLK_UFSAO_UNIPRO_SAP_CFG_CG = 234,
	CLK_UFSAO_PHY_TOP_AHB_S_BUS_CG = 235,
	CLK_UFSPDN_UFSHCI_CG = 236,
	CLK_UFSPDN_UFSHCI_AES_CG = 237,
	CLK_UFSPDN_UFSHCI_AHB_CG = 238,
	CLK_UFSPDN_UFSHCI_AXI_CG = 239,
	CLK_IFRAO_CQ_DMA_FPC_CG = 240,
	CLK_IFRAO_CPUM_CG = 241,
	CLK_IFRAO_CCIF1_AP_CG = 242,
	CLK_IFRAO_CCIF1_MD_CG = 243,
	CLK_IFRAO_CCIF_AP_CG = 244,
	CLK_IFRAO_CCIF_MD_CG = 245,
	CLK_IFRAO_CLDMA_BCLK_CG = 246,
	CLK_IFRAO_CQ_DMA_CG = 247,
	CLK_IFRAO_CCIF5_MD_CG = 248,
	CLK_IFRAO_CCIF2_AP_CG = 249,
	CLK_IFRAO_CCIF2_MD_CG = 250,
	CLK_IFRAO_DPMAIF_MAIN_CG = 251,
	CLK_IFRAO_CCIF4_MD_CG = 252,
	CLK_IFRAO_RG_MMW_DPMAIF26M_CG = 253,
	CLK_MDP_MUTEX0_CG = 254,
	CLK_MDP_APB_BUS_CG = 255,
	CLK_MDP_SMI0_CG = 256,
	CLK_MDP_RDMA0_CG = 257,
	CLK_MDP_HDR0_CG = 258,
	CLK_MDP_AAL0_CG = 259,
	CLK_MDP_RSZ0_CG = 260,
	CLK_MDP_TDSHP0_CG = 261,
	CLK_MDP_WROT0_CG = 262,
	CLK_MDP_RDMA1_CG = 263,
	CLK_MDP_RSZ1_CG = 264,
	CLK_MDP_WROT1_CG = 265,
	CLK_SCP_SET_SPI0_CG = 266,
	CLK_SCP_SET_SPI1_CG = 267,
	CLK_SCP_SET_SPI2_CG = 268,
	CLK_SCP_SET_SPI3_CG = 269,
	CLK_VDE2_VDEC_CKEN_CG = 270,
	CLK_VDE2_VDEC_ACTIVE_CG = 271,
	CLK_VDE2_LARB_CKEN_CG = 272,
	CLK_VEN1_CKE0_LARB_CG = 273,
	CLK_VEN1_CKE1_VENC_CG = 274,
	CLK_VEN1_CKE2_JPGENC_CG = 275,
	CLK_VEN1_CKE5_GALS_CG = 276,
	TRACE_CLK_NUM = 277,
};
