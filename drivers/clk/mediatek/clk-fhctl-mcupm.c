...
static unsigned int id_to_mcupm(struct id_map *map, char *domain, unsigned int fh_id)
{
	if (!map)
		return fh_id;
...
static int mcupm_hopping_v1(void *priv_data, char *domain_name, unsigned int fh_id,
...
struct hdlr_data_v1 hdlr_data_6897 = {
	.reg_tr = NULL,
	.map = map_6897,
};
static struct fh_hdlr mcupm_hdlr_6897 = {
	.ops = &mcupm_ops_v1,
	.data = &hdlr_data_6897,
};
static struct match mt6897_match = {
	.name = "mediatek,mt6897-fhctl",
	.hdlr = &mcupm_hdlr_6897,
	.init = &mcupm_init_v1,
};
/*mt6897 end*/
...
struct hdlr_data_v1 hdlr_data_6985 = {
	.reg_tr = NULL,
	.map = map_6985,
};
static struct fh_hdlr mcupm_hdlr_6985 = {
	.ops = &mcupm_ops_v1,
	.data = &hdlr_data_6985,
};
static struct match mt6985_match = {
	.name = "mediatek,mt6985-fhctl",
	.hdlr = &mcupm_hdlr_6985,
	.init = &mcupm_init_v1,
};
/*mt6985 end*/
