...
static const struct mtk_gate perao_clks[] = {
	...
	GATE_PERAO0(CLK_PERAOP_SPI7_B, "peraop_spi7_b",
			"spi7_b_ck"/* parent */, 19),
	GATE_PERAO0(CLK_PERAOP_SPI0_H, "peraop_spi0_h",
			"peri_faxi_ck"/* parent */, 20),
	GATE_PERAO0(CLK_PERAOP_SPI1_H, "peraop_spi1_h",
			"peri_faxi_ck"/* parent */, 21),
	GATE_PERAO0(CLK_PERAOP_SPI2_H, "peraop_spi2_h",
			"peri_faxi_ck"/* parent */, 22),
	GATE_PERAO0(CLK_PERAOP_SPI3_H, "peraop_spi3_h",
			"peri_faxi_ck"/* parent */, 23),
	GATE_PERAO0(CLK_PERAOP_SPI4_H, "peraop_spi4_h",
			"peri_faxi_ck"/* parent */, 24),
	GATE_PERAO0(CLK_PERAOP_SPI5_H, "peraop_spi5_h",
			"peri_faxi_ck"/* parent */, 25),
	GATE_PERAO0(CLK_PERAOP_SPI6_H, "peraop_spi6_h",
			"peri_faxi_ck"/* parent */, 26),
	GATE_PERAO0(CLK_PERAOP_SPI7_H, "peraop_spi7_h",
			"peri_faxi_ck"/* parent */, 27),
	GATE_PERAO0(CLK_PERAOP_SFLASH, "peraop_sflash",
			"sflash_ck"/* parent */, 28),
	GATE_PERAO0(CLK_PERAOP_SFLASH_F, "peraop_sflash_f",
			"peri_faxi_ck"/* parent */, 29),
	GATE_PERAO0(CLK_PERAOP_SFLASH_H, "peraop_sflash_h",
			"peri_faxi_ck"/* parent */, 30),
	GATE_PERAO0(CLK_PERAOP_SFLASH_P, "peraop_sflash_p",
			"peri_faxi_ck"/* parent */, 31),
	/* PERAO1 */
	GATE_PERAO1(CLK_PERAOP_I2C, "peraop_i2c",
			"peri_faxi_ck"/* parent */, 0),
	GATE_PERAO1(CLK_PERAOP_DMA_B, "peraop_dma_b",
			"peri_faxi_ck"/* parent */, 1),
	GATE_PERAO1(CLK_PERAOP_SSUSB0_PIPE, "peraop_ssusb0_pipe",
			"clk_null"/* parent */, 2),
	GATE_PERAO1(CLK_PERAOP_SSUSB0_REF, "peraop_ssusb0_ref",
			"f26m_ck"/* parent */, 3),
	GATE_PERAO1(CLK_PERAOP_SSUSB0_FRMCNT, "peraop_ssusb0_frmcnt",
			"ssusb_fmcnt_ck"/* parent */, 4),
	GATE_PERAO1(CLK_PERAOP_SSUSB0_UTMI, "peraop_ssusb0_utmi",
			"clk_null"/* parent */, 5),
	GATE_PERAO1(CLK_PERAOP_SSUSB0_SYS, "peraop_ssusb0_sys",
			"usb_ck"/* parent */, 6),
	GATE_PERAO1(CLK_PERAOP_SSUSB0_XHCI, "peraop_ssusb0_xhci",
			"ssusb_xhci_ck"/* parent */, 7),
	GATE_PERAO1(CLK_PERAOP_SSUSB0_F, "peraop_ssusb0_f",
			"peri_fmem_sub_ck"/* parent */, 8),
	GATE_PERAO1(CLK_PERAOP_SSUSB0_H, "peraop_ssusb0_h",
			"peri_faxi_ck"/* parent */, 9),
	GATE_PERAO1(CLK_PERAOP_SSUSB1_REF, "peraop_ssusb1_ref",
			"f26m_ck"/* parent */, 10),
	GATE_PERAO1(CLK_PERAOP_SSUSB1_FRMCNT, "peraop_ssusb1_frmcnt",
			"ssusb_fmcnt_p1_ck"/* parent */, 11),
	GATE_PERAO1(CLK_PERAOP_SSUSB1_UTMI, "peraop_ssusb1_utmi",
			"clk_null"/* parent */, 12),
	GATE_PERAO1(CLK_PERAOP_SSUSB1_SYS, "peraop_ssusb1_sys",
			"usb_1p_ck"/* parent */, 13),
	GATE_PERAO1(CLK_PERAOP_SSUSB1_XHCI, "peraop_ssusb1_xhci",
			"ssusb_xhci_1p_ck"/* parent */, 14),
	GATE_PERAO1(CLK_PERAOP_SSUSB1_F, "peraop_ssusb1_f",
			"peri_faxi_ck"/* parent */, 15),
	GATE_PERAO1(CLK_PERAOP_SSUSB1_H, "peraop_ssusb1_h",
	...
	GATE_PERAO1(CLK_PERAOP_UARTHUB_P, "peraop_uarthub_p",
			"peri_faxi_ck"/* parent */, 25),
	GATE_PERAO1(CLK_PERAOP_PERI_FMEM_SUB, "peraop_peri_fmem_sub",
			"peri_fmem_sub_ck"/* parent */, 29),
	/* PERAO2 */
