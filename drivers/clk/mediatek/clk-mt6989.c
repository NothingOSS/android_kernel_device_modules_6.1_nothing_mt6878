...
#define TOP_MUX_MFGSC_REF_SHIFT			22
...
#define TOP_MUX_SPU0_SHIFT			8
#define TOP_MUX_SPU1_SHIFT			9
...
static const struct mtk_fixed_factor top_divs[] = {
	...
	FACTOR(CLK_TOP_UARTHUB_BCLK, "uarthub_b_ck",
			"uarthub_b_sel", 1, 1),
	FACTOR(CLK_TOP_SSR_PKA, "ssr_pka_ck",
			"ssr_pka_sel", 1, 1),
	FACTOR(CLK_TOP_SSR_DMA, "ssr_dma_ck",
			"ssr_dma_sel", 1, 1),
	FACTOR(CLK_TOP_SSR_KDF, "ssr_kdf_ck",
			"ssr_kdf_sel", 1, 1),
	FACTOR(CLK_TOP_SSR_RNG, "ssr_rng_ck",
			"ssr_rng_sel", 1, 1),
	FACTOR(CLK_TOP_SPU0, "spu0_ck",
			"spu0_sel", 1, 1),
...
static const struct mtk_mux vlp_ck_muxes[] = {
	...
	MUX_GATE_CLR_SET_UPD(CLK_VLP_CK_SCP_SPI_SEL/* dts */, "vlp_scp_spi_sel",
		vlp_scp_spi_parents/* parent */, VLP_CLK_CFG_0, VLP_CLK_CFG_0_SET,
		VLP_CLK_CFG_0_CLR/* set parent */, 8/* lsb */, 2/* width */,
		15/* pdn */, VLP_CLK_CFG_UPDATE/* upd ofs */,
		TOP_MUX_SCP_SPI_SHIFT/* upd shift */),
	MUX_GATE_CLR_SET_UPD(CLK_VLP_CK_SCP_IIC_SEL/* dts */, "vlp_scp_iic_sel",
		vlp_scp_iic_parents/* parent */, VLP_CLK_CFG_0, VLP_CLK_CFG_0_SET,
		VLP_CLK_CFG_0_CLR/* set parent */, 16/* lsb */, 2/* width */,
		23/* pdn */, VLP_CLK_CFG_UPDATE/* upd ofs */,
		TOP_MUX_SCP_IIC_SHIFT/* upd shift */),
	MUX_GATE_CLR_SET_UPD(CLK_VLP_CK_SCP_SPI_HIGH_SPD_SEL/* dts */, "vlp_scp_spi_hs_sel",
		vlp_scp_spi_hs_parents/* parent */, VLP_CLK_CFG_0, VLP_CLK_CFG_0_SET,
		VLP_CLK_CFG_0_CLR/* set parent */, 24/* lsb */, 3/* width */,
		31/* pdn */, VLP_CLK_CFG_UPDATE/* upd ofs */,
		TOP_MUX_SCP_SPI_HIGH_SPD_SHIFT/* upd shift */),
	/* VLP_CLK_CFG_1 */
	MUX_GATE_CLR_SET_UPD(CLK_VLP_CK_SCP_IIC_HIGH_SPD_SEL/* dts */, "vlp_scp_iic_hs_sel",
		vlp_scp_iic_hs_parents/* parent */, VLP_CLK_CFG_1, VLP_CLK_CFG_1_SET,
		VLP_CLK_CFG_1_CLR/* set parent */, 0/* lsb */, 3/* width */,
		7/* pdn */, VLP_CLK_CFG_UPDATE/* upd ofs */,
...
static const struct mtk_mux top_muxes[] = {
	...
	MUX_CLR_SET_UPD(CLK_TOP_EMI_SLICE_N_SEL/* dts */, "emi_slice_n_sel",
	...
	/* CLK_CFG_3 */
	MUX_CLR_SET_UPD(CLK_TOP_EMI_SLICE_S_SEL/* dts */, "emi_slice_s_sel",
	...
	MUX_CLR_SET_UPD(CLK_TOP_CIRQ_SEL/* dts */, "cirq_sel",
	...
	MUX_CLR_SET_UPD(CLK_TOP_MFGSC_REF_SEL/* dts */, "mfgsc_ref_sel",
		...
		CLK_CFG_5_CLR/* set parent */, 16/* lsb */, 1/* width */,
		CLK_CFG_UPDATE/* upd ofs */, TOP_MUX_MFGSC_REF_SHIFT/* upd shift */),
	MUX_CLR_SET_UPD(CLK_TOP_MFG_EB_SEL/* dts */, "mfg_eb_sel",
	...
	MUX_CLR_SET_UPD(CLK_TOP_SPI0_BCLK_SEL/* dts */, "spi0_b_sel",
	...
	MUX_CLR_SET_UPD(CLK_TOP_SPI1_BCLK_SEL/* dts */, "spi1_b_sel",
	...
	MUX_CLR_SET_UPD(CLK_TOP_SPI2_BCLK_SEL/* dts */, "spi2_b_sel",
	...
	/* CLK_CFG_7 */
	MUX_CLR_SET_UPD(CLK_TOP_SPI3_BCLK_SEL/* dts */, "spi3_b_sel",
	...
	MUX_CLR_SET_UPD(CLK_TOP_SPI4_BCLK_SEL/* dts */, "spi4_b_sel",
	...
	MUX_CLR_SET_UPD(CLK_TOP_SPI5_BCLK_SEL/* dts */, "spi5_b_sel",
	...
	MUX_CLR_SET_UPD(CLK_TOP_SPI6_BCLK_SEL/* dts */, "spi6_b_sel",
	...
	/* CLK_CFG_8 */
	MUX_CLR_SET_UPD(CLK_TOP_SPI7_BCLK_SEL/* dts */, "spi7_b_sel",
	...
	MUX_CLR_SET_UPD(CLK_TOP_SDF_SEL/* dts */, "sdf_sel",
	...
	/* CLK_CFG_16 */
	MUX_CLR_SET_UPD(CLK_TOP_UARTHUB_BCLK_SEL/* dts */, "uarthub_b_sel",
	...
	MUX_CLR_SET_UPD(CLK_TOP_SSR_PKA_SEL/* dts */, "ssr_pka_sel",
	...
	MUX_CLR_SET_UPD(CLK_TOP_SSR_DMA_SEL/* dts */, "ssr_dma_sel",
	...
	MUX_CLR_SET_UPD(CLK_TOP_SSR_KDF_SEL/* dts */, "ssr_kdf_sel",
	...
	/* CLK_CFG_17 */
	MUX_CLR_SET_UPD(CLK_TOP_SSR_RNG_SEL/* dts */, "ssr_rng_sel",
	...
	MUX_CLR_SET_UPD(CLK_TOP_SSR_SEJ_SEL/* dts */, "ssr_sej_sel",
	...
	MUX_CLR_SET_UPD(CLK_TOP_SPU0_SEL/* dts */, "spu0_sel",
		spu0_parents/* parent */, CLK_CFG_17, CLK_CFG_17_SET,
		CLK_CFG_17_CLR/* set parent */, 16/* lsb */, 3/* width */,
		CLK_CFG_UPDATE2/* upd ofs */, TOP_MUX_SPU0_SHIFT/* upd shift */),
	MUX_CLR_SET_UPD(CLK_TOP_SPU1_SEL/* dts */, "spu1_sel",
		spu1_parents/* parent */, CLK_CFG_17, CLK_CFG_17_SET,
	...
	MUX_CLR_SET_UPD(CLK_TOP_SENINF0_SEL/* dts */, "seninf0_sel",
	...
	MUX_CLR_SET_UPD(CLK_TOP_CCUTM_SEL/* dts */, "ccutm_sel",
	...
	MUX_CLR_SET_UPD(CLK_TOP_DP_CORE_SEL/* dts */, "dp_core_sel",
	...
	MUX_GATE_CLR_SET_UPD(CLK_TOP_MFG_EB_SEL/* dts */, "mfg_eb_sel",
		mfg_eb_parents/* parent */, CLK_CFG_5, CLK_CFG_5_SET,
		CLK_CFG_5_CLR/* set parent */, 24/* lsb */, 2/* width */,
		31/* pdn */, CLK_CFG_UPDATE/* upd ofs */,
		TOP_MUX_MFG_EB_SHIFT/* upd shift */),
	/* CLK_CFG_6 */
	MUX_CLR_SET_UPD(CLK_TOP_UART_SEL/* dts */, "uart_sel",
		uart_parents/* parent */, CLK_CFG_6, CLK_CFG_6_SET,
		CLK_CFG_6_CLR/* set parent */, 0/* lsb */, 2/* width */,
		CLK_CFG_UPDATE/* upd ofs */, TOP_MUX_UART_SHIFT/* upd shift */),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_SPI0_BCLK_SEL/* dts */, "spi0_b_sel",
		spi0_b_parents/* parent */, CLK_CFG_6, CLK_CFG_6_SET,
		CLK_CFG_6_CLR/* set parent */, 8/* lsb */, 3/* width */,
		15/* pdn */, CLK_CFG_UPDATE/* upd ofs */,
		TOP_MUX_SPI0_BCLK_SHIFT/* upd shift */),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_SPI1_BCLK_SEL/* dts */, "spi1_b_sel",
		spi1_b_parents/* parent */, CLK_CFG_6, CLK_CFG_6_SET,
		CLK_CFG_6_CLR/* set parent */, 16/* lsb */, 3/* width */,
		23/* pdn */, CLK_CFG_UPDATE/* upd ofs */,
		TOP_MUX_SPI1_BCLK_SHIFT/* upd shift */),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_SPI2_BCLK_SEL/* dts */, "spi2_b_sel",
		spi2_b_parents/* parent */, CLK_CFG_6, CLK_CFG_6_SET,
		CLK_CFG_6_CLR/* set parent */, 24/* lsb */, 3/* width */,
		31/* pdn */, CLK_CFG_UPDATE/* upd ofs */,
		TOP_MUX_SPI2_BCLK_SHIFT/* upd shift */),
	/* CLK_CFG_7 */
	MUX_GATE_CLR_SET_UPD(CLK_TOP_SPI3_BCLK_SEL/* dts */, "spi3_b_sel",
		spi3_b_parents/* parent */, CLK_CFG_7, CLK_CFG_7_SET,
		CLK_CFG_7_CLR/* set parent */, 0/* lsb */, 3/* width */,
		7/* pdn */, CLK_CFG_UPDATE/* upd ofs */,
		TOP_MUX_SPI3_BCLK_SHIFT/* upd shift */),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_SPI4_BCLK_SEL/* dts */, "spi4_b_sel",
		spi4_b_parents/* parent */, CLK_CFG_7, CLK_CFG_7_SET,
		CLK_CFG_7_CLR/* set parent */, 8/* lsb */, 3/* width */,
		15/* pdn */, CLK_CFG_UPDATE/* upd ofs */,
		TOP_MUX_SPI4_BCLK_SHIFT/* upd shift */),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_SPI5_BCLK_SEL/* dts */, "spi5_b_sel",
		spi5_b_parents/* parent */, CLK_CFG_7, CLK_CFG_7_SET,
		CLK_CFG_7_CLR/* set parent */, 16/* lsb */, 3/* width */,
		23/* pdn */, CLK_CFG_UPDATE/* upd ofs */,
		TOP_MUX_SPI5_BCLK_SHIFT/* upd shift */),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_SPI6_BCLK_SEL/* dts */, "spi6_b_sel",
		spi6_b_parents/* parent */, CLK_CFG_7, CLK_CFG_7_SET,
		CLK_CFG_7_CLR/* set parent */, 24/* lsb */, 3/* width */,
		31/* pdn */, CLK_CFG_UPDATE1/* upd ofs */,
		TOP_MUX_SPI6_BCLK_SHIFT/* upd shift */),
	/* CLK_CFG_8 */
	MUX_GATE_CLR_SET_UPD(CLK_TOP_SPI7_BCLK_SEL/* dts */, "spi7_b_sel",
		spi7_b_parents/* parent */, CLK_CFG_8, CLK_CFG_8_SET,
		CLK_CFG_8_CLR/* set parent */, 0/* lsb */, 3/* width */,
		7/* pdn */, CLK_CFG_UPDATE1/* upd ofs */,
		TOP_MUX_SPI7_BCLK_SHIFT/* upd shift */),
	...
	MUX_GATE_CLR_SET_UPD(CLK_TOP_EMI_INTERFACE_546_SEL/* dts */, "md_emi_sel",
		md_emi_parents/* parent */, CLK_CFG_15, CLK_CFG_15_SET,
		CLK_CFG_15_CLR/* set parent */, 16/* lsb */, 1/* width */,
		23/* pdn */, CLK_CFG_UPDATE2/* upd ofs */,
		TOP_MUX_EMI_INTERFACE_546_SHIFT/* upd shift */),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_SDF_SEL/* dts */, "sdf_sel",
		sdf_parents/* parent */, CLK_CFG_15, CLK_CFG_15_SET,
		CLK_CFG_15_CLR/* set parent */, 24/* lsb */, 3/* width */,
		31/* pdn */, CLK_CFG_UPDATE2/* upd ofs */,
		TOP_MUX_SDF_SHIFT/* upd shift */),
	/* CLK_CFG_16 */
	MUX_GATE_CLR_SET_UPD(CLK_TOP_UARTHUB_BCLK_SEL/* dts */, "uarthub_b_sel",
		uarthub_b_parents/* parent */, CLK_CFG_16, CLK_CFG_16_SET,
		CLK_CFG_16_CLR/* set parent */, 0/* lsb */, 2/* width */,
		7/* pdn */, CLK_CFG_UPDATE2/* upd ofs */,
		TOP_MUX_UARTHUB_BCLK_SHIFT/* upd shift */),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_SSR_PKA_SEL/* dts */, "ssr_pka_sel",
		ssr_pka_parents/* parent */, CLK_CFG_16, CLK_CFG_16_SET,
		CLK_CFG_16_CLR/* set parent */, 8/* lsb */, 3/* width */,
		15/* pdn */, CLK_CFG_UPDATE2/* upd ofs */,
		TOP_MUX_SSR_PKA_SHIFT/* upd shift */),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_SSR_DMA_SEL/* dts */, "ssr_dma_sel",
		ssr_dma_parents/* parent */, CLK_CFG_16, CLK_CFG_16_SET,
		CLK_CFG_16_CLR/* set parent */, 16/* lsb */, 3/* width */,
		23/* pdn */, CLK_CFG_UPDATE2/* upd ofs */,
		TOP_MUX_SSR_DMA_SHIFT/* upd shift */),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_SSR_KDF_SEL/* dts */, "ssr_kdf_sel",
		ssr_kdf_parents/* parent */, CLK_CFG_16, CLK_CFG_16_SET,
		CLK_CFG_16_CLR/* set parent */, 24/* lsb */, 3/* width */,
		31/* pdn */, CLK_CFG_UPDATE2/* upd ofs */,
		TOP_MUX_SSR_KDF_SHIFT/* upd shift */),
	/* CLK_CFG_17 */
	MUX_GATE_CLR_SET_UPD(CLK_TOP_SSR_RNG_SEL/* dts */, "ssr_rng_sel",
		ssr_rng_parents/* parent */, CLK_CFG_17, CLK_CFG_17_SET,
		CLK_CFG_17_CLR/* set parent */, 0/* lsb */, 2/* width */,
		7/* pdn */, CLK_CFG_UPDATE2/* upd ofs */,
		TOP_MUX_SSR_RNG_SHIFT/* upd shift */),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_SSR_SEJ_SEL/* dts */, "ssr_sej_sel",
		ssr_sej_parents/* parent */, CLK_CFG_17, CLK_CFG_17_SET,
		CLK_CFG_17_CLR/* set parent */, 8/* lsb */, 2/* width */,
		15/* pdn */, CLK_CFG_UPDATE2/* upd ofs */,
		TOP_MUX_SSR_SEJ_SHIFT/* upd shift */),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_SPU0_SEL/* dts */, "spu0_sel",
		spu0_parents/* parent */, CLK_CFG_17, CLK_CFG_17_SET,
		CLK_CFG_17_CLR/* set parent */, 16/* lsb */, 3/* width */,
		23/* pdn */, CLK_CFG_UPDATE2/* upd ofs */,
		TOP_MUX_SPU0_SHIFT/* upd shift */),
	MUX_GATE_CLR_SET_UPD(CLK_TOP_SPU1_SEL/* dts */, "spu1_sel",
		spu1_parents/* parent */, CLK_CFG_17, CLK_CFG_17_SET,
		CLK_CFG_17_CLR/* set parent */, 24/* lsb */, 3/* width */,
		31/* pdn */, CLK_CFG_UPDATE2/* upd ofs */,
		TOP_MUX_SPU1_SHIFT/* upd shift */),
	/* CLK_CFG_18 */
	...
	MUX_GATE_CLR_SET_UPD(CLK_TOP_SENINF0_SEL/* dts */, "seninf0_sel",
		seninf0_parents/* parent */, CKSYS2_CLK_CFG_1, CKSYS2_CLK_CFG_1_SET,
		CKSYS2_CLK_CFG_1_CLR/* set parent */, 24/* lsb */, 4/* width */,
		31/* pdn */, CKSYS2_CLK_CFG_UPDATE/* upd ofs */,
		TOP_MUX_SENINF0_SHIFT/* upd shift */),
	/* CKSYS2_CLK_CFG_2 */
	...
	MUX_GATE_CLR_SET_UPD(CLK_TOP_DP_CORE_SEL/* dts */, "dp_core_sel",
		dp_core_parents/* parent */, CKSYS2_CLK_CFG_5, CKSYS2_CLK_CFG_5_SET,
		CKSYS2_CLK_CFG_5_CLR/* set parent */, 24/* lsb */, 3/* width */,
		31/* pdn */, CKSYS2_CLK_CFG_UPDATE/* upd ofs */,
		TOP_MUX_DP_CORE_SHIFT/* upd shift */),
	/* CKSYS2_CLK_CFG_6 */
