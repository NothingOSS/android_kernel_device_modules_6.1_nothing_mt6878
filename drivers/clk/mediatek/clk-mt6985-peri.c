...
static const struct mtk_gate perao_clks[] = {
	...
	GATE_PERAO0(CLK_PERAO_SPI6_H, "perao_spi6_h",
			"peri_faxi_ck"/* parent */, 26),
	GATE_PERAO0(CLK_PERAO_SPI7_H, "perao_spi7_h",
	...
	GATE_PERAO1(CLK_PERAO_MSDC2_H, "perao_msdc2_h",
			"peri_faxi_ck"/* parent */, 22),
	GATE_PERAO1(CLK_PERAO_UARTHUB, "perao_uarthub",
			"uarthub_bclk_ck"/* parent */, 23),
	GATE_PERAO1(CLK_PERAO_UARTHUB_H, "perao_uarthub_h",
			"peri_faxi_ck"/* parent */, 24),
	GATE_PERAO1(CLK_PERAO_UARTHUB_P, "perao_uarthub_p",
			"peri_faxi_ck"/* parent */, 25),
	/* PERAO2 */
