...
static const struct of_device_id of_match_clk_mt6897_vcodec[] = {
	{
		.compatible = "mediatek,mt6897-vdecsys",
		.data = &vde2_mcd,
	}, {
		.compatible = "mediatek,mt6897-vdecsys_soc",
		.data = &vde1_mcd,
	}, {
		.compatible = "mediatek,mt6897-vencsys",
		.data = &ven1_mcd,
	}, {
		.compatible = "mediatek,mt6897-vencsys_c1",
		.data = &ven2_mcd,
	}, {
		/* sentinel */
	}
...
static int clk_mt6897_vcodec_grp_probe(struct platform_device *pdev)
{
	int r;
...
static struct platform_driver clk_mt6897_vcodec_drv = {
	.probe = clk_mt6897_vcodec_grp_probe,
	.driver = {
		.name = "clk-mt6897-vcodec",
		.of_match_table = of_match_clk_mt6897_vcodec,
	},
};

module_platform_driver(clk_mt6897_vcodec_drv);
MODULE_LICENSE("GPL");
