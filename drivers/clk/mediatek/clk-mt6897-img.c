...
static const struct mtk_gate_regs imgv_cg_regs = {
	.set_ofs = 0x4,
	.clr_ofs = 0x8,
	.sta_ofs = 0x0,
};

#define GATE_IMGV(_id, _name, _parent, _shift) {	\
		.id = _id,				\
		.name = _name,				\
		.parent_name = _parent,			\
		.regs = &imgv_cg_regs,			\
...
static const struct mtk_gate imgv_clks[] = {
	GATE_IMGV(CLK_IMGV_IMG_VCORE_GALS_DISP_CON_0, "imgv_imgv_g_disp_ck",
			"img1_ck"/* parent */, 0),
	GATE_IMGV(CLK_IMGV_IMG_VCORE_MAIN_CON_0, "imgv_imgv_main_ck",
			"img1_ck"/* parent */, 1),
	GATE_IMGV(CLK_IMGV_IMG_VCORE_SUB0_CON_0, "imgv_imgv_sub0_ck",
			"img1_ck"/* parent */, 2),
	GATE_IMGV(CLK_IMGV_IMG_VCORE_SUB1_CON_0, "imgv_imgv_sub1_ck",
			"img1_ck"/* parent */, 3),
};

static const struct mtk_clk_desc imgv_mcd = {
	.clks = imgv_clks,
	.num_clks = CLK_IMGV_NR_CLK,
};
...
static const struct of_device_id of_match_clk_mt6897_img[] = {
	{
		.compatible = "mediatek,mt6897-dip_nr1_dip1",
		.data = &dip_nr1_dip1_mcd,
	}, {
		.compatible = "mediatek,mt6897-dip_nr2_dip1",
		.data = &dip_nr2_dip1_mcd,
	}, {
		.compatible = "mediatek,mt6897-dip_top_dip1",
		.data = &dip_top_dip1_mcd,
	}, {
		.compatible = "mediatek,mt6897-imgsys_main",
		.data = &img_mcd,
	}, {
		.compatible = "mediatek,mt6897-traw_dip1",
		.data = &traw_dip1_mcd,
	}, {
		.compatible = "mediatek,mt6897-wpe1_dip1",
		.data = &wpe1_dip1_mcd,
	}, {
		.compatible = "mediatek,mt6897-wpe2_dip1",
		.data = &wpe2_dip1_mcd,
	}, {
		.compatible = "mediatek,mt6897-wpe3_dip1",
		.data = &wpe3_dip1_mcd,
	}, {
		.compatible = "mediatek,mt6897-img_vcore_d1a",
		.data = &imgv_mcd,
	}, {
		/* sentinel */
	}
...
static int clk_mt6897_img_grp_probe(struct platform_device *pdev)
{
	int r;
...
static struct platform_driver clk_mt6897_img_drv = {
	.probe = clk_mt6897_img_grp_probe,
	.driver = {
		.name = "clk-mt6897-img",
		.of_match_table = of_match_clk_mt6897_img,
	},
};

module_platform_driver(clk_mt6897_img_drv);
MODULE_LICENSE("GPL");
