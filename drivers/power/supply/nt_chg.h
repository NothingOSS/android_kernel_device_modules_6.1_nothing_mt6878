...
#define UPM6720_CHIP_ID                 (0x20)
#define CP_WORKMODE_DEF                  (2)
#define ABOVE_IBAT_COMPENSATION          (2600)
#define PLUGIN_VOLTAGE                   (2500)
#define PROJECT_DATA_ID                  (3)
...
#define LOW_TEMP_THR                     (-20)
#define HIGH_TEMP_THR                    (60)
...
{                                                                     \
	return single_open(file, name ## _proc_show, inode->i_private);   		\
}                                                                     \
...
#define NT_CHG_CYCLE			6
#define NT_CHG_100MA			100000
#define NT_CHG_1500MA			1500000
