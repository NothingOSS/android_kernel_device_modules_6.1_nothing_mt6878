...
struct charger_ops {
	...
	int (*enable_vac_otgovp)(struct charger_device *dev, bool en);
	int (*enable_vac_otgovp_spec)(struct charger_device *dev, bool en);
...
extern int charger_dev_set_vac_ovp(
	struct charger_device *charger_dev, u32 uV);
extern int charger_dev_enable_vac_otgovp(
	struct charger_device *charger_dev, bool en);
extern int charger_dev_enable_vac_otgovp_spec(
	struct charger_device *charger_dev, bool en);
