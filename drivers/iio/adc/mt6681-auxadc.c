...
#define MT6681_AUXADC_CHANNEL(_ch_name, _ch_num, _res, _has_regs) \
	[AUXADC_##_ch_name] = {			\
		.type = IIO_VOLTAGE,			\
...
static struct auxadc_channels auxadc_chans[] = {
	MT6681_AUXADC_CHANNEL(CHIP_TEMP, 4, 12, true),
	MT6681_AUXADC_CHANNEL(ACCDET, 5, 12, true),
	MT6681_AUXADC_CHANNEL(HPOFS_CAL, 9, 15, true),
};
...
#define MT6681_RG_TSENS_EN_ADDR			0x98b
#define MT6681_RG_TSENS_EN_SHIFT		7
#define MT6681_AUXADC_ADC4_L			0x1088
#define MT6681_AUXADC_ADC4_H			0x1089
#define MT6681_AUXADC_ADC5_L			0x108a
#define MT6681_AUXADC_ADC5_H			0x108b
#define MT6681_AUXADC_ADC9_L			0x108c
#define MT6681_AUXADC_ADC9_H			0x108d
#define MT6681_AUXADC_RQST0			0x1107
#define MT6681_AUXADC_RQST_CH4_SHIFT		0
#define MT6681_AUXADC_RQST_CH5_SHIFT		1
#define MT6681_AUXADC_RQST_CH9_SHIFT		2
#define MT6681_AUXADC_ADC_OUT_CH4_L_ADDR	MT6681_AUXADC_ADC4_L
#define MT6681_AUXADC_ADC_RDY_CH4_ADDR		MT6681_AUXADC_ADC4_H
#define MT6681_AUXADC_ADC_OUT_CH5_L_ADDR        MT6681_AUXADC_ADC5_L
#define MT6681_AUXADC_ADC_RDY_CH5_ADDR		MT6681_AUXADC_ADC5_H
#define MT6681_AUXADC_ADC_OUT_CH9_L_ADDR        MT6681_AUXADC_ADC9_L
#define MT6681_AUXADC_ADC_RDY_CH9_ADDR		MT6681_AUXADC_ADC9_H

#define MT6681_AUXADC_REG(_ch_name, _chip, _rqst_reg, _rqst_shift, _rdy_reg, _out_reg) \
	[AUXADC_##_ch_name] = {			\
...
static const struct auxadc_regs mt6681_auxadc_regs_tbl[] = {
	MT6681_AUXADC_REG(CHIP_TEMP, MT6681, AUXADC_RQST0, MT6681_AUXADC_RQST_CH4_SHIFT,
			  MT6681_AUXADC_ADC_RDY_CH4_ADDR, MT6681_AUXADC_ADC_OUT_CH4_L_ADDR),
	MT6681_AUXADC_REG(ACCDET, MT6681, AUXADC_RQST0, MT6681_AUXADC_RQST_CH5_SHIFT,
			  MT6681_AUXADC_ADC_RDY_CH5_ADDR, MT6681_AUXADC_ADC_OUT_CH5_L_ADDR),
	MT6681_AUXADC_REG(HPOFS_CAL, MT6681, AUXADC_RQST0, MT6681_AUXADC_RQST_CH9_SHIFT,
			  MT6681_AUXADC_ADC_RDY_CH9_ADDR, MT6681_AUXADC_ADC_OUT_CH9_L_ADDR),
};

#define MT6681_HK_TOP_RST_CON0                                0xf8d
#define MT6681_HK_TOP_WKEY_L                                  0xf94
...
static const unsigned int mt6681_rst_setting[][3] = {
	{
		...
		MT6681_HK_TOP_RST_CON0, 0x9, 0,
	}, {
		MT6681_HK_TOP_WKEY_H, 0xFF, 0,
	}, {
		MT6681_HK_TOP_WKEY_L, 0xFF, 0,
	}
};
...
static const struct auxadc_info mt6681_info = {
	.regs_tbl = mt6681_auxadc_regs_tbl,
	.rst_setting = mt6681_rst_setting,
	.num_rst_setting = ARRAY_SIZE(mt6681_rst_setting),
};

#define mt6681_regmap_bulk_read_poll_timeout(map, addr, val, cond, sleep_us, timeout_us) \
({ \
...
/*
 * @adc_dev:	 pointer to the struct mt6681_auxadc_device
 * @auxadc_chan: pointer to the struct auxadc_channels, it represents specific
		 auxadc channel
 * @val:	 pointer to output value
 */
static int get_auxadc_out(struct mt6681_auxadc_device *adc_dev,
			  const struct auxadc_channels *auxadc_chan, int *val)
{
	...
	ret = mt6681_regmap_bulk_read_poll_timeout(adc_dev->regmap, auxadc_chan->regs->out_reg,
...
static int mt6681_auxadc_read_raw(struct iio_dev *indio_dev,
				  struct iio_chan_spec const *chan,
				  int *val,
				  int *val2,
				  long mask)
{
	struct mt6681_auxadc_device *adc_dev = iio_priv(indio_dev);
	...
	if (chan->channel == AUXADC_CHIP_TEMP)
		regmap_update_bits(adc_dev->regmap, MT6681_RG_TSENS_EN_ADDR,
				   0x1 << MT6681_RG_TSENS_EN_SHIFT, 0);
...
static int mt6681_auxadc_fwnode_xlate(struct iio_dev *indio_dev,
...
static const struct iio_info mt6681_auxadc_info = {
	.read_raw = &mt6681_auxadc_read_raw,
	.fwnode_xlate = &mt6681_auxadc_fwnode_xlate,
};

static int auxadc_get_data_from_dt(struct mt6681_auxadc_device *adc_dev,
...
static int auxadc_parse_dt(struct mt6681_auxadc_device *adc_dev,
			   struct device_node *node)
{
...
static int mt6681_auxadc_probe(struct platform_device *pdev)
{
	...
	indio_dev->info = &mt6681_auxadc_info;
...
static const struct of_device_id mt6681_auxadc_of_match[] = {
	{
...
MODULE_DEVICE_TABLE(of, mt6681_auxadc_of_match);

static struct platform_driver mt6681_auxadc_driver = {
	.driver = {
		.name = "mt6681-auxadc",
		.of_match_table = mt6681_auxadc_of_match,
	},
...
MODULE_DESCRIPTION("MediaTek PMIC AUXADC Driver for MT6681 PMIC");
