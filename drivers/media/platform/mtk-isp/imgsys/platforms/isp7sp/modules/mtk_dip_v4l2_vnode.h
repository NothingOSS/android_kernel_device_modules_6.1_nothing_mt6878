...
static const struct mtk_imgsys_dev_format dip_csmcso_fmts[] = {
	/* color content smart, 1 plane 32 bit */
	{
...
static const struct mtk_imgsys_video_device_desc dip_setting[] = {
	...
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_REC_PREI_OUT,
		.name = "RecPrei Input",
		.cap = V4L2_CAP_VIDEO_OUTPUT_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 13,
		.frmsizeenum = &dip_in_frmsizeenum,
		.description = "Prev F1 input",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_TNRAIMI_OUT,
		.name = "Tnraimi Input",
		.cap = V4L2_CAP_VIDEO_OUTPUT_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 14,
		.frmsizeenum = &dip_in_frmsizeenum,
		.description = "AIM Map input",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_EECSI_OUT,
		.name = "Eecsi Input",
		.cap = V4L2_CAP_VIDEO_OUTPUT_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 15,
		.frmsizeenum = &dip_in_frmsizeenum,
		.description = "EE CS input",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_SNRCSI_OUT,
		.name = "Snrcsi Input",
		.cap = V4L2_CAP_VIDEO_OUTPUT_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 16,
		.frmsizeenum = &dip_in_frmsizeenum,
		.description = "SNR CS input",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_SNRAIMI_OUT,
		.name = "Snraimi Input",
		.cap = V4L2_CAP_VIDEO_OUTPUT_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 17,
		.frmsizeenum = &dip_in_frmsizeenum,
		.description = "SNR AIM input",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_CSMCSI_D1_OUT,
		.name = "Csmcsi Input",
		.cap = V4L2_CAP_VIDEO_OUTPUT_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 18,
		.frmsizeenum = &dip_in_frmsizeenum,
		.description = "Color CSS input",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_CSMCI_D1_OUT,
		.name = "Csmci Input",
		.cap = V4L2_CAP_VIDEO_OUTPUT_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 19,
		.frmsizeenum = &dip_in_frmsizeenum,
		.description = "Color CSW input",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_BOKMI_OUT,
		.name = "Bokmi Input",
		.cap = V4L2_CAP_VIDEO_OUTPUT_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
		.smem_alloc = 0,
		...
		.dma_port = 20,
		.frmsizeenum = &dip_in_frmsizeenum,
		.description = "Bokeh map in",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_BOKPI_OUT,
		.name = "Bokpi Input",
		.cap = V4L2_CAP_VIDEO_OUTPUT_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
		.smem_alloc = 0,
	...
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_CSMCSO_CAPTURE,
		.name = "Csmcso Output",
		.cap = V4L2_CAP_VIDEO_CAPTURE_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_CAPTURE_MPLANE,
		.smem_alloc = 0,
		.flags = MEDIA_LNK_FL_DYNAMIC,
		.fmts = dip_csmcso_fmts,
		.num_fmts = ARRAY_SIZE(dip_csmcso_fmts),
		.default_fmt_idx = 0,
		.default_width = MTK_DIP_CAPTURE_MAX_WIDTH,
		.default_height = MTK_DIP_CAPTURE_MAX_HEIGHT,
		.dma_port = 7,
		...
		.dma_port = 8,
		.frmsizeenum = &dip_out_frmsizeenum,
		.description = "Bokeh map out",
	},
	{
		.id = MTK_IMGSYS_VIDEO_NODE_ID_CNRO_CAPTURE,
		.name = "Cnro Output",
		.cap = V4L2_CAP_VIDEO_CAPTURE_MPLANE | V4L2_CAP_STREAMING,
		.buf_type = V4L2_BUF_TYPE_VIDEO_CAPTURE_MPLANE,
		.smem_alloc = 0,
