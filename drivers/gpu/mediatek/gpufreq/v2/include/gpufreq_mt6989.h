...
#define GPUFREQ_BATT_OC_FREQ                (483000)
...
#define GPUFREQ_LOW_BATT_LV1_FREQ           (981000)
#define GPUFREQ_LOW_BATT_LV2_FREQ           (483000)
#define GPUFREQ_LOW_BATT_LV3_FREQ           (265000)
