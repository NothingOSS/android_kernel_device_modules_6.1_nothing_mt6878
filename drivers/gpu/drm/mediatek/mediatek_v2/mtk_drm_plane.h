...
enum MTK_PLANE_PROP {
	...
	PLANE_PROP_BUFFER_ALLOC_ID,	/* 10 */
	PLANE_PROP_OVL_CSC_SET_BRIGHTNESS,
	PLANE_PROP_OVL_CSC_SET_COLORTRANSFORM,
	PLANE_PROP_DIRTY_ROI_NUM,
	PLANE_PROP_DIRTY_ROI_X,
...
struct mtk_crtc_ovl_csc_config {
	int setbrightness[16];
	int setcolortransform[16];
};
