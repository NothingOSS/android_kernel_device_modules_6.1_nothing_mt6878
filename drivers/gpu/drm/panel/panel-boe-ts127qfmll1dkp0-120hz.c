...
static void boe_panel_init(struct boe *ctx)
{
	...
	boe_dcs_write_seq_static(ctx, 0x65, 0xDD);
	boe_dcs_write_seq_static(ctx, 0x6D, 0xDD);
	...
	boe_dcs_write_seq_static(ctx, 0xFB, 0x01);
	boe_dcs_write_seq_static(ctx, 0x75, 0x01, 0x00);
	...
	boe_dcs_write_seq_static(ctx, 0xBA, 0x12, 0x00);
	boe_dcs_write_seq_static(ctx, 0xBB, 0x10, 0x00);
	boe_dcs_write_seq_static(ctx, 0xBC, 0x37, 0x00, 0x30);
	...
	boe_dcs_write_seq_static(ctx, 0x92, 0x87, 0x01, 0x2D);
	boe_dcs_write_seq_static(ctx, 0x93, 0x1A, 0x00);
	boe_dcs_write_seq_static(ctx, 0x94, 0x7A, 0x00);
	...
	boe_dcs_write_seq_static(ctx, 0xAA, 0x96, 0x96, 0x25);
	...
	boe_dcs_write_seq_static(ctx, 0x13, 0x03);
	boe_dcs_write_seq_static(ctx, 0x14, 0x24);
	boe_dcs_write_seq_static(ctx, 0x15, 0x02);
	boe_dcs_write_seq_static(ctx, 0x16, 0x5B);
	...
	boe_dcs_write_seq_static(ctx, 0xDB, 0x03);
	boe_dcs_write_seq_static(ctx, 0xDC, 0x96);
	boe_dcs_write_seq_static(ctx, 0xDD, 0x02);
	boe_dcs_write_seq_static(ctx, 0xDE, 0xB0);

	boe_dcs_write_seq_static(ctx, 0xFF, 0x26);
	boe_dcs_write_seq_static(ctx, 0xFB, 0x01);
	boe_dcs_write_seq_static(ctx, 0x04, 0x75);
	boe_dcs_write_seq_static(ctx, 0x0A, 0x04);
	boe_dcs_write_seq_static(ctx, 0x0D, 0x00);
	boe_dcs_write_seq_static(ctx, 0x0F, 0x03);
	boe_dcs_write_seq_static(ctx, 0x13, 0x88);
	boe_dcs_write_seq_static(ctx, 0x14, 0x8E);
	boe_dcs_write_seq_static(ctx, 0x16, 0x10);
	boe_dcs_write_seq_static(ctx, 0x19, 0x1C, 0x1D, 0x16, 0x1D);
	boe_dcs_write_seq_static(ctx, 0x1A, 0xDB, 0xB1, 0xA4, 0x84);
	boe_dcs_write_seq_static(ctx, 0x1B, 0x1B, 0x1C, 0x1C, 0x1C);
	boe_dcs_write_seq_static(ctx, 0x1C, 0x1F, 0xA4, 0xA4, 0xA4);
	boe_dcs_write_seq_static(ctx, 0x1D, 0x00);
	boe_dcs_write_seq_static(ctx, 0x1E, 0x87);
	boe_dcs_write_seq_static(ctx, 0x1F, 0x87);
	boe_dcs_write_seq_static(ctx, 0x24, 0x01);
	boe_dcs_write_seq_static(ctx, 0x25, 0x87);
	boe_dcs_write_seq_static(ctx, 0x2A, 0x1C, 0x1D, 0x16, 0x1D);
	boe_dcs_write_seq_static(ctx, 0x2B, 0xD3, 0xA9, 0x9C, 0x7C);
	boe_dcs_write_seq_static(ctx, 0x2D, 0x00, 0x00, 0x00, 0x0E, 0x00, 0xC0, 0x0F,
			0x04, 0x00);
	boe_dcs_write_seq_static(ctx, 0x2F, 0x0B);
	boe_dcs_write_seq_static(ctx, 0x30, 0x87);
	boe_dcs_write_seq_static(ctx, 0x32, 0x87);
	...
	boe_dcs_write_seq_static(ctx, 0x3A, 0x87);
	boe_dcs_write_seq_static(ctx, 0x3D, 0x00, 0x80, 0x28, 0x20);
	boe_dcs_write_seq_static(ctx, 0x3F, 0x00);
	boe_dcs_write_seq_static(ctx, 0x40, 0x82);
	boe_dcs_write_seq_static(ctx, 0x41, 0x82);
	boe_dcs_write_seq_static(ctx, 0x42, 0x82);
	boe_dcs_write_seq_static(ctx, 0x43, 0x02);
	boe_dcs_write_seq_static(ctx, 0x44, 0x82);
	boe_dcs_write_seq_static(ctx, 0x45, 0x0B);
	boe_dcs_write_seq_static(ctx, 0x46, 0x82);
	boe_dcs_write_seq_static(ctx, 0x48, 0x82);
	boe_dcs_write_seq_static(ctx, 0x49, 0x04);
	boe_dcs_write_seq_static(ctx, 0x4A, 0x82);
	boe_dcs_write_seq_static(ctx, 0x4E, 0x61);
	boe_dcs_write_seq_static(ctx, 0x4F, 0x02);
	boe_dcs_write_seq_static(ctx, 0x50, 0x61);
	boe_dcs_write_seq_static(ctx, 0x52, 0x7D);
	boe_dcs_write_seq_static(ctx, 0x53, 0x02);
	boe_dcs_write_seq_static(ctx, 0x54, 0x72);
	boe_dcs_write_seq_static(ctx, 0x58, 0x7D);
	boe_dcs_write_seq_static(ctx, 0x5C, 0x7D);
	boe_dcs_write_seq_static(ctx, 0x60, 0x05);
	boe_dcs_write_seq_static(ctx, 0x61, 0x7D);
	boe_dcs_write_seq_static(ctx, 0x64, 0x05);
	boe_dcs_write_seq_static(ctx, 0x65, 0x7D);
	boe_dcs_write_seq_static(ctx, 0x69, 0x05);
	boe_dcs_write_seq_static(ctx, 0x6A, 0x7D);
	boe_dcs_write_seq_static(ctx, 0x6F, 0x61);
	boe_dcs_write_seq_static(ctx, 0x70, 0x02);
	boe_dcs_write_seq_static(ctx, 0x71, 0x61);
	boe_dcs_write_seq_static(ctx, 0x73, 0x7D);
	...
	boe_dcs_write_seq_static(ctx, 0x80, 0xEE);
	boe_dcs_write_seq_static(ctx, 0x81, 0xEE);
	boe_dcs_write_seq_static(ctx, 0x82, 0x00, 0x4C, 0x4C, 0x4C);
	boe_dcs_write_seq_static(ctx, 0x84, 0x1F, 0x1F, 0x1F);
	boe_dcs_write_seq_static(ctx, 0x8B, 0x64);
	boe_dcs_write_seq_static(ctx, 0x8C, 0x05);
	boe_dcs_write_seq_static(ctx, 0x8D, 0x00);
	boe_dcs_write_seq_static(ctx, 0x8F, 0x00);
	boe_dcs_write_seq_static(ctx, 0x92, 0x51);
	boe_dcs_write_seq_static(ctx, 0x93, 0x33);
	boe_dcs_write_seq_static(ctx, 0x94, 0x32);
	boe_dcs_write_seq_static(ctx, 0x96, 0x01);
	boe_dcs_write_seq_static(ctx, 0x97, 0x00, 0x00);
	boe_dcs_write_seq_static(ctx, 0x99, 0x15, 0x1E, 0x04);
	boe_dcs_write_seq_static(ctx, 0x9A, 0x30, 0x94, 0x3B, 0xC9);
	boe_dcs_write_seq_static(ctx, 0x9C, 0xFF, 0xEC, 0xEC, 0xEC);
	boe_dcs_write_seq_static(ctx, 0x9D, 0x15, 0x1E, 0x04);
	boe_dcs_write_seq_static(ctx, 0x9E, 0x2A, 0x8C, 0x00, 0xC4);
	boe_dcs_write_seq_static(ctx, 0xA7, 0x06);
	...
	boe_dcs_write_seq_static(ctx, 0xCF, 0x01, 0x00, 0x24);
	...
	boe_dcs_write_seq_static(ctx, 0x5B, 0x76);
	...
	boe_dcs_write_seq_static(ctx, 0x79, 0xB5);
	boe_dcs_write_seq_static(ctx, 0x7A, 0x00);
	boe_dcs_write_seq_static(ctx, 0x7B, 0x77);
	boe_dcs_write_seq_static(ctx, 0x7D, 0x04);
	boe_dcs_write_seq_static(ctx, 0x7E, 0x43);
	boe_dcs_write_seq_static(ctx, 0x7F, 0x03);
	boe_dcs_write_seq_static(ctx, 0x80, 0xEB, 0x07);
	boe_dcs_write_seq_static(ctx, 0x81, 0x23, 0x00);
	boe_dcs_write_seq_static(ctx, 0x82, 0x3D, 0x40);
	boe_dcs_write_seq_static(ctx, 0x83, 0x12, 0x00);
	boe_dcs_write_seq_static(ctx, 0x84, 0x20, 0x00);
	boe_dcs_write_seq_static(ctx, 0x85, 0x1F, 0x00);
	boe_dcs_write_seq_static(ctx, 0x86, 0x3D, 0x40);
	boe_dcs_write_seq_static(ctx, 0x87, 0x12, 0x00);
	boe_dcs_write_seq_static(ctx, 0x88, 0x20, 0x00);
	...
	boe_dcs_write_seq_static(ctx, 0x16, 0x1F);
	boe_dcs_write_seq_static(ctx, 0x17, 0x09);
	boe_dcs_write_seq_static(ctx, 0x18, 0x1F);
	boe_dcs_write_seq_static(ctx, 0x19, 0x09);
	boe_dcs_write_seq_static(ctx, 0x1A, 0x1F);
	boe_dcs_write_seq_static(ctx, 0x1B, 0x09);
	boe_dcs_write_seq_static(ctx, 0x1C, 0x1F);
	...
	boe_dcs_write_seq_static(ctx, 0x32, 0xB0);
	boe_dcs_write_seq_static(ctx, 0x33, 0xC9);
	...
	boe_dcs_write_seq_static(ctx, 0xFB, 0x01);
	boe_dcs_write_seq_static(ctx, 0x3B, 0x03, 0x7A, 0x1A, 0x0A, 0x0A, 0x00);
	boe_dcs_write_seq_static(ctx, 0x90, 0x13);
	boe_dcs_write_seq_static(ctx, 0x91, 0x89, 0x28, 0x00, 0x14, 0xD2, 0x00, 0x00,
			0x00, 0x02, 0xA1, 0x00, 0x14, 0x05, 0x7A, 0x01, 0xDA);
	boe_dcs_write_seq_static(ctx, 0x92, 0x10, 0xE0);
	boe_dcs_write_seq_static(ctx, 0x9D, 0x01);
	boe_dcs_write_seq_static(ctx, 0xB2, 0x00);
...
static const struct drm_display_mode default_mode = {
	...
	.hdisplay = 2944,
	.hsync_start = 2944 + 86,
	.hsync_end = 2944 + 86 + 10,
	.htotal = 2944 + 86 + 10 + 84,
	.vdisplay = 1840,
	.vsync_start = 1840 + 26,
	.vsync_end = 1840 + 26 + 2,
	.vtotal = 1840 + 26 + 2 + 120,
};
...
static const struct of_device_id boe_of_match[] = {
	{
		.compatible = "boe,ts127qfmll1dkp0,120hz",
	},
	{}
};
...
static struct mipi_dsi_driver boe_driver = {
	...
	.remove = boe_remove,
	.driver = {
			.name = "panel-boe-ts127qfmll1dkp0-120hz",
			.owner = THIS_MODULE,
...
MODULE_DESCRIPTION("boe ts127qfmll1dkp0 wqxga2944 120Hz DPHY sPanel Driver");
MODULE_LICENSE("GPL");
