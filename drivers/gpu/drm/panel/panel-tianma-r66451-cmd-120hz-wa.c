	...
	enum MTK_PANEL_MODE_SWITCH_STAGE stage)
{
	if (stage == BEFORE_DSI_POWERDOWN) {
		...
		struct mtk_mode_switch_cmd cmd_table[15] = {
			{2, {0xB0, 0x00}},
			{13, {0xB6, 0x6A, 0x00, 0x06, 0x23, 0x8A, 0x13, 0x1A, 0x05, 0x04,
				0xFA, 0x05, 0x20}},
			{2, {0xB0, 0x04}},
			{44, {0xC1, 0x94, 0x42, 0x00, 0x16, 0x05, 0x00, 0x00, 0x00, 0x10,
				0x00, 0x10, 0x00, 0xAA, 0x8A, 0x02, 0x10, 0x00, 0x10, 0x00,
				0x00, 0x3F, 0x3F, 0x03, 0xFF, 0x03, 0xFF, 0x23, 0xFF, 0x03,
				0xFF, 0x23, 0xFF, 0x03, 0xFF, 0x00, 0x40, 0x40, 0x00, 0x00,
				0x10, 0x01, 0x00, 0x0C}},
			{7, {0xC2, 0x09, 0x24, 0x0E, 0x00, 0x00, 0x0E}},
			{19, {0xC4, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x35, 0x00, 0x01}},
			{134, {}},
			{10, {0xD7, 0x00, 0x69, 0x34, 0x00, 0xA0, 0x0A, 0x00, 0x00, 0x39}},
			{60, {0xD8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x3A, 0x00, 0x3A, 0x00, 0x3A, 0x00, 0x3A, 0x00, 0x3A, 0x05,
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x20, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x00, 0x00, 0x00, 0x0F, 0x00, 0x32, 0x00, 0x00,
				0x00, 0x17, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
			{50, {0xBB, 0x59, 0xC8, 0xC8, 0xC8, 0xC8, 0xC8, 0xC8, 0xC8, 0xC8,
				0xC8, 0x4A, 0x48, 0x46, 0x44, 0x42, 0x40, 0x3E, 0x3C, 0x3A,
				0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
				0x04, 0x00, 0x02, 0x02, 0x00, 0x04, 0x69, 0x5A, 0x00, 0x0B,
				0x76, 0x0F, 0xFF, 0x0F, 0xFF, 0x0F, 0xFF, 0x14, 0x81, 0xF4}},
			{3, {0xE8, 0x00, 0x02}},
			{3, {0xE4, 0x00, 0x0A}},
			{2, {0xB0, 0x84}},
			{10, {0xE4, 0x33, 0xB4, 0x00, 0x00, 0x00, 0x39, 0x04, 0x09, 0x34}},
			{2, {0xE6, 0x01}}
		};

		memset(&ext_params_mode_2.mode_switch_cmd, 0,
			sizeof(struct mode_switch_params));
		ext_params_mode_2.mode_switch_cmd.num_cmd = 15;
		memcpy(&ext_params_mode_2.mode_switch_cmd.ms_table, &cmd_table,
			sizeof(struct mtk_mode_switch_cmd)*15);
#else
		struct tianma *ctx = panel_to_tianma(panel);
	...
	enum MTK_PANEL_MODE_SWITCH_STAGE stage)
{
	if (stage == BEFORE_DSI_POWERDOWN) {
#if MODE_SWITCH_CMDQ_ENABLE
		struct mtk_mode_switch_cmd cmd_table[17] = {
			{2, {0xB0, 0x00}},
			{13, {0xB6, 0x59, 0x00, 0x06, 0x23, 0x8A, 0x13, 0x1A, 0x05, 0x04,
				0xFA, 0x05, 0x20}},
			{2, {0xB0, 0x04}},
			{2, {0xF1, 0x2A}},
			{2, {0xC1, 0x0C}},
			{7, {0xC2, 0x09, 0x24, 0x0E, 0x00, 0x00, 0x0E}},
			{6, {0xC1, 0x94, 0x42, 0x00, 0x16, 0x05}},
			{134, {0xCF, 0x64, 0x0B, 0x00, 0x28, 0x02, 0x4B, 0x02, 0xDE, 0x0B,
				0x77, 0x0B, 0x8B, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02,
				0x02, 0x02, 0x03, 0x03, 0x03, 0x00, 0x3D, 0x00, 0xCD, 0x00,
				0xCD, 0x00, 0xCD, 0x00, 0xCD, 0x01, 0x00, 0x01, 0x00, 0x03,
				0x98, 0x03, 0x98, 0x03, 0x98, 0x03, 0x98, 0x03, 0x98, 0x00,
				0x3D, 0x00, 0xCD, 0x00, 0xCD, 0x00, 0xCD, 0x00, 0xCD, 0x01,
				0x00, 0x01, 0x00, 0x03, 0x98, 0x03, 0x98, 0x03, 0x98, 0x03,
				0x98, 0x03, 0x98, 0x01, 0x42, 0x01, 0x42, 0x01, 0x42, 0x01,
				0x42, 0x01, 0x42, 0x01, 0x42, 0x01, 0x42, 0x01, 0x42, 0x01,
				0x42, 0x01, 0x42, 0x01, 0x42, 0x01, 0x42, 0x1C, 0x1C, 0x1C,
				0x1C, 0x1C, 0x1C, 0x1C, 0x1C, 0x1C, 0x1C, 0x1C, 0x1C, 0x00,
				0x88, 0x00, 0xB1, 0x00, 0xB1, 0x09, 0xA6, 0x09, 0xA6, 0x09,
				...
				0xA4, 0x0F, 0xC3, 0x19}},
			{19, {0xC4, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x48, 0x00, 0x01}},
			{10, {0xD7, 0x00, 0x69, 0x34, 0x00, 0xA0, 0x0A, 0x00, 0x00, 0x4E}},
			{60, {0xD8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x4D, 0x00, 0x4D, 0x00, 0x4D, 0x00, 0x4D, 0x00, 0x4D, 0x05,
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x00, 0x4E, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x00, 0x00, 0x00, 0x16, 0x00, 0x44, 0x00, 0x00,
			...
			{3, {0xE4, 0x00, 0x0A}},
			{2, {0xB0, 0x84}},
			{10, {0xE4, 0x33, 0xB4, 0x00, 0x00, 0x00, 0x4E, 0x04, 0x04, 0x9A}},
			{2, {0xE6, 0x01}}
		};

		memset(&ext_params_mode_1.mode_switch_cmd, 0,
			sizeof(struct mode_switch_params));
		ext_params_mode_1.mode_switch_cmd.num_cmd = 17;
		memcpy(&ext_params_mode_1.mode_switch_cmd.ms_table, &cmd_table,
			sizeof(struct mtk_mode_switch_cmd)*17);
#else
		struct tianma *ctx = panel_to_tianma(panel);
		/* set PLL to 285M */
		tianma_dcs_write_seq_static(ctx, 0xB0, 0x00);
	...
	enum MTK_PANEL_MODE_SWITCH_STAGE stage)
{
	...
	if (stage == BEFORE_DSI_POWERDOWN) {
		...
		struct mtk_mode_switch_cmd cmd_table[17] = {
			{2, {0xB0, 0x00}},
			{13, {0xB6, 0x51, 0x00, 0x06, 0x23, 0x8A, 0x13, 0x1A, 0x05, 0x04,
				0xFA, 0x05, 0x20}},
			{2, {0xB0, 0x04}},
			{2, {0xF1, 0x2A}},
			{2, {0xC1, 0x0C}},
			...
			{6, {0xC1, 0x94, 0x42, 0x00, 0x16, 0x05}},
			{134, {0xCF, 0x64, 0x0B, 0x00, 0x28, 0x02, 0x4B, 0x02, 0xDE, 0x0B,
				0x77, 0x0B, 0x8B, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x01, 0x01, 0x01, 0x00, 0x3D, 0x00, 0xCD, 0x00,
				0xCD, 0x00, 0xCD, 0x00, 0xCD, 0x01, 0x00, 0x01, 0x00, 0x03,
				0x98, 0x03, 0x98, 0x03, 0x98, 0x03, 0x98, 0x03, 0x98, 0x00,
				0x3D, 0x00, 0xCD, 0x00, 0xCD, 0x00, 0xCD, 0x00, 0xCD, 0x01,
				0x00, 0x01, 0x00, 0x03, 0x98, 0x03, 0x98, 0x03, 0x98, 0x03,
				...
				0xA4, 0x0F, 0xC3, 0x19}},
			{19, {0xC4, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x68, 0x00, 0x01}},
			{10, {0xD7, 0x00, 0x69, 0x34, 0x00, 0xA0, 0x0A, 0x00, 0x00, 0x75}},
			{60, {0xD8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x74, 0x00, 0x74, 0x00, 0x74, 0x00, 0x74, 0x00, 0x74, 0x05,
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x00, 0x75, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x00, 0x00, 0x00, 0x22, 0x00, 0x65, 0x00, 0x00,
				0x00, 0x2F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
			{50, {0xBB, 0x59, 0xC8, 0xC8, 0xC8, 0xC8, 0xC8, 0xC8, 0xC8, 0xC8,
				0xC8, 0x4A, 0x48, 0x46, 0x44, 0x42, 0x40, 0x3E, 0x3C, 0x3A,
				0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
				0x04, 0x00, 0x01, 0x01, 0x00, 0x04, 0x69, 0x5A, 0x00, 0x0B,
				0x76, 0x0F, 0xFF, 0x0F, 0xFF, 0x0F, 0xFF, 0x14, 0x81, 0xF4}},
			{3, {0xE8, 0x00, 0x02}},
			{3, {0xE4, 0x00, 0x0A}},
			{2, {0xB0, 0x84}},
			{10, {0xE4, 0x33, 0xB4, 0x00, 0x00, 0x00, 0x75, 0x04, 0x00, 0x00}},
			{2, {0xE6, 0x01}}
		};

		memset(&ext_params.mode_switch_cmd, 0, sizeof(struct mode_switch_params));
		ext_params.mode_switch_cmd.num_cmd = 17;
		...
		unsigned int dst_mode, enum MTK_PANEL_MODE_SWITCH_STAGE stage)
{
	...
	if (cur_mode == dst_mode || stage == AFTER_DSI_POWERON) {
		ret = 1;
		return ret;
	}
