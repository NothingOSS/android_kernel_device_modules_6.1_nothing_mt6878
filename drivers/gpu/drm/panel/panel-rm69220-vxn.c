...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	lcm_dcs_write_seq_static(ctx,  0x2F, 0x05);		//120hz
...
static struct mtk_panel_params ext_params_30hz = {
	...
	.dyn_fps = {
		...
		.aod_high_cmd_table[0] = {0, 3, {0x51, 0x0F, 0xFE} },        //AOD 60nit
		.aod_middle_cmd_table[0] = {0, 3, {0x51, 0x07, 0xFF} },  //AOD 30nit
		.aod_low_cmd_table[0] = {0, 3, {0x51, 0x01, 0x55} },          //AOD 5nit
	},
};
/*
