...
unsigned int nt37801_rc_buf_thresh[14] = {896, 1792, 2688, 3584, 4480, 5376,
		6272, 6720, 7168, 7616, 7744, 7872, 8000, 8064};
unsigned int nt37801_range_min_qp[15] = {0, 2, 3, 5, 5, 6, 6, 7, 7, 7, 8, 8, 9, 11, 14};
unsigned int nt37801_range_max_qp[15] = {4, 6, 7, 9, 10, 11, 11, 12, 12, 13, 13, 13, 13, 14, 15};
int nt37801_range_bpg_ofs[15] = {2, 0, 0, -2, -4, -6, -8, -8, -8, -10, -10, -10, -12, -12, -12};
...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	lcm_dcs_write_seq_static(ctx, 0xDE, 0x30, 0x14, 0x25, 0x10, 0x34, 0x25);//bgrg
	...
	lcm_dcs_write_seq_static(ctx, 0x93, 0xA0, 0xF0, 0x00, 0x08, 0xD1,
		0x00, 0x01, 0xD6, 0x00, 0x40, 0x00, 0x3C, 0x0E, 0xDC, 0x36, 0x00, 0x11, 0x50);

	lcm_dcs_write_seq_static(ctx, 0xFF, 0xaa, 0x55, 0xa5, 0x81);
	lcm_dcs_write_seq_static(ctx, 0x6f, 0x1d);
	lcm_dcs_write_seq_static(ctx, 0xfb, 0x6f);
...
static struct mtk_panel_params ext_params = {
	...
	.spr_params = {
		...
		.spr_format_type = MTK_PANEL_BGRG_RGBG_TYPE,
		//.rg_xy_swap = 1,
		.spr_ip_params = nt37801_spr_ip_bgrg_cfg,
		.spr_ip_shrink_params = nt37801_spr_ip_shrink_bgrg_cfg,
	...
	.dsc_params_spr_in  = {
		...
		.dec_delay = 470,
		.scale_value = 10,
		.increment_interval = 64,
		.decrement_interval = 60,
		.line_bpg_offset = 13,
		.nfl_bpg_offset = 3804,
		.slice_bpg_offset = 13824,
		.initial_offset = 2048,
		.final_offset = 4432,
		.flatness_minqp = 7,
		.flatness_maxqp = 16,
		...
		.ext_pps_cfg = {
			.enable = 1,
			.rc_buf_thresh = nt37801_rc_buf_thresh,
			.range_min_qp = nt37801_range_min_qp,
			.range_max_qp = nt37801_range_max_qp,
	...
	unsigned int x, unsigned int y, unsigned int w, unsigned int h)
{
	...
	//set TE scan line: display total line - slice height + 8 = 3160
	lcm_dcs_write_seq_static(ctx, 0x44, 0x0c, 0x60);
