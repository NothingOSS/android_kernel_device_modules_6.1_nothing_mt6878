...
#ifndef __MT6878_APUPWR_H__
#define __MT6878_APUPWR_H__
...
void mt6878_apu_dump_rpc_status(enum t_acx_id id, struct rpc_status_dump *dump);
...
// mt6319_6_vbuck3 (in mt6878 for vapu)
#define MT6319_6_VBUCK3_SLAVE_ID                         (0x6)
#define MT6319_6_VBUCK3_PMIC_RG_BUCK_VBUCK1_EN_ADDR      (0x1440)
#define MT6319_6_VBUCK3_PMIC_RG_BUCK_VBUCK1_EN_SET       (0x1441) // for buck on
#define MT6319_6_VBUCK3_PMIC_RG_BUCK_VBUCK1_EN_CLR       (0x1442) // for buck off
#define MT6319_6_VBUCK3_PMIC_RG_BUCK_VBUCK1_EN_SHIFT     (2)
#define MT6319_6_VBUCK3_PMIC_RG_BUCK_VBUCK1_VOSEL_ADDR   (0x144d) // for voltage change

#define BUCK_VAPU_PMIC_ID               MT6319_6_VBUCK3_SLAVE_ID
#define BUCK_VAPU_PMIC_REG_EN_ADDR      MT6319_6_VBUCK3_PMIC_RG_BUCK_VBUCK1_EN_ADDR
#define BUCK_VAPU_PMIC_REG_EN_SET_ADDR  MT6319_6_VBUCK3_PMIC_RG_BUCK_VBUCK1_EN_SET
#define BUCK_VAPU_PMIC_REG_EN_CLR_ADDR  MT6319_6_VBUCK3_PMIC_RG_BUCK_VBUCK1_EN_CLR
#define BUCK_VAPU_PMIC_REG_EN_SHIFT     MT6319_6_VBUCK3_PMIC_RG_BUCK_VBUCK1_EN_SHIFT
#define BUCK_VAPU_PMIC_REG_VOSEL_ADDR	MT6319_6_VBUCK3_PMIC_RG_BUCK_VBUCK1_VOSEL_ADDR

// mt6369_vdigrf_apu (in mt6878 for vsram_apu)
#define MT6369_VDIGRF_SLAVE_ID                         (0x5)
#define MT6369_VDIGRF_PMIC_RG_LDO_VSRAM_APU_EN_ADDR    (0x1d21)
#define MT6369_VDIGRF_PMIC_RG_LDO_VSRAM_APU_EN_SHIFT   (0)

// LP mode depends on EN has already raised !
#define MT6369_VDIGRF_PMIC_RG_LDO_VSRAM_APU_LP_SHIFT  (1)

#define LDO_VSRAM_PMIC_ID               MT6369_VDIGRF_SLAVE_ID
#define LDO_VSRAM_PMIC_REG_EN_ADDR      MT6369_VDIGRF_PMIC_RG_LDO_VSRAM_APU_EN_ADDR
#define LDO_VSRAM_PMIC_REG_EN_SHIFT     MT6369_VDIGRF_PMIC_RG_LDO_VSRAM_APU_EN_SHIFT
#define LDO_VSRAM_PMIC_REG_LP_SHIFT     MT6369_VDIGRF_PMIC_RG_LDO_VSRAM_APU_LP_SHIFT
...
int mt6878_all_on(struct platform_device *pdev, struct apu_power *papw);
void mt6878_all_off(struct platform_device *pdev);
#endif // __mt6878_APUPWR_H__
