 ...
 */
#ifndef __MT6989_APUPWR_PROT_H__
#define __MT6989_APUPWR_PROT_H__
#include "apu_top.h"
#include "mt6989_apupwr.h"
// mbox offset define (for data exchange with remote)
#define SPARE_DBG_REG10		0x1428	// mbox12_dummy10
#define SPARE_DBG_REG11		0x142C	// mbox12_dummy11
#define SPARE_DBG_REG12		0x1430	// mbox12_dummy12
#define SPARE_DBG_REG13		0x1434	// mbox12_dummy13
#define SPARE_DBG_REG14		0x1438	// mbox12_dummy14
#define SPARE_DBG_REG15		0x143C	// mbox12_dummy15
#define SPARE_DBG_REG16		0x1440	// mbox12_dummy16
#define SPARE_DBG_REG17		0x1444	// mbox12_dummy17
#define SPARE_DBG_REG18		0x1448	// mbox12_dummy17
...
void mt6989_aputop_opp_limit(struct aputop_func_param *aputop,
		enum apu_opp_limit_type type);
#if IS_ENABLED(CONFIG_DEBUG_FS)
int mt6989_apu_top_dbg_open(struct inode *inode, struct file *file);
ssize_t mt6989_apu_top_dbg_write(
		struct file *flip, const char __user *buffer,
		size_t count, loff_t *f_pos);
#endif
int mt6989_init_remote_data_sync(void __iomem *reg_base);
int mt6989_drv_cfg_remote_sync(struct aputop_func_param *aputop);
int mt6989_apu_top_rpmsg_cb(int cmd, void *data, int len, void *priv, u32 src);
#endif
