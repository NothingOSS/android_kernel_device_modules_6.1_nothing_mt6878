...
#include "mdp_engine_mt6897.h"
#include "mdp_base_mt6897.h"
#include <cmdq-util.h>
...
ACTION(CMDQ_ENG_MDP_RDMA2,  MDP_RDMA2)	\
ACTION(CMDQ_ENG_MDP_RDMA3,  MDP_RDMA3)	\
ACTION(CMDQ_ENG_MDP_HDR0,   MDP_HDR0)	\
ACTION(CMDQ_ENG_MDP_HDR1,   MDP_HDR1)	\
ACTION(CMDQ_ENG_MDP_AAL0,   MDP_AAL0)	\
ACTION(CMDQ_ENG_MDP_AAL1,   MDP_AAL1)	\
ACTION(CMDQ_ENG_MDP_RSZ0,   MDP_RSZ0)	\
ACTION(CMDQ_ENG_MDP_RSZ1,   MDP_RSZ1)	\
ACTION(CMDQ_ENG_MDP_BIRSZ0, MDP_BIRSZ0)	\
ACTION(CMDQ_ENG_MDP_BIRSZ1, MDP_BIRSZ1)	\
...
struct CmdqMdpModuleClock {
	...
	struct clk *clk_MDP_BIRSZ0;
	struct clk *clk_MDP_BIRSZ1;
...
IMP_ENABLE_MDP_HW_CLOCK(MDP_BIRSZ0, MDP_BIRSZ0);
IMP_ENABLE_MDP_HW_CLOCK(MDP_BIRSZ1, MDP_BIRSZ1);
...
IMP_MDP_HW_CLOCK_IS_ENABLE(MDP_BIRSZ0, MDP_BIRSZ0);
IMP_MDP_HW_CLOCK_IS_ENABLE(MDP_BIRSZ1, MDP_BIRSZ1);
...
long cmdq_mdp_get_module_base_VA_MDP_BIRSZ0(void)
{
	return gCmdqMdpModuleBaseVA.MDP_BIRSZ0;
}

long cmdq_mdp_get_module_base_VA_MDP_BIRSZ1(void)
{
	return gCmdqMdpModuleBaseVA.MDP_BIRSZ1;
}
...
#define MDP_BIRSZ0_BASE		cmdq_mdp_get_module_base_VA_MDP_BIRSZ0()
#define MDP_BIRSZ1_BASE		cmdq_mdp_get_module_base_VA_MDP_BIRSZ1()
...
static void cmdq_core_dump_mmsys_config(void)
{
	...
	static const struct RegDef configRegisters[] = {
		...
		{0x504, "MDP_RDMA1_AIDSEL"},
		{0x508, "MDP_WROT0_AIDSEL"},
		{0x50C, "MDP_WROT1_AIDSEL"},
		{0x51C, "MDP_RDMA2_AIDSEL"},
		{0x520, "MDP_RDMA3_AIDSEL"},
		{0x524, "MDP_AID_SEL_MODE"},
		...
		{0xF0C,	"MDPSYS_SECURITY_DISABLE"},
		{0xF10,	"MDPSYS_SECURITY_DISABLE1"},
		...
		{0xFA8, "MDP_HDR0_SOUT_SEL"},
		{0xFAC, "MDP_HDR1_SOUT_SEL"},
		{0xF40, "MDP_AAL0_SEL_IN"},
		{0xF44, "MDP_AAL1_SEL_IN"},
		{0xF48, "MDP_TDSHP0_SOUT_SEL"},
		{0xF4C, "MDP_TDSHP1_SOUT_SEL"},
		{0xF50, "MDP_COLOR0_SEL_IN"},
		{0xF54, "MDP_COLOR1_SEL_IN"},
		{0xF58, "MDP_COLOR0_SOUT_SEL"},
		{0xF5C, "MDP_COLOR1_SOUT_SEL"},
		{0xF60, "MDP_TDSHP0_SEL_IN"},
		{0xF64, "MDP_TDSHP1_SEL_IN"},
		{0xF68,	"MDP_AAL0_MOUT_EN"},
		{0xF6C,	"MDP_AAL1_MOUT_EN"},
...
int32_t cmdq_mdp_reset_with_mmsys(const uint64_t engineToResetAgain)
{
	...
	int engineResetBit[32] = {
		...
		CMDQ_ENG_MDP_RDMA2,	/* bit  4 : mdp_rdma2 */
		...
		CMDQ_ENG_MDP_RDMA3,	/* bit 16 : mdp_rdma3 */
...
void cmdq_mdp_deinit_module_base_VA(void)
{
	...
	cmdq_dev_free_module_base_VA(cmdq_mdp_get_module_base_VA_MDP_BIRSZ0());
	cmdq_dev_free_module_base_VA(cmdq_mdp_get_module_base_VA_MDP_BIRSZ1());
...
bool cmdq_mdp_clock_is_on(u32 engine)
{
	...
	case CMDQ_ENG_MDP_BIRSZ0:
		return cmdq_mdp_clock_is_enable_MDP_BIRSZ0();
	case CMDQ_ENG_MDP_BIRSZ1:
		return cmdq_mdp_clock_is_enable_MDP_BIRSZ1();
...
void cmdq_mdp_enable_clock(bool enable, u32 engine)
{
	...
	case CMDQ_ENG_MDP_RSZ1:
		...
		break;
	case CMDQ_ENG_MDP_BIRSZ0:
		cmdq_mdp_enable_clock_MDP_BIRSZ0(enable);
		break;
	case CMDQ_ENG_MDP_BIRSZ1:
		cmdq_mdp_enable_clock_MDP_BIRSZ1(enable);
		break;
	case CMDQ_ENG_MDP_WROT0:
...
void cmdq_mdp_dump_rsz(const unsigned long base, const char *label)
{
	...
	value[18] = CMDQ_REG_GET32(base + 0x048);   /*  RSZ_DEBUG_13    */
	CMDQ_REG_SET32(base + 0x044, 0x0000000E);
	value[19] = CMDQ_REG_GET32(base + 0x048);   /*  RSZ_DEBUG_14    */
	value[20] = CMDQ_REG_GET32(base + 0x100);   /*  PAT1_GEN_SET    */
	value[21] = CMDQ_REG_GET32(base + 0x200);   /*  PAT2_GEN_SET    */
	value[22] = CMDQ_REG_GET32(base + 0x00C);   /*  RSZ_INT_FLAG    */
	/*  RSZ_LUMA_HORIZONTAL_INTEGER_OFFSET  */
	value[23] = CMDQ_REG_GET32(base + 0x020);
	/*  RSZ_LUMA_HORIZONTAL_SUBPIXEL_OFFSET */
	value[24] = CMDQ_REG_GET32(base + 0x024);
	/*  RSZ_LUMA_VERTICAL_INTEGER_OFFSET    */
	value[25] = CMDQ_REG_GET32(base + 0x028);
	/*  RSZ_LUMA_VERTICAL_SUBPIXEL_OFFSET   */
	value[26] = CMDQ_REG_GET32(base + 0x02C);
	/*  RSZ_CHROMA_HORIZONTAL_INTEGER_OFFSET    */
	value[27] = CMDQ_REG_GET32(base + 0x030);
	/*  RSZ_CHROMA_HORIZONTAL_SUBPIXEL_OFFSET   */
	value[28] = CMDQ_REG_GET32(base + 0x034);
	/*  RSZ_RSV */
	value[29] = CMDQ_REG_GET32(base + 0x040);
	value[30] = CMDQ_REG_GET32(base + 0x04C);   /*  RSZ_TAP_ADAPT	*/
	value[31] = CMDQ_REG_GET32(base + 0x050);   /*  RSZ_IBSE_SOFTCLIP */
	value[32] = CMDQ_REG_GET32(base + 0x22C);   /*  RSZ_ETC_CONTROL	*/
	/*  RSZ_ETC_SWITCH_MAX_MIN_1	*/
	value[33] = CMDQ_REG_GET32(base + 0x230);
	/*  RSZ_ETC_SWITCH_MAX_MIN_2	*/
	value[34] = CMDQ_REG_GET32(base + 0x234);
	/*  RSZ_ETC_RING_CONTROL	*/
	value[35] = CMDQ_REG_GET32(base + 0x238);
	/*  RSZ_ETC_RING_CONTROL_GAINCONTROL_1	*/
	value[36] = CMDQ_REG_GET32(base + 0x23C);
	/*  RSZ_ETC_RING_CONTROL_GAINCONTROL_2	*/
	value[37] = CMDQ_REG_GET32(base + 0x240);
	/*  RSZ_ETC_RING_CONTROL_GAINCONTROL_3	*/
	value[38] = CMDQ_REG_GET32(base + 0x244);
	/*  RSZ_ETC_SIMILARITY_PROTECTION_GAINCONTROL_1	*/
	value[39] = CMDQ_REG_GET32(base + 0x248);
	/*  RSZ_ETC_SIMILARITY_PROTECTION_GAINCONTROL_2	*/
	value[40] = CMDQ_REG_GET32(base + 0x24C);
	/*  RSZ_ETC_SIMILARITY_PROTECTION_GAINCONTROL_3	*/
	value[41] = CMDQ_REG_GET32(base + 0x250);
	value[42] = CMDQ_REG_GET32(base + 0x254);   /*  RSZ_ETC_BLEND	*/
...
void cmdq_mdp_dump_tdshp(const unsigned long base, const char *label)
{
	...
	value[2] = CMDQ_REG_GET32(base + 0x104); /* MDP_TDSHP_INTER */
	value[3] = CMDQ_REG_GET32(base + 0x108); /* MDP_TDSHP_INTSTA */
	value[4] = CMDQ_REG_GET32(base + 0x10C); /* MDP_TDSHP_STATUS */
	value[5] = CMDQ_REG_GET32(base + 0x110); /* MDP_TDSHP_CFG */
	value[6] = CMDQ_REG_GET32(base + 0x120); /* MDP_TDSHP_INPUT_SIZE */
	value[7] = CMDQ_REG_GET32(base + 0x124); /* MDP_TDSHP_OUTPUT_OFFSET */
...
void cmdq_mdp_dump_aal(const unsigned long base, const char *label)
{
	...
	value[2] = CMDQ_REG_GET32(base + 0x020);    /* MDP_AAL_CFG       */
	value[3] = CMDQ_REG_GET32(base + 0x024);    /* MDP_AAL_INPUT_COUNT  */
	value[4] = CMDQ_REG_GET32(base + 0x028);    /* MDP_AAL_OUTPUT_COUNT */
	value[5] = CMDQ_REG_GET32(base + 0x030);    /* MDP_AAL_SIZE         */
	value[6] = CMDQ_REG_GET32(base + 0x034);    /* MDP_AAL_OUTPUT_SIZE  */
	value[7] = CMDQ_REG_GET32(base + 0x038);    /* MDP_AAL_OUTPUT_OFFSET*/
	value[8] = CMDQ_REG_GET32(base + 0x4EC);    /* MDP_AAL_TILE_00      */
	value[9] = CMDQ_REG_GET32(base + 0x4F0);    /* MDP_AAL_TILE_01      */
	CMDQ_ERR(
		"=============== [CMDQ] %s Status ====================================\n",
		label);
...
int32_t cmdqMdpClockOn(uint64_t engineFlag)
{
	...
	cmdq_mdp_enable(engineFlag, CMDQ_ENG_MDP_BIRSZ0);
	cmdq_mdp_enable(engineFlag, CMDQ_ENG_MDP_BIRSZ1);
...
int32_t cmdqMdpDumpInfo(uint64_t engineFlag, int logLevel)
{
	...
	/*
	 * [TODO] should porting BIRSZ after DB, such as mdpDumpBiRsz(...)
	 */
	...
	if (logLevel >= 1) {
		...
		const struct MODULE_BASE bases[] = {
			...
			DEFINE_MODULE(CMDQ_ENG_MDP_BIRSZ0, MDP_BIRSZ0_BASE),
			DEFINE_MODULE(CMDQ_ENG_MDP_BIRSZ1, MDP_BIRSZ1_BASE),
...
enum MOUT_BITS {
	...
	MOUT_BITS_MDP_AAL0	=  4,  /* bit  4: mdp_aal0_mout multiple outupt reset */
	MOUT_BITS_MDP_AAL1	=  5,  /* bit  5: mdp_aal1_mout multiple outupt reset */
};
...
int32_t cmdqMdpClockOff(uint64_t engineFlag)
{
	...
	if (engineFlag & (1LL << CMDQ_ENG_MDP_BIRSZ0)) {
		if (cmdq_mdp_get_func()->mdpClockIsOn(CMDQ_ENG_MDP_BIRSZ0)) {
			CMDQ_REG_SET32(MDP_BIRSZ0_BASE, 0x0);

			CMDQ_MSG("Disable MDP_BIRSZ0 clock\n");
	...
	if (engineFlag & (1LL << CMDQ_ENG_MDP_BIRSZ1)) {
		if (cmdq_mdp_get_func()->mdpClockIsOn(CMDQ_ENG_MDP_BIRSZ1)) {
			CMDQ_REG_SET32(MDP_BIRSZ1_BASE, 0x0);

			CMDQ_MSG("Disable MDP_BIRSZ1 clock\n");
	...
	if (engineFlag & (1LL << CMDQ_ENG_MDP_RDMA2))
		cmdq_mdp_get_func()->enableMdpClock(false, CMDQ_ENG_MDP_RDMA2);

	if (engineFlag & (1LL << CMDQ_ENG_MDP_RDMA3))
		cmdq_mdp_get_func()->enableMdpClock(false, CMDQ_ENG_MDP_RDMA3);
...
void cmdqMdpInitialSetting(struct platform_device *pdev)
{
	...
	mtk_iommu_register_fault_callback(M4U_L2_P0_MDP_RDMA0,
		cmdq_TranslationFault_callback, (void *)pdev, false);
	mtk_iommu_register_fault_callback(M4U_L2_P1_MDP_RDMA1,
		cmdq_TranslationFault_callback, (void *)pdev, false);
	mtk_iommu_register_fault_callback(M4U_L2_P6_MDP_RDMA2,
		cmdq_TranslationFault_callback, (void *)pdev, false);
	mtk_iommu_register_fault_callback(M4U_L2_P7_MDP_RDMA3,
		cmdq_TranslationFault_callback, (void *)pdev, false);
	mtk_iommu_register_fault_callback(M4U_L2_P2_MDP_WROT0,
		cmdq_TranslationFault_callback, (void *)pdev, false);
	mtk_iommu_register_fault_callback(M4U_L2_P3_MDP_WROT1,
		cmdq_TranslationFault_callback, (void *)pdev, false);
#endif
...
static u32 cmdq_mdp_qos_translate_port(u32 engine_id)
{
	switch (engine_id) {
	case CMDQ_ENG_MDP_RDMA0:
		return M4U_L2_P0_MDP_RDMA0;
	case CMDQ_ENG_MDP_RDMA1:
		return M4U_L2_P1_MDP_RDMA1;
	case CMDQ_ENG_MDP_RDMA2:
		return M4U_L2_P6_MDP_RDMA2;
	case CMDQ_ENG_MDP_RDMA3:
		return M4U_L2_P7_MDP_RDMA3;
	case CMDQ_ENG_MDP_WROT0:
		return M4U_L2_P2_MDP_WROT0;
	case CMDQ_ENG_MDP_WROT1:
		return M4U_L2_P3_MDP_WROT1;
	}
...
static u16 mdp_get_reg_msb_offset(u32 eng_base, u16 offset)
{
	...
	if ((eng_base == ENGBASE_MDP_RDMA0) || (eng_base == ENGBASE_MDP_RDMA1)
		|| (eng_base == ENGBASE_MDP_RDMA2) || (eng_base == ENGBASE_MDP_RDMA3)) {
		if (offset == 0xF00)
