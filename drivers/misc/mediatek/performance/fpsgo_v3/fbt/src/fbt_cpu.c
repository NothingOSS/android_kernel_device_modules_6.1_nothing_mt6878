...
static int fbt_cal_aa(long loading, unsigned long long t_cpu, unsigned long long t_q2q,
					long *aa)
{
	int ret = 0;
...
static unsigned int fbt_cal_blc(long aa, unsigned long long target_time,
