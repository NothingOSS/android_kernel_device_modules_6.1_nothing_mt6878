...
static struct scenario_power_type_t md_scen_power_6897[SCENARIO_NUM] = {
	[S_STANDBY]		= {    1,    1},
	[S_2G_IDLE]		= {    50,  50},
	[S_C2K_DATALINK] = {   53,  53},
	[S_3G_IDLE]		= {    54,  54},
	[S_4G_1CC]		= {    139,    139},
	[S_4G_1CC_H]	= {    139,    139},
	[S_4G_2CC]		= {  139,  139},
	...
	[S_4G_4CC]		= {  286,  286},
	[S_4G_5CC]		= {  286,  286},
	[S_5G_NR_0CC_1TG]		= {  69,  69},
	[S_5G_NR_0CC_2TG]		= {  69,  69},
	[S_5G_NR_0CC_3TG]		= {  69,  69},
	[S_5G_FR1_1CC_1TG]		= {  179,  179},
	[S_5G_FR1_1CC_1TG_H]		= {  179,  179},
	[S_5G_FR1_2CC_1TG]		= {  349,  349},
	[S_5G_FR1_3_4CC_1TG]	= {  476,  476},
	[S_5G_FR1_1_4CC_2TG]	= {  476,  476},
	[S_5G_FR1_1_4CC_3TG]	= {  476,  476},
	[S_5G_FR2_1CC_1TG]		= {  476,  272},
	[S_5G_FR2_2_4CC_1TG]	= {  476,  476},
	[S_5G_FR2_5_8CC_1TG]	= {  476,  476},
	[S_5G_FR2_1_8CC_2TG]	= {  476,  476},
	[S_5G_FR2_1_8CC_3TG]	= {  476,  476},
	[S_5G_FR1_FR2]			= {  476,  476},
	[S_5G_FR1_1CC_1TG_4G_1CC]			= {  762,  762},
	[S_5G_FR1_1CC_1TG_4G_1CC_H]	= {  762,  762},
	[S_5G_FR2_1CC_1TG_4G_1CC_NR_0CC]	= {  762,  762},
	[S_5G_FR2_2_4CC_1TG_4G_1CC]			= {  762,  762},
	[S_5G_FR1_FR2_4G]					= {  762,  762},
	[S_4G_5G_POS_URGENT]				= {  556,  556}
};

static struct rfhw_power_t rfhw_6897[TX_DBM_NUM] = {
	[TX_2G_DBM] = {
		.pa_power = {
			{ 876,  684,  543,  436,  349,  282,
			   228,  186,  153,   126,   89,   58},   /*MAX*/
			{ 876,  684,  543,  436,  349,  282,
			   228,  186,  153,   126,   89,   58} }, /*AVG*/
		.rf_power = {
			{  121,  121,  118,  117,  116,  115,
			   114,  114,  115,  114,  113,  115},   /*MAX*/
			{  121,  121,  118,  117,  116,  115,
			   114,  114,  115,  114,  113,  115} }, /*AVG*/
		.section = {
			31, 30, 28, 26, 24, 22, 20, 18, 16, 12,  6,  0}
	},

	[TX_3G_DBM] = {
		.pa_power = {
			{  3762, 3328, 2178, 1922, 1456,  1303,
			   960,  868,  597,  552,  327,  172},   /*MAX*/
			{  3762, 3328, 2178, 1922, 1456,  1303,
			   960,  868,  597,  552,  327,  172} }, /*AVG*/
		.rf_power = {
			{  407,  416,  386,  366,  359,  355,
			   349,  304,  295,  293,  290,  268},   /*MAX*/
			{  407,  416,  386,  366,  359,  355,
			   349,  304,  295,  293,  290,  268} }, /*AVG*/
		.section = {
			23, 22, 21, 20, 19, 18, 17, 15,  14,  11,  6,  0}
	},
	...
	[TX_4G_CC0_DBM] = {
		.pa_power = {
			{  2136, 1365, 901, 624, 537,  450,
			   401,  381,  312,  296,  168,  118},   /*MAX*/
			{  2136, 1365, 901, 624, 537,  450,
			   401,  381,  312,  296,  168,  118} }, /*AVG*/
		.rf_power = {
			{  395,  366,  355,  314,  306,  307,
			   304,  285,  280,  279,  277,  279},   /*MAX*/
			{  395,  366,  355,  314,  306,  307,
			   304,  285,  280,  279,  277,  279} }, /*AVG*/
		.section = {
			23, 21, 19, 17, 16, 15, 14, 12,  10,  8,  6,  0}
	},
	...
	[TX_C2K_DBM] = {
		.pa_power = {
			{ 1282, 1154, 1016, 910, 611,  495,
			   447,  355,  278,  196,  121,  78},   /*MAX*/
			{ 1282, 1154, 1016, 910, 611,  495,
			   447,  355,  278,  196,  121,  78} }, /*AVG*/
		.rf_power = {
			{  164,  168,  162,  157,  156,  155,
			   137,  137,  137,  130,  85,  85},   /*MAX*/
			{  164,  168,  162,  157,  156,  155,
			   137,  137,  137,  130,  85,  85} }, /*AVG*/
		.section = {
			24, 23, 22, 21, 20, 19, 17, 16, 14,  9,  5,  0}
	},

	[TX_NR_CC0_DBM] = {
		.pa_power = {
			{  2964,  2420,  2039,  1563,  1406,  1261,
			   1061,  877,  982,  870,  478,  226},   /*MAX*/
			{  2964,  2420,  2039,  1563,  1406,  1261,
			   1061,  877,  982,  870,  478,  226} }, /*AVG*/
		.rf_power = {
			{  457,  452,  451,  435,  434,  435,
			   433,  430,  429,  430,  429,  431},   /*MAX*/
			{  457,  452,  451,  435,  434,  435,
			   433,  430,  429,  430,  429,  431} }, /*AVG*/
		.section = {
			23, 21, 20, 19, 18, 16, 13, 11,  10,  6,  4,  0}
	},
...
static struct scenario_power_type_t md_scen_power_6989[SCENARIO_NUM] = {
	[S_STANDBY]		= {  1,    1},
	[S_2G_IDLE]		= {  42,  42},
	[S_C2K_DATALINK]		= {  51,  51},
	[S_3G_IDLE]		= {  50,  50},
	[S_4G_1CC]		= {  137,  137},
	[S_4G_1CC_H]		= {  137,  137},
	[S_4G_2CC]		= {  137,  137},
	[S_4G_3CC]		= {  326,  326},
	[S_5G_NR_0CC_1TG]		= {  85,  85},
	[S_5G_NR_0CC_2TG]		= {  85,  85},
	[S_5G_NR_0CC_3TG]		= {  85,  85},
	[S_5G_FR1_1CC_1TG]		= {  185,  185},
	[S_5G_FR1_1CC_1TG_H]		= {  185,  185},
	[S_5G_FR1_2CC_1TG]		= {  434,  434},
	[S_5G_FR1_3_4CC_1TG]	= {  434,  434},
	[S_5G_FR1_1_4CC_2TG]	= {  434,  434},
	[S_5G_FR1_1_4CC_3TG]	= {  434,  434},
	[S_5G_FR2_1CC_1TG]	= {  245,  245},
	[S_5G_FR2_2_4CC_1TG]	= {  603,  603},
	[S_5G_FR1_FR2]	= {  988,  988},
	[S_5G_FR1_1CC_1TG_4G_1CC]	= {  759,  759},
	[S_5G_FR1_1CC_1TG_4G_1CC_H]	= {  759,  759},
	[S_5G_FR2_1CC_1TG_4G_1CC_NR_0CC]	= {  928,  928},
	[S_5G_FR1_FR2_4G]		= {  1313,  1313},
	[S_4G_5G_POS_URGENT]				= {  556,  556},
};

static struct rfhw_power_t rfhw_6989[TX_DBM_NUM] = {
	[TX_2G_DBM] = {
		.pa_power = {
			{ 1136,  1024,  848,  704,  576,  480,
			   400,  274,  221,   143,   93,   59},   /*MAX*/
