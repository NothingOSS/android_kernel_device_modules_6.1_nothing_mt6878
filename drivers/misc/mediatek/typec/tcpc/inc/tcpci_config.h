...
#define CONFIG_TYPEC_ATTACHED_SRC_SAFE5V_DELAY	0

#define CONFIG_TYPEC_LEGACY3_ALWAYS_LOCAL_RP	1
...
#define CONFIG_TYPEC_NOTIFY_ATTACHWAIT_SNK	0
#define CONFIG_TYPEC_NOTIFY_ATTACHWAIT_SRC	0

#define CONFIG_TYPEC_SNK_ONLY_WHEN_SUSPEND	0
...
#define CONFIG_USB_PD_ATTEMPT_DISCOVER_SVIDS	0
...
#define CONFIG_USB_PD_RETRY_HRESET			0
...
#define CONFIG_USB_PD_SAFE0V_TOUT		0
#define CONFIG_USB_PD_SAFE5V_DELAY		0
...
#define CONFIG_WD_DURING_PLUGGED_IN	0
#define CONFIG_WD_SBU_PH_TITAN_LBOUND	1800 /* mV */
#define CONFIG_WD_SBU_PH_TITAN_UBOUND	3000 /* mV */
