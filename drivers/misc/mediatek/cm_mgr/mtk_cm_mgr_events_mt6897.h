...
TRACE_EVENT(CM_MGR__stall_raio, TP_PROTO(int _id, unsigned int _ratio),
	    TP_ARGS(_id, _ratio),
	    TP_STRUCT__entry(__field(int, _id) __field(unsigned int, _ratio)),
	    TP_fast_assign(__entry->_id = _id; __entry->_ratio = _ratio;),
...
#define TRACE_INCLUDE_FILE mtk_cm_mgr_events_mt6897
