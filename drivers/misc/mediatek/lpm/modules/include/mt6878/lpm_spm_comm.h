...
struct lpm_spm_wake_status {
	...
	u32 req_sta12;		/* SRC_REQ_STA_12 */
	u32 cg_check_sta;	/* SPM_CG_CHECK_STA */
	u32 debug_flag;		/* PCM_WDT_LATCH_SPARE_0 */
	u32 debug_flag1;	/* PCM_WDT_LATCH_SPARE_1 */
	u32 debug_spare_5;	/* PCM_WDT_LATCH_SPARE_5 */
	u32 debug_spare_6;	/* PCM_WDT_LATCH_SPARE_6 */
	u32 b_sw_flag0;		/* PCM_WDT_LATCH_SPARE_7 */
	u32 b_sw_flag1;		/* PCM_WDT_LATCH_SPARE_5 */
	u32 isr;			/* SPM_IRQ_STA */
...
#define SPM_FLAG1_DISABLE_POLLING_BUS_PROTECT          (1U << 9)
...
#define SPM_FLAG1_ENABLE_DFD_SOC_MTCMOS_EN             (1U << 17)
