...
#define SPM_FLAG_DISABLE_LVTS_WORKAROUND         (1U << 4)
...
#define SPM_FLAG_DISABLE_CPU_PDN                 (1U << 13)
#define SPM_FLAG_DISABLE_ARMPLL_OFF              (1U << 14)
#define SPM_FLAG_DISABLE_DDRPHY_PDN              (1U << 15)
#define SPM_FLAG_KEEP_CSYSPWRACK_HIGH            (1U << 16)
#define SPM_FLAG_ENABLE_VDD2_DVS                 (1U << 17)
#define SPM_FLAG_ENABLE_SPM_DBG_WDT_DUMP         (1U << 18)
#define SPM_FLAG_RUN_COMMON_SCENARIO             (1U << 19)
#define SPM_FLAG_USE_SRCCLKEN02                  (1U << 20)
#define SPM_FLAG_ENABLE_AOV                      (1U << 21)
#define SPM_FLAG_MD_MUMTAS                       (1U << 22)
#define SPM_FLAG_DISABLE_DVFSQ                   (1U << 23)
#define SPM_FLAG_ENABLE_EMI_SSC                  (1U << 24)
#define SPM_FLAG_ENABLE_VMDDR_DVS                (1U << 25)
...
#define SPM_FLAG1_FLAG_DO_DPSW_0P725V                  (1U << 15)
...
#define SPM_FLAG1_DEBUG_IDX_SCP_SLP_ACK_HIGH_ABORT_1   (1U << 25)
#define SPM_FLAG1_DEBUG_IDX_SCP_SLP_ACK_HIGH_ABORT_2   (1U << 26)
#define SPM_FLAG1_DEBUG_IDX_SCP_SLP_ACK_HIGH_ABORT_3   (1U << 27)
#define SPM_FLAG1_DEBUG_IDX_SCP_SLP_ACK_LOW_ABORT_1    (1U << 28)
#define SPM_FLAG1_DEBUG_IDX_SCP_SLP_ACK_LOW_ABORT_2    (1U << 29)
#define SPM_FLAG1_DEBUG_IDX_SCP_SLP_ACK_LOW_ABORT_3    (1U << 30)
...
#define SPM_DBG_DEBUG_IDX_PMIC_SLEEP             (1U << 12)
#define SPM_DBG_DEBUG_IDX_PMIC_WAKEUP            (1U << 13)
#define	SPM_DBG_DEBUG_IDX_VCORE_LP_MODE          (1U << 14)
...
#define SPM_DBG_DEBUG_IDX_AOVBUS_130M            (1U << 21)
#define SPM_DBG_DEBUG_IDX_AOV_MODE               (1U << 22)
#define SPM_DBG_DEBUG_IDX_SPM_DVFS_NO_REQ        (1U << 23)
#define SPM_DBG_DEBUG_IDX_SPM_NORMAL_WAKEUP      (1U << 28)
#define SPM_DBG_DEBUG_IDX_SPM_WAKEUP_BY_NONE     (1U << 29)
#define SPM_DBG_DEBUG_IDX_EMI_SLEEP              (1U << 30)
#define SPM_DBG_DEBUG_IDX_EMI_WAKEUP             (1U << 31)
/* --- SPM DEBUG1 Define --- */
...
#define SPM_DBG1_DEBUG_IDX_VMDDRVDDQ_OFF                (1U << 19)
...
#define SPM_DBG1_DEBUG_IDX_VMDDRVDDQ_ON                 (1U << 25)
