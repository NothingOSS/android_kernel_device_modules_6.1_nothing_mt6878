...
static char *pwr_ctrl_str[PW_MAX_COUNT] = {
	...
	[PW_REG_GCE_D_APSRC_REQ_MASK_B] = "reg_gce_d_apsrc_req_mask_b",
	[PW_REG_GCE_D_DDREN_REQ_MASK_B] = "reg_gce_d_ddren_req_mask_b",
	[PW_REG_GCE_D_EMI_REQ_MASK_B] = "reg_gce_d_emi_req_mask_b",
	[PW_REG_GCE_D_INFRA_REQ_MASK_B] = "reg_gce_d_infra_req_mask_b",
	[PW_REG_GCE_D_PMIC_REQ_MASK_B] = "reg_gce_d_pmic_req_mask_b",
	[PW_REG_GCE_D_SRCCLKENA_MASK_B] = "reg_gce_d_srcclkena_mask_b",
	[PW_REG_GCE_D_VRF18_REQ_MASK_B] = "reg_gce_d_vrf18_req_mask_b",
	[PW_REG_GCE_M_APSRC_REQ_MASK_B] = "reg_gce_m_apsrc_req_mask_b",
	[PW_REG_GCE_M_DDREN_REQ_MASK_B] = "reg_gce_m_ddren_req_mask_b",
	[PW_REG_GCE_M_EMI_REQ_MASK_B] = "reg_gce_m_emi_req_mask_b",
	[PW_REG_GCE_M_INFRA_REQ_MASK_B] = "reg_gce_m_infra_req_mask_b",
	[PW_REG_GCE_M_PMIC_REQ_MASK_B] = "reg_gce_m_pmic_req_mask_b",
	[PW_REG_GCE_M_SRCCLKENA_MASK_B] = "reg_gce_m_srcclkena_mask_b",

	/* SPM_SRC_MASK_7 */
	[PW_REG_GCE_M_VRF18_REQ_MASK_B] = "reg_gce_m_vrf18_req_mask_b",
	...
	[PW_REG_MCUSYS_INFRA_REQ_MASK_B] = "reg_mcusys_infra_req_mask_b",

	/* SPM_SRC_MASK_9 */
	[PW_REG_MCUSYS_PMIC_REQ_MASK_B] = "reg_mcusys_pmic_req_mask_b",
	[PW_REG_MCUSYS_SRCCLKENA_MASK_B] = "reg_mcusys_srcclkena_mask_b",
	[PW_REG_MCUSYS_VRF18_REQ_MASK_B] = "reg_mcusys_vrf18_req_mask_b",
	...
	[PW_REG_PERISYS_VCORE_REQ_MASK_B] = "reg_perisys_vcore_req_mask_b",
...
static int lpm_get_wakeup_status(void)
{
	...
	help->wakesrc->b_sw_flag0 = plat_mmio_read(PCM_WDT_LATCH_SPARE_7);
	help->wakesrc->b_sw_flag1 = plat_mmio_read(PCM_WDT_LATCH_SPARE_5);
...
#undef LOG_BUF_SIZE
	...
	if (wakesrc->is_abort != 0) {
		...
		log_size += scnprintf(log_buf + log_size,
			  ...
			  wakesrc->sw_rsv3, wakesrc->sw_rsv4,
			  wakesrc->sw_rsv5, wakesrc->sw_rsv6,
			  wakesrc->sw_rsv7, wakesrc->sw_rsv8);
	...
	if (type == LPM_ISSUER_SUSPEND) {
		...
		/* get suspend abort reason */
		abort = lpm_smc_cpu_pm_lp(SUSPEND_ABORT_REASON, MT_LPM_SMC_ACT_GET, 0, 0);
		if (abort)
...
static int __init mt6878_dbg_late_initcall(void)
{
...
int __init mt6878_dbg_init(void)
{
	int ret = 0;

	ret = mt6878_dbg_device_initcall();
	if (ret)
		goto mt6878_dbg_init_fail;

	ret = mt6878_dbg_late_initcall();
	if (ret)
		goto mt6878_dbg_init_fail;

	return 0;

mt6878_dbg_init_fail:
	return -EAGAIN;
}
...
module_exit(mt6878_dbg_exit);

MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("mt6878 low power debug module");
