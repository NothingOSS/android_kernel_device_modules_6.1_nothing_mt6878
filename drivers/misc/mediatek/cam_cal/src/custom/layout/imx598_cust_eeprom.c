...
static unsigned int do_single_lsc_imx598(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_2a_gain_imx598(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_lens_id_imx598(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x0000000B, 0x010B00FF, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x00000CE2, 0x0000074C, do_single_lsc_imx598},
		{0x00000001, 0x00000007, 0x0000000E, do_2a_gain_imx598},
		{0x00000001, 0x0000143F, 0x000005A0, do_pdaf},
		{0x00000000, 0x00000FAE, 0x00000550, do_stereo_data},
		{0x00000001, 0x00000000, 0x00008000, do_dump_all},
		{0x00000001, 0x00000008, 0x00000002, do_lens_id_imx598}
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT imx598_cust_eeprom = {
	.name = "imx598_cust_eeprom",
