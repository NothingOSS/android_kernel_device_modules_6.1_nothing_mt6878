...
void __exit swpm_core_v6897_dbg_exit(void)
{
	swpm_core_v6897_exit();
}

module_init(swpm_core_v6897_dbg_init);
module_exit(swpm_core_v6897_dbg_exit);

MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("v6897 SWPM core debug module");
