...
enum {
	MCUSYS_LCPU_STALL_DCM_OFF = DCM_OFF,
	MCUSYS_LCPU_STALL_DCM_ON = DCM_ON,
};

enum {
	MCUSYS_MCPU_STALL_DCM_OFF = DCM_OFF,
	MCUSYS_MCPU_STALL_DCM_ON = DCM_ON,
};

enum {
	MCUSYS_BCPU_STALL_DCM_OFF = DCM_OFF,
	MCUSYS_BCPU_STALL_DCM_ON = DCM_ON,
};
