...
#define U3D_TXDEEMPH		(SSUSB_USB3_MAC_CSR_BASE + 0x0020)
#define U3D_CP5_CP7_TXDEEMPH	(SSUSB_USB3_MAC_CSR_BASE + 0x0028)
...
/* U3D_TXDEEMPH */
#define PIPE_TXDEEMPH_MASK	GENMASK(17, 0)
#define PIPE_TXDEEMPH(x)	((x) & PIPE_TXDEEMPH_MASK)

/* U3D_CP5_CP7_TXDEEMPH */
#define PIPE_CP5_CP7_TXDEEMPH_MASK	GENMASK(17, 0)
#define PIPE_CP5_CP7_TXDEEMPH(x)	((x) & PIPE_CP5_CP7_TXDEEMPH_MASK)
...
#define U3D_SSUSB_SPM_CTRL	(SSUSB_SIFSLV_IPPC_BASE + 0x0040)
#define U3D_SSUSB_SPM_CTRL_ACK	(SSUSB_SIFSLV_IPPC_BASE + 0x0044)
...
/* U3D_SSUSB_SPM_CTRL */
/* U3D_SSUSB_SPM_CTRL_ACK */
#define SSUSB_SPM_PMIC_EN		BIT(7)
#define SSUSB_SPM_EMI_EN		BIT(6)
#define SSUSB_SPM_VCORE_EN		BIT(5)
#define SSUSB_SPM_DDR_EN		BIT(4)
#define SSUSB_SPM_VRF18_REQ		BIT(3)
#define SSUSB_SPM_APSRC_REQ		BIT(2)
#define SSUSB_SPM_INFRE_REQ		BIT(1)
#define SSUSB_SPM_SRCCLKENA		BIT(0)
#define SSUSB_SPM_REQ_MSK \
	(SSUSB_SPM_SRCCLKENA | SSUSB_SPM_INFRE_REQ | \
	SSUSB_SPM_APSRC_REQ | SSUSB_SPM_VRF18_REQ | \
	SSUSB_SPM_DDR_EN | SSUSB_SPM_EMI_EN)
/* exclude SSUSB_SPM_PMIC_EN */
#define SSUSB_SPM_FORCE_HW_REQ_MSK	GENMASK(14, 8)
