...
#define MT6897_TOP_AXI_PROT_EN_EMISYS0_MDP0	(BIT(11))
#define MT6897_TOP_AXI_PROT_EN_EMISYS1_MDP0	(BIT(11))
...
static const struct scp_domain_data scp_domain_mt6897_spm_data[] = {
	...
	[MT6897_POWER_DOMAIN_MDP0_SHUTDOWN] = {
		...
		.bp_table = {
			...
			BUS_PROT_IGN(IFR_TYPE, 0x124, 0x128, 0x120, 0x12c,
				MT6897_TOP_AXI_PROT_EN_EMISYS0_MDP0),
			BUS_PROT_IGN(IFR_TYPE, 0x104, 0x108, 0x100, 0x10c,
				MT6897_TOP_AXI_PROT_EN_EMISYS1_MDP0),
		},
...
static const struct scp_subdomain scp_subdomain_mt6897_spm[] = {
	...
	{MT6897_POWER_DOMAIN_DIS0_SHUTDOWN, MT6897_POWER_DOMAIN_MDP0_SHUTDOWN},
	{MT6897_POWER_DOMAIN_DIS1_SHUTDOWN, MT6897_POWER_DOMAIN_MDP1_SHUTDOWN},
