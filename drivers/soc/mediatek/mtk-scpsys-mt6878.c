...
#define MT6878_TOP_AXI_PROT_EN_EMISYS_STA_0_MD	(BIT(16) | BIT(17))
...
static const struct scp_domain_data scp_domain_mt6878_spm_data[] = {
	[MT6878_POWER_DOMAIN_MD] = {
		...
		.bp_table = {
			...
			BUS_PROT_IGN(IFR_TYPE, 0x0C64, 0x0C68, 0x0C60, 0x0C6C,
				MT6878_TOP_AXI_PROT_EN_EMISYS_STA_0_MD),
		},
	...
	[MT6878_POWER_DOMAIN_MM_INFRA] = {
		...
		.bp_table = {
			...
			BUS_PROT_IGN(IFR_TYPE, 0x0C54, 0x0C58, 0x0C50, 0x0C5C,
				MT6878_TOP_AXI_PROT_EN_INFRASYS_STA_1_MM_INFRA),
			BUS_PROT_IGN(IFR_TYPE, 0x0C24, 0x0C28, 0x0C20, 0x0C2C,
				MT6878_TOP_AXI_PROT_EN_MMSYS_STA_1_MM_INFRA_2ND),
			BUS_PROT_IGN(IFR_TYPE, 0x0C44, 0x0C48, 0x0C40, 0x0C4C,
				MT6878_TOP_AXI_PROT_EN_INFRASYS_STA_0_MM_INFRA),
			BUS_PROT_IGN(IFR_TYPE, 0x0C64, 0x0C68, 0x0C60, 0x0C6C,
				MT6878_TOP_AXI_PROT_EN_EMISYS_STA_0_MM_INFRA),
		},
		.caps = MTK_SCPD_IS_PWR_CON_ON | MTK_SCPD_BYPASS_CLK | default_cap,
	},
	...
	[MT6878_POWER_DOMAIN_SSR] = {
		...
		.sram_pdn_ack_bits = GENMASK(12, 12),
		.bp_table = {
			BUS_PROT_IGN(SSR_TOP_TYPE, 0x44, 0x44, 0x44, 0x50,
				MT6878_AXI_PROT_EN_SSRSYS),
			BUS_PROT_IGN(IFR_TYPE, 0x0C44, 0x0C48, 0x0C40, 0x0C4C,
				MT6878_TOP_AXI_PROT_EN_INFRASYS_STA_0_SSRSYS),
		},
		.caps = MTK_SCPD_IS_PWR_CON_ON | default_cap,
	},
