...
#define MT6985_TOP_AXI_PROT_EN_MFGSYS0_MFG1	(BIT(0) | BIT(1) |  \
			BIT(2) | BIT(3))
#define MT6985_TOP_AXI_PROT_EN_INFRASYS0_MFG1	(BIT(10))
#define MT6985_TOP_AXI_PROT_EN_EMISYS0_MFG1	(BIT(20))
#define MT6985_TOP_AXI_PROT_EN_EMISYS1_MFG1	(BIT(20))
#define MT6985_TOP_AXI_PROT_EN_MFGSYS_RPC0_MFG1	(BIT(16) | BIT(17) |  \
			BIT(18) | BIT(19))
#define MT6985_TOP_AXI_PROT_EN_EMISYS0_MFG1_2ND	(BIT(19) | BIT(20))
#define MT6985_TOP_AXI_PROT_EN_EMISYS1_MFG1_2ND	(BIT(19) | BIT(20))
...
#define MT6985_TOP_AXI_PROT_EN_UFS_UFS0_PHY	(BIT(0))
...
#define MT6985_TOP_AXI_PROT_EN_MMSYS2_VEN1	(BIT(18) | BIT(19))
...
#define MT6985_TOP_AXI_PROT_EN_MMSYS2_CAM_MAIN	(BIT(5) | BIT(7) |  \
			BIT(9) | BIT(11))
#define MT6985_TOP_AXI_PROT_EN_CCUSYS0_CAM_MRAW	(BIT(10))
#define MT6985_TOP_AXI_PROT_EN_CCUSYS0_CAM_MRAW_2ND	(BIT(11))
#define MT6985_TOP_AXI_PROT_EN_MMSYS2_CAM_VCORE	(BIT(4) | BIT(6) |  \
			BIT(8) | BIT(10))
...
#define MT6985_TOP_AXI_PROT_EN_MMSYS2_DIS0	(BIT(23) | BIT(25))
...
#define MT6985_TOP_AXI_PROT_EN_MMSYS2_DIS1	(BIT(29) | BIT(31))
...
#define MT6985_TOP_AXI_PROT_EN_MMSYS0_MM_INFRA	(BIT(0) | BIT(2) |  \
			BIT(4) | BIT(6))
#define MT6985_TOP_AXI_PROT_EN_MMSYS1_MM_INFRA	(BIT(4) | BIT(6))
#define MT6985_TOP_AXI_PROT_EN_MMSYS2_MM_INFRA	(BIT(12))
	...
	[MT6985_POWER_DOMAIN_MFG1] = {
		...
		.bp_table = {
			...
			BUS_PROT_IGN(IFR_TYPE, 0x004, 0x008, 0x000, 0x00c,
				MT6985_TOP_AXI_PROT_EN_INFRASYS0_MFG1),
			...
			BUS_PROT_IGN(GPU_EB_RPC_TYPE, 0x040, 0x044, 0x040, 0x048,
				MT6985_TOP_AXI_PROT_EN_MFGSYS_RPC0_MFG1),
			BUS_PROT_IGN(IFR_TYPE, 0x124, 0x128, 0x120, 0x12c,
				MT6985_TOP_AXI_PROT_EN_EMISYS0_MFG1_2ND),
			BUS_PROT_IGN(IFR_TYPE, 0x104, 0x108, 0x100, 0x10c,
				MT6985_TOP_AXI_PROT_EN_EMISYS1_MFG1_2ND),
		},
...
static const struct scp_domain_data scp_domain_mt6985_spm_data[] = {
	...
	[MT6985_POWER_DOMAIN_UFS0_PHY_SHUTDOWN] = {
		...
		.bp_table = {
			BUS_PROT_IGN(UFSCFG_AO_TYPE, 0x54, 0x58, 0x50, 0x5c,
				MT6985_TOP_AXI_PROT_EN_UFS_UFS0_PHY),
		},
	...
	[MT6985_POWER_DOMAIN_ISP_MAIN] = {
		...
		.bp_table = {
			BUS_PROT_IGN(IFR_TYPE, 0x224, 0x228, 0x220, 0x22c,
				MT6985_TOP_AXI_PROT_EN_MMSYS2_ISP_MAIN),
			BUS_PROT_IGN(IFR_TYPE, 0x224, 0x228, 0x220, 0x22c,
				MT6985_TOP_AXI_PROT_EN_MMSYS2_ISP_MAIN_2ND),
		},
		.caps = MTK_SCPD_IS_PWR_CON_ON,
	},
	...
	[MT6985_POWER_DOMAIN_ISP_VCORE] = {
		...
		.bp_table = {
			BUS_PROT_IGN(IFR_TYPE, 0x1e4, 0x1e8, 0x1e0, 0x1ec,
				MT6985_TOP_AXI_PROT_EN_MMSYS0_ISP_VCORE),
			BUS_PROT_IGN(IFR_TYPE, 0x1e4, 0x1e8, 0x1e0, 0x1ec,
				MT6985_TOP_AXI_PROT_EN_MMSYS0_ISP_VCORE_2ND),
		},
		.caps = MTK_SCPD_IS_PWR_CON_ON,
	},
	[MT6985_POWER_DOMAIN_VDE0] = {
		...
		.bp_table = {
			BUS_PROT_IGN(IFR_TYPE, 0x1e4, 0x1e8, 0x1e0, 0x1ec,
				MT6985_TOP_AXI_PROT_EN_MMSYS0_VDE0),
			BUS_PROT_IGN(IFR_TYPE, 0x204, 0x208, 0x200, 0x20c,
				MT6985_TOP_AXI_PROT_EN_MMSYS1_VDE0),
			BUS_PROT_IGN(IFR_TYPE, 0x204, 0x208, 0x200, 0x20c,
				MT6985_TOP_AXI_PROT_EN_MMSYS1_VDE0_2ND),
		},
		.caps = MTK_SCPD_IS_PWR_CON_ON,
	},
	[MT6985_POWER_DOMAIN_VDE1] = {
		...
		.bp_table = {
			...
			BUS_PROT_IGN(IFR_TYPE, 0x204, 0x208, 0x200, 0x20c,
				MT6985_TOP_AXI_PROT_EN_MMSYS1_VDE1),
		},
		.caps = MTK_SCPD_IS_PWR_CON_ON,
	},
	...
	[MT6985_POWER_DOMAIN_VEN1] = {
		...
		.bp_table = {
			BUS_PROT_IGN(IFR_TYPE, 0x224, 0x228, 0x220, 0x22c,
				MT6985_TOP_AXI_PROT_EN_MMSYS2_VEN1),
			BUS_PROT_IGN(IFR_TYPE, 0x1e4, 0x1e8, 0x1e0, 0x1ec,
	...
	[MT6985_POWER_DOMAIN_CAM_MAIN] = {
		...
		.bp_table = {
			BUS_PROT_IGN(IFR_TYPE, 0x1e4, 0x1e8, 0x1e0, 0x1ec,
				MT6985_TOP_AXI_PROT_EN_MMSYS0_CAM_MAIN),
			BUS_PROT_IGN(IFR_TYPE, 0x204, 0x208, 0x200, 0x20c,
				MT6985_TOP_AXI_PROT_EN_MMSYS1_CAM_MAIN),
			BUS_PROT_IGN(IFR_TYPE, 0x224, 0x228, 0x220, 0x22c,
				MT6985_TOP_AXI_PROT_EN_MMSYS2_CAM_MAIN),
		},
		.caps = MTK_SCPD_IS_PWR_CON_ON,
	},
	...
	[MT6985_POWER_DOMAIN_CAM_VCORE] = {
		...
		.bp_table = {
			BUS_PROT_IGN(IFR_TYPE, 0x224, 0x228, 0x220, 0x22c,
				MT6985_TOP_AXI_PROT_EN_MMSYS2_CAM_VCORE),
			BUS_PROT_IGN(IFR_TYPE, 0x264, 0x268, 0x260, 0x26c,
				MT6985_TOP_AXI_PROT_EN_CCUSYS0_CAM_VCORE),
			BUS_PROT_IGN(IFR_TYPE, 0x004, 0x008, 0x000, 0x00c,
				MT6985_TOP_AXI_PROT_EN_INFRASYS0_CAM_VCORE),
			BUS_PROT_IGN(IFR_TYPE, 0x1e4, 0x1e8, 0x1e0, 0x1ec,
				MT6985_TOP_AXI_PROT_EN_MMSYS0_CAM_VCORE),
			BUS_PROT_IGN(IFR_TYPE, 0x204, 0x208, 0x200, 0x20c,
				MT6985_TOP_AXI_PROT_EN_MMSYS1_CAM_VCORE),
		},
		.caps = MTK_SCPD_IS_PWR_CON_ON,
	},
	...
	[MT6985_POWER_DOMAIN_MM_INFRA] = {
		...
		.bp_table = {
			BUS_PROT_IGN(IFR_TYPE, 0x024, 0x028, 0x020, 0x02c,
				MT6985_TOP_AXI_PROT_EN_INFRASYS1_MM_INFRA),
			BUS_PROT_IGN(IFR_TYPE, 0x1e4, 0x1e8, 0x1e0, 0x1ec,
				MT6985_TOP_AXI_PROT_EN_MMSYS0_MM_INFRA),
			BUS_PROT_IGN(IFR_TYPE, 0x204, 0x208, 0x200, 0x20c,
				MT6985_TOP_AXI_PROT_EN_MMSYS1_MM_INFRA),
			BUS_PROT_IGN(IFR_TYPE, 0x224, 0x228, 0x220, 0x22c,
				MT6985_TOP_AXI_PROT_EN_MMSYS2_MM_INFRA),
			BUS_PROT_IGN(IFR_TYPE, 0x004, 0x008, 0x000, 0x00c,
				MT6985_TOP_AXI_PROT_EN_INFRASYS0_MM_INFRA),
			BUS_PROT_IGN(IFR_TYPE, 0x1e4, 0x1e8, 0x1e0, 0x1ec,
				MT6985_TOP_AXI_PROT_EN_MMSYS0_MM_INFRA_2ND),
			BUS_PROT_IGN(IFR_TYPE, 0x204, 0x208, 0x200, 0x20c,
				MT6985_TOP_AXI_PROT_EN_MMSYS1_MM_INFRA_2ND),
			BUS_PROT_IGN(IFR_TYPE, 0x224, 0x228, 0x220, 0x22c,
				MT6985_TOP_AXI_PROT_EN_MMSYS2_MM_INFRA_2ND),
			BUS_PROT_IGN(IFR_TYPE, 0x124, 0x128, 0x120, 0x12c,
	...
	[MT6985_POWER_DOMAIN_VDE_VCORE0] = {
		...
		.bp_table = {
			...
			BUS_PROT_IGN(IFR_TYPE, 0x1e4, 0x1e8, 0x1e0, 0x1ec,
				MT6985_TOP_AXI_PROT_EN_MMSYS0_VDE_VCORE0),
			BUS_PROT_IGN(IFR_TYPE, 0x204, 0x208, 0x200, 0x20c,
...
static const struct scp_subdomain scp_subdomain_mt6985_spm[] = {
	{MT6985_POWER_DOMAIN_PEXTP_MAC0_SHUTDOWN, MT6985_POWER_DOMAIN_PEXTP_PHY0},
	{MT6985_POWER_DOMAIN_PEXTP_MAC1_SHUTDOWN, MT6985_POWER_DOMAIN_PEXTP_PHY1},
	...
	{MT6985_POWER_DOMAIN_MM_INFRA, MT6985_POWER_DOMAIN_OVLSYS_SHUTDOWN},
	{MT6985_POWER_DOMAIN_MM_INFRA, MT6985_POWER_DOMAIN_OVLSYS1_SHUTDOWN},
	...
	{MT6985_POWER_DOMAIN_MM_INFRA, MT6985_POWER_DOMAIN_VDE_VCORE1},
};
