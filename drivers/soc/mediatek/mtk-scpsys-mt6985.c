...
#define MT6985_TOP_AXI_PROT_EN_PERISYS0_AUDIO	(BIT(5))
#define MT6985_TOP_AXI_PROT_EN_INFRASYS1_ADSP_TOP	(BIT(14))
#define MT6985_TOP_AXI_PROT_EN_SSR0_ADSP_TOP	(BIT(15))
...
#define MT6985_TOP_AXI_PROT_EN_MMSYS2_CAM_MAIN	(BIT(4) | BIT(6) |  \
			BIT(8) | BIT(10))
#define MT6985_TOP_AXI_PROT_EN_CCUSYS0_CAM_MRAW	(BIT(12))
...
#define MT6985_TOP_AXI_PROT_EN_INFRASYS0_CAM_MRAW	(BIT(27))
#define MT6985_TOP_AXI_PROT_EN_CCUSYS0_CAM_MRAW_2ND	(BIT(10))
#define MT6985_TOP_AXI_PROT_EN_CCUSYS0_CAM_MRAW_3RD	(BIT(11))
...
#define MT6985_TOP_AXI_PROT_EN_MMSYS1_DIS0_2ND	(BIT(11) | BIT(13))
...
#define MT6985_TOP_AXI_PROT_EN_MMSYS1_DIS1_2ND	(BIT(1) | BIT(3))
#define MT6985_TOP_AXI_PROT_EN_MMSYS2_DIS1_2ND	(BIT(29) | BIT(31))
#define MT6985_TOP_AXI_PROT_EN_MMSYS2_OVLSYS	(BIT(20) | BIT(22) |  \
			BIT(24))
#define MT6985_TOP_AXI_PROT_EN_MMSYS2_OVLSYS_2ND	(BIT(21) | BIT(23) |  \
			BIT(25))
#define MT6985_TOP_AXI_PROT_EN_MMSYS2_OVLSYS1	(BIT(26) | BIT(28) |  \
			BIT(30))
#define MT6985_TOP_AXI_PROT_EN_MMSYS2_OVLSYS1_2ND	(BIT(27) | BIT(29) |  \
			BIT(31))
...
static const struct scp_domain_data scp_domain_mt6985_spm_data[] = {
	...
	[MT6985_POWER_DOMAIN_UFS0_PHY_SHUTDOWN] = {
		...
		.caps = MTK_SCPD_SRAM_ISO | MTK_SCPD_IS_PWR_CON_ON  | MTK_SCPD_UFS_RTFF,
	},
	...
	[MT6985_POWER_DOMAIN_ADSP_TOP_DORMANT] = {
		...
		.bp_table = {
			...
			BUS_PROT_IGN(IFR_TYPE, 0x804, 0x808, 0x800, 0x80c,
				MT6985_TOP_AXI_PROT_EN_SSR0_ADSP_TOP),
		},
	...
	[MT6985_POWER_DOMAIN_CAM_MRAW] = {
		...
		.bp_table = {
			...
			BUS_PROT_IGN(IFR_TYPE, 0x004, 0x008, 0x000, 0x00c,
				MT6985_TOP_AXI_PROT_EN_INFRASYS0_CAM_MRAW),
			BUS_PROT_IGN(IFR_TYPE, 0x264, 0x268, 0x260, 0x26c,
				MT6985_TOP_AXI_PROT_EN_CCUSYS0_CAM_MRAW_2ND),
			BUS_PROT_IGN(IFR_TYPE, 0x264, 0x268, 0x260, 0x26c,
				MT6985_TOP_AXI_PROT_EN_CCUSYS0_CAM_MRAW_3RD),
		},
		.caps = MTK_SCPD_IS_PWR_CON_ON,
	},
	...
	[MT6985_POWER_DOMAIN_DIS0_SHUTDOWN] = {
		...
		.hwv_shift = 3,
		.basic_clk_name = {"disp"},
		.caps = MTK_SCPD_SRAM_ISO | MTK_SCPD_IS_PWR_CON_ON | MTK_SCPD_HWV_OPS,
	},
...
static const struct scp_subdomain scp_subdomain_mt6985_spm[] = {
	...
	{MT6985_POWER_DOMAIN_MM_PROC_DORMANT, MT6985_POWER_DOMAIN_ISP_VCORE},
	...
	{MT6985_POWER_DOMAIN_MM_PROC_DORMANT, MT6985_POWER_DOMAIN_CAM_VCORE},
	...
	{MT6985_POWER_DOMAIN_MM_PROC_DORMANT, MT6985_POWER_DOMAIN_VDE_VCORE0},
