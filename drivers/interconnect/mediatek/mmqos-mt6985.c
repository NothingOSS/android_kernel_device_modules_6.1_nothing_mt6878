...
static const struct mtk_node_desc node_descs_mt6985[] = {
	...
	DEFINE_MNODE(vdec_larb5, SLAVE_LARB(5), 0x7, false, 0x2, MASTER_COMMON_PORT(0, 3)),
	DEFINE_MNODE(venc_larb7, SLAVE_LARB(7), 0x7, false, 0x1, MASTER_COMMON_PORT(0, 4)),
	DEFINE_MNODE(venc_larb43, SLAVE_LARB(43), 0x8, true, 0x1,
		MASTER_COMMON_PORT(0, 4)), //venc virt
	DEFINE_MNODE(img_larb10, SLAVE_LARB(10), 0x7, false, 0x2, MASTER_COMMON_PORT(0, 5)),
	DEFINE_MNODE(img_larb22, SLAVE_LARB(22), 0x8, true, 0x2,
		MASTER_COMMON_PORT(0, 5)), //LARB11_u1
	DEFINE_MNODE(img_larb23, SLAVE_LARB(23), 0, false, 0x0,
		MASTER_COMMON_PORT(0, 5)), //LARB11_u2
	DEFINE_MNODE(img_larb28, SLAVE_LARB(28), 0, false, 0x0, MASTER_COMMON_PORT(0, 5)),
	DEFINE_MNODE(cam_larb16, SLAVE_LARB(16), 0, false, 0x0,
		MASTER_COMMON_PORT(0, 6)), //LARB16_u0
	DEFINE_MNODE(cam_larb31, SLAVE_LARB(31), 0, false, 0x0,
		MASTER_COMMON_PORT(0, 6)), //LARB16_u2
	DEFINE_MNODE(cam_larb34, SLAVE_LARB(34), 0, false, 0x0,
		MASTER_COMMON_PORT(0, 6)), //LARB17_u1
	...
	DEFINE_MNODE(vdec_larb6, SLAVE_LARB(6), 0, false, 0x0, MASTER_COMMON_PORT(0, 7)),
	/* MDP COMMON */
	...
	DEFINE_MNODE(vdec_larb4, SLAVE_LARB(4), 0x7, false, 0x11, MASTER_COMMON_PORT(1, 3)),
	DEFINE_MNODE(venc_larb8, SLAVE_LARB(8), 0x8, true, 0x12, MASTER_COMMON_PORT(1, 4)),
	DEFINE_MNODE(venc_larb37, SLAVE_LARB(37), 0x7, false, 0x12,
		MASTER_COMMON_PORT(1, 4)), //LARB8_u1
	DEFINE_MNODE(img_larb9, SLAVE_LARB(9), 0x7, false, 0x11, MASTER_COMMON_PORT(1, 5)),
	DEFINE_MNODE(img_larb11, SLAVE_LARB(11), 0, false, 0x0, MASTER_COMMON_PORT(1, 5)),
	DEFINE_MNODE(img_larb12, SLAVE_LARB(12), 0, false, 0x0, MASTER_COMMON_PORT(1, 5)),
	DEFINE_MNODE(img_larb15, SLAVE_LARB(15), 0x8, true, 0x11, MASTER_COMMON_PORT(1, 5)),
	...
	DEFINE_MNODE(cam_larb30, SLAVE_LARB(30), 0, false, 0x0,
		MASTER_COMMON_PORT(1, 6)), //LARB16_u1
	DEFINE_MNODE(cam_larb17, SLAVE_LARB(17), 0, false, 0x0,
		MASTER_COMMON_PORT(1, 6)), //LARB17_u0
	DEFINE_MNODE(cam_larb35, SLAVE_LARB(35), 0, false, 0x0,
		MASTER_COMMON_PORT(1, 6)), //LARB17_u2
	...
	DEFINE_MNODE(cam_larb14, SLAVE_LARB(14), 0, false, 0x0, MASTER_COMMON_PORT(1, 6)),
	DEFINE_MNODE(disp_larb38, SLAVE_LARB(38), 0, false, 0x1,
		MASTER_COMMON_PORT(0, 8)), //virt DISP
	DEFINE_MNODE(cam_larb39, SLAVE_LARB(39), 0, true, 0x1,
		MASTER_COMMON_PORT(0, 6)), //virt CCU
	DEFINE_MNODE(cam_larb40, SLAVE_LARB(40), 0, true, 0x12,
		MASTER_COMMON_PORT(1, 6)), //virt CCU0
	DEFINE_MNODE(disp_larb41, SLAVE_LARB(41), 0, false, 0x11,
		MASTER_COMMON_PORT(1, 8)), //virt DISP
	DEFINE_MNODE(disp_larb42, SLAVE_LARB(42), 0, false, 0x11,
		MASTER_COMMON_PORT(1, 8)), //virt DISP
	/* LARB0 */
	...
	DEFINE_MNODE(larb0_disp_ovl2_2L_rdma0_w,
		MASTER_LARB_PORT(M4U_PORT_L0_DISP_OVL2_2L_RDMA0), 8, false, 0x1, SLAVE_LARB(0)),
	...
	DEFINE_MNODE(larb21_disp_ovl3_2L_hdr_w,
		MASTER_LARB_PORT(M4U_PORT_L21_DISP_OVL3_2L_HDR), 7, false, 0x2, SLAVE_LARB(21)),
	...
	DEFINE_MNODE(larb33_disp_postmask0_r,
		MASTER_LARB_PORT(M4U_PORT_L33_DISP_POSTMASK0), 7, false, 0x2, SLAVE_LARB(33)),
	...
	DEFINE_MNODE(larb33_disp_oddmr0_dmrr_w,
		MASTER_LARB_PORT(M4U_PORT_L33_DISP_ODDMR0_DMRR), 8, false, 0x2, SLAVE_LARB(33)),
	DEFINE_MNODE(larb33_disp_oddmr0_odr_w,
		MASTER_LARB_PORT(M4U_PORT_L33_DISP_ODDMR0_ODR), 8, false, 0x2, SLAVE_LARB(33)),
	DEFINE_MNODE(larb33_disp_oddmr0_odw_r,
		MASTER_LARB_PORT(M4U_PORT_L33_DISP_ODDMR0_ODW), 9, true, 0x2, SLAVE_LARB(33)),
	DEFINE_MNODE(larb33_disp_wdma1_r,
		MASTER_LARB_PORT(M4U_PORT_L33_DISP_WDMA1), 9, true, 0x2, SLAVE_LARB(33)),
	DEFINE_MNODE(larb33_disp_ufbc_wdma1_w,
		MASTER_LARB_PORT(M4U_PORT_L33_DISP_UFBC_WDMA1), 9, true, 0x2, SLAVE_LARB(33)),
	/* LARB2 */
...
static const struct mtk_mmqos_desc mmqos_desc_mt6985 = {
	...
	.comm_port_hrt_types = {
		{ HRT_MAX_BWL, HRT_MAX_BWL, HRT_NONE, SRT_VDEC, SRT_VENC,
			HRT_NONE, HRT_CAM, SRT_VDEC, HRT_DISP },
		{ HRT_MAX_BWL, HRT_MAX_BWL, HRT_NONE, SRT_VDEC, SRT_VENC,
	...
	.report_bw_larbs = { SLAVE_LARB(9), SLAVE_LARB(10),
			...
			SLAVE_LARB(7), SLAVE_LARB(43),
			SLAVE_LARB(8), SLAVE_LARB(37),},
	.report_bw_real_larbs = { SLAVE_LARB(9), SLAVE_LARB(10),
			SLAVE_LARB(15), SLAVE_LARB(22),
			SLAVE_LARB(4), SLAVE_LARB(5),
