...
static const struct mtk_node_desc node_descs_mt6985[] = {
	...
	DEFINE_MNODE(img_larb10, SLAVE_LARB(10), 0, false, 0x2, MASTER_COMMON_PORT(0, 5)),
	DEFINE_MNODE(img_larb22, SLAVE_LARB(22), 0, true, 0x2,
	...
	DEFINE_MNODE(venc_larb8, SLAVE_LARB(8), 0, true, 0x12, MASTER_COMMON_PORT(1, 4)),
	DEFINE_MNODE(venc_larb37, SLAVE_LARB(37), 0, false, 0x12,
