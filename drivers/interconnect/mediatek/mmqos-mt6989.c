...
static const struct mtk_node_desc node_descs_mt6989[] = {
	...
	/* LARB4 */
	DEFINE_MNODE(hw_vdec_mc_c_ext_larb4_0,
		MASTER_LARB_PORT(SMMU_L4_P0_HW_VDEC_MC_C_EXT),    6, false, 0x0, SLAVE_LARB(4)),
	DEFINE_MNODE(hw_vdec_ufo_ext_larb4_1,
		MASTER_LARB_PORT(SMMU_L4_P1_HW_VDEC_UFO_EXT),     7, false, 0x0, SLAVE_LARB(4)),
	DEFINE_MNODE(hw_vdec_pp_ext_larb4_2,
		MASTER_LARB_PORT(SMMU_L4_P2_HW_VDEC_PP_EXT),      8, true,  0x0, SLAVE_LARB(4)),
	DEFINE_MNODE(hw_vdec_ufo_ex_c_larb4_3,
		MASTER_LARB_PORT(SMMU_L4_P3_HW_VDEC_UFO_EX_C),    7, false, 0x0, SLAVE_LARB(4)),
	DEFINE_MNODE(hw_vdec_pred_rd_ext_larb4_4,
		MASTER_LARB_PORT(SMMU_L4_P4_HW_VDEC_PRED_RD_EXT), 7, false, 0x0, SLAVE_LARB(4)),
	DEFINE_MNODE(hw_vdec_pred_wr_ext_larb4_5,
		MASTER_LARB_PORT(SMMU_L4_P5_HW_VDEC_PRED_WR_EXT), 7, false, 0x0, SLAVE_LARB(4)),
	DEFINE_MNODE(hw_vdec_pp_wrap_ext_larb4_6,
		MASTER_LARB_PORT(SMMU_L4_P6_HW_VDEC_PP_WRAP_EXT), 7, false, 0x0, SLAVE_LARB(4)),
	DEFINE_MNODE(hw_vdec_tile_ext_larb4_7,
		MASTER_LARB_PORT(SMMU_L4_P7_HW_VDEC_TILE_EXT),    7, false, 0x0, SLAVE_LARB(4)),
	DEFINE_MNODE(hw_vdec_vld_ext_larb4_8,
		MASTER_LARB_PORT(SMMU_L4_P8_HW_VDEC_VLD_EXT),     7, false, 0x0, SLAVE_LARB(4)),
	DEFINE_MNODE(hw_vdec_vld2_ext_larb4_9,
		MASTER_LARB_PORT(SMMU_L4_P9_HW_VDEC_VLD2_EXT),    7, false, 0x0, SLAVE_LARB(4)),
	DEFINE_MNODE(hw_vdec_avc_mv_ext_larb4_10,
		MASTER_LARB_PORT(SMMU_L4_P10_HW_VDEC_AVC_MV_EXT), 6, false, 0x0, SLAVE_LARB(4)),
	/* LARB5 */
	DEFINE_MNODE(hw_vdec_lat0_vld_ext_larb5_0,
		MASTER_LARB_PORT(SMMU_L5_P0_HW_VDEC_LAT0_VLD_EXT),    7, false, 0x2, SLAVE_LARB(5)),
	DEFINE_MNODE(hw_vdec_lat0_vld2_ext_larb5_1,
		MASTER_LARB_PORT(SMMU_L5_P1_HW_VDEC_LAT0_VLD2_EXT),   7, false, 0x2, SLAVE_LARB(5)),
	DEFINE_MNODE(hw_vdec_mc_ext_larb5_2,
		MASTER_LARB_PORT(SMMU_L5_P2_HW_VDEC_MC_EXT),          6, false, 0x2, SLAVE_LARB(5)),
	DEFINE_MNODE(hw_vdec_ufo_enc_ext_larb5_3,
		MASTER_LARB_PORT(SMMU_L5_P3_HW_VDEC_UFO_ENC_EXT),     7, true, 0x2, SLAVE_LARB(5)),
	DEFINE_MNODE(hw_vdec_ufo_enc_ext_c_larb5_4,
		MASTER_LARB_PORT(SMMU_L5_P4_HW_VDEC_UFO_ENC_EXT_C),   7, true, 0x2, SLAVE_LARB(5)),
	DEFINE_MNODE(hw_vdec_lat0_avc_mv_ext_larb5_5,
		MASTER_LARB_PORT(SMMU_L5_P5_HW_VDEC_LAT0_AVC_MV_EXT), 6, false, 0x2, SLAVE_LARB(5)),
	DEFINE_MNODE(hw_vdec_lat0_pred_rd_ext_larb5_6,
		MASTER_LARB_PORT(SMMU_L5_P6_HW_VDEC_LAT0_PRED_RD_EXT),
		7, false, 0x2, SLAVE_LARB(5)),
	DEFINE_MNODE(hw_vdec_lat0_tile_ext_larb5_7,
		MASTER_LARB_PORT(SMMU_L5_P7_HW_VDEC_LAT0_TILE_EXT),   7, false, 0x2, SLAVE_LARB(5)),
	DEFINE_MNODE(hw_vdec_lat0_wdma_ext_larb5_8,
		MASTER_LARB_PORT(SMMU_L5_P8_HW_VDEC_LAT0_WDMA_EXT),   8, true, 0x2, SLAVE_LARB(5)),
	/* LARB7 */
	...
	DEFINE_MNODE(camsv_b_cqi_e1_larb13_0,
		MASTER_LARB_PORT(SMMU_L13_P0_CAMSV_B_CQI_E1), 8, true, 0x0, SLAVE_LARB(13)),
	...
	DEFINE_MNODE(camsv_a_cqi_e1_larb14_0,
		MASTER_LARB_PORT(SMMU_L14_P0_CAMSV_A_CQI_E1), 8, true, 0x0, SLAVE_LARB(14)),
	...
	DEFINE_MNODE(camsv_c_cqi_e1_larb29_0,
		MASTER_LARB_PORT(SMMU_L29_P0_CAMSV_C_CQI_E1), 7, false, 0x0, SLAVE_LARB(29)),
	DEFINE_MNODE(camsv_d_cqi_e1_larb29_1,
		MASTER_LARB_PORT(SMMU_L29_P1_CAMSV_D_CQI_E1), 7, false, 0x0, SLAVE_LARB(29)),
	DEFINE_MNODE(camsv_e_cqi_e1_larb29_2,
		MASTER_LARB_PORT(SMMU_L29_P2_CAMSV_E_CQI_E1), 7, false, 0x0, SLAVE_LARB(29)),
	DEFINE_MNODE(camsv_f_cqi_e1_larb29_3,
		MASTER_LARB_PORT(SMMU_L29_P3_CAMSV_F_CQI_E1), 7, false, 0x0, SLAVE_LARB(29)),
	DEFINE_MNODE(camsv_c_wdma_larb29_4,
		MASTER_LARB_PORT(SMMU_L29_P4_CAMSV_C_WDMA), 7, true, 0x0, SLAVE_LARB(29)),
	DEFINE_MNODE(camsv_d_wdma_larb29_5,
		MASTER_LARB_PORT(SMMU_L29_P5_CAMSV_D_WDMA), 7, true, 0x0, SLAVE_LARB(29)),
	DEFINE_MNODE(camsv_e_wdma_larb29_6,
		MASTER_LARB_PORT(SMMU_L29_P6_CAMSV_E_WDMA), 7, true, 0x0, SLAVE_LARB(29)),
	DEFINE_MNODE(camsv_f_wdma_larb29_7,
		MASTER_LARB_PORT(SMMU_L29_P7_CAMSV_F_WDMA), 7, true, 0x0, SLAVE_LARB(29)),
