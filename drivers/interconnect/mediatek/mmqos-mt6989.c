...
static const struct mtk_node_desc node_descs_mt6989[] = {
	...
	DEFINE_MNODE(camsv_b_cqi_e1_larb13_0,
		MASTER_LARB_PORT(SMMU_L13_P0_CAMSV_B_CQI_E1), 9, true, 0x0, SLAVE_LARB(13)),
	...
	DEFINE_MNODE(camsv_a_cqi_e1_larb14_0,
		MASTER_LARB_PORT(SMMU_L14_P0_CAMSV_A_CQI_E1), 9, true, 0x0, SLAVE_LARB(14)),
...
static const struct mtk_mmqos_desc mmqos_desc_mt6989 = {
	...
	.hrt = {
		.hrt_bw = {12808, 0, 0},
		.hrt_total_bw = 60000, /* Todo: Use DRAMC API 7500*4(channel)*2(io width)*/
