...
static const struct mtk_node_desc node_descs_mt6897[] = {
	...
	DEFINE_MNODE(VDEC_larb46,
		SLAVE_LARB(46), 0x8, true, 0x2, MASTER_COMMON_PORT(0, 3)), //vir_vdec
	DEFINE_MNODE(VENC_larb7, SLAVE_LARB(7), 0x7, false, 0x1, MASTER_COMMON_PORT(0, 4)),
	DEFINE_MNODE(VENC_larb44,
		SLAVE_LARB(44), 0x8, true, 0x1, MASTER_COMMON_PORT(0, 4)), //vir_venc
	DEFINE_MNODE(IMG_larb28, SLAVE_LARB(28), 0x7, false, 0x2, MASTER_COMMON_PORT(0, 5)),
	DEFINE_MNODE(IMG_larb22, SLAVE_LARB(22), 0x8, true, 0x2, MASTER_COMMON_PORT(0, 5)),
	...
	DEFINE_MNODE(VDEC_larb47,
		SLAVE_LARB(47), 0x8, true, 0x11, MASTER_COMMON_PORT(1, 3)), //vir_vdec
	DEFINE_MNODE(VENC_larb8, SLAVE_LARB(8), 0x7, false, 0x12, MASTER_COMMON_PORT(1, 4)),
	DEFINE_MNODE(VENC_larb45,
		SLAVE_LARB(45), 0x8, true, 0x12, MASTER_COMMON_PORT(1, 4)), //vir_venc
	...
	DEFINE_MNODE(camsv_b_cqi_e1_larb13_0,
		MASTER_LARB_PORT(M4U_L13_P0_CAMSV_B_CQI_E1), 8, false, 0x12, SLAVE_LARB(13)),
	DEFINE_MNODE(camsv_b0_wdma_larb13_1,
		MASTER_LARB_PORT(M4U_L13_P1_CAMSV_B0_WDMA), 9, true, 0x12, SLAVE_LARB(13)),
	DEFINE_MNODE(camsv_b1_wdma_larb13_2,
		MASTER_LARB_PORT(M4U_L13_P2_CAMSV_B1_WDMA), 9, true, 0x12, SLAVE_LARB(13)),
	...
	DEFINE_MNODE(reserved_larb13_4,
		MASTER_LARB_PORT(M4U_L13_P4_RESERVED), 8, false, 0x12, SLAVE_LARB(13)),
	/* LARB14 */
	DEFINE_MNODE(camsv_a_cqi_e1_larb14_0,
		MASTER_LARB_PORT(M4U_L14_P0_CAMSV_A_CQI_E1), 8, false, 0x1, SLAVE_LARB(14)),
	...
	DEFINE_MNODE(reserved_larb14_3,
		MASTER_LARB_PORT(M4U_L14_P3_RESERVED), 8, false, 0x1, SLAVE_LARB(14)),
	/* LARB16 */
	...
	DEFINE_MNODE(reserved_larb16_u0_16,
		MASTER_LARB_PORT(M4U_L16_P16_RESERVED), 8, true, 0x1, SLAVE_LARB(16)),
	/* LARB17 */
	...
	DEFINE_MNODE(drzhno_r3_larb17_u0_6,
		MASTER_LARB_PORT(M4U_L17_P6_DRZHNO_R3_U0), 9, true, 0x12, SLAVE_LARB(17)),
	DEFINE_MNODE(reserved_larb17_u0_7,
		MASTER_LARB_PORT(M4U_L17_P7_RESERVED), 8, false, 0x12, SLAVE_LARB(17)),
	/* LARB19 */
	...
	DEFINE_MNODE(drzhno_r3_larb34_u0_6,
		MASTER_LARB_PORT(M4U_L34_P6_DRZHNO_R3_U0), 9, true, 0x1, SLAVE_LARB(34)),
	DEFINE_MNODE(reserved_larb34_u0_7,
		MASTER_LARB_PORT(M4U_L34_P7_RESERVED), 8, false, 0x1, SLAVE_LARB(34)),
	/* LARB35 */
	...
	DEFINE_MNODE(drzhno_r3_larb35_u0_6,
		MASTER_LARB_PORT(M4U_L35_P6_DRZHNO_R3_U0), 9, true, 0x12, SLAVE_LARB(35)),
	DEFINE_MNODE(reserved_larb35_u0_7,
		MASTER_LARB_PORT(M4U_L35_P7_RESERVED), 8, false, 0x12, SLAVE_LARB(35)),
	/* LARB36 */
	...
	DEFINE_MNODE(reserved_larb36_u0_16,
		MASTER_LARB_PORT(M4U_L36_P16_RESERVED), 8, false, 0x12, SLAVE_LARB(36)),
	/* LARB37 */
	...
	DEFINE_MNODE(reserved_larb37_u0_16,
		MASTER_LARB_PORT(M4U_L37_P16_RESERVED), 8, false, 0x1, SLAVE_LARB(37)),
};
