...
DEFINE_MNODE(mcu_port_0, MASTER_MCU_PORT_0, 0, MASTER_MCUSYS);
DEFINE_MNODE(mcu_port_1, MASTER_MCU_PORT_1, 0, MASTER_MCUSYS);
DEFINE_MNODE(mcu_port_2, MASTER_MCU_PORT_2, 0, MASTER_MCUSYS);
DEFINE_MNODE(mcu_port_3, MASTER_MCU_PORT_3, 0, MASTER_MCUSYS);
DEFINE_MNODE(mcu_port_4, MASTER_MCU_PORT_4, 0, MASTER_MCUSYS);
...
static const struct of_device_id emi_icc_of_match[] = {
	...
	{ .compatible = "mediatek,mt6985-dvfsrc", .data = &mt6873_icc },
	{ .compatible = "mediatek,mt6886-dvfsrc", .data = &mt6873_icc },
	{ },
};
