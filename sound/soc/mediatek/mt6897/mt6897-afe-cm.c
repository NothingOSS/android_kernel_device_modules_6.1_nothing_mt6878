...
void mt6897_set_cm_rate(int id, unsigned int rate)
{
...
EXPORT_SYMBOL_GPL(mt6897_set_cm_rate);

static int mt6897_convert_cm_ch(unsigned int ch)
{
	return ch - 1;
}

int mt6897_set_cm(struct mtk_base_afe *afe, int id,
...
EXPORT_SYMBOL_GPL(mt6897_set_cm);

int mt6897_enable_cm_bypass(struct mtk_base_afe *afe, int id, bool en)
{
	int cm_reg = 0;
	int cm_on_mask = 0;
	int cm_on_shift = 0;
...
EXPORT_SYMBOL_GPL(mt6897_enable_cm_bypass);

int mt6897_enable_cm(struct mtk_base_afe *afe, int id, bool en)
{
	int cm_reg = 0;
	int cm_on_mask = 0;
	int cm_on_shift = 0;
...
EXPORT_SYMBOL_GPL(mt6897_enable_cm);

int mt6897_is_need_enable_cm(struct mtk_base_afe *afe, int id)
{
	int cm_reg = 0;
	int cm_on_mask = 0;
	int cm_on_shift = 0;
...
EXPORT_SYMBOL_GPL(mt6897_is_need_enable_cm);
