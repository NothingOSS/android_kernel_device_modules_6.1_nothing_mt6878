			 ...
			 struct snd_ctl_elem_value *ucontrol)
{
	...
	struct mtk_afe_i2s_priv *i2sin4_priv = afe_priv->dai_priv[MT6897_DAI_I2S_IN4];
			 ...
			 struct snd_ctl_elem_value *ucontrol)
{
	...
	struct mt6897_afe_private *afe_priv = afe->platform_priv;
	struct mtk_afe_i2s_priv *i2sin4_priv = afe_priv->dai_priv[MT6897_DAI_I2S_IN4];
	struct mtk_afe_i2s_priv *i2sout4_priv = afe_priv->dai_priv[MT6897_DAI_I2S_OUT4];
	unsigned int value = 0;
...
static int mtk_is_i2s_low_power(int i2s_num)
{
	...
	i2s_bit_shift = i2s_num - MT6897_DAI_I2S_IN0;
	if (i2s_bit_shift < 0 || i2s_bit_shift > MT6897_DAI_I2S_MAX_NUM) {
...
/* low jitter control */
static const char *const mt6897_i2s_hd_str[] = {
	"Normal", "Low_Jitter"
};

static const struct soc_enum mt6897_i2s_enum[] = {
	SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(mt6897_i2s_hd_str),
			    mt6897_i2s_hd_str),
};

static int mt6897_i2s_hd_get(struct snd_kcontrol *kcontrol,
			     struct snd_ctl_elem_value *ucontrol)
{
...
static int mt6897_i2s_hd_set(struct snd_kcontrol *kcontrol,
			     struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static const struct snd_kcontrol_new mtk_dai_i2s_controls[] = {
	SOC_ENUM_EXT(MTK_AFE_I2SIN0_KCONTROL_NAME, mt6897_i2s_enum[0],
		     mt6897_i2s_hd_get, mt6897_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2SIN1_KCONTROL_NAME, mt6897_i2s_enum[0],
		     mt6897_i2s_hd_get, mt6897_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2SIN2_KCONTROL_NAME, mt6897_i2s_enum[0],
		     mt6897_i2s_hd_get, mt6897_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2SIN4_KCONTROL_NAME, mt6897_i2s_enum[0],
		     mt6897_i2s_hd_get, mt6897_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2SIN6_KCONTROL_NAME, mt6897_i2s_enum[0],
		     mt6897_i2s_hd_get, mt6897_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2SOUT0_KCONTROL_NAME, mt6897_i2s_enum[0],
		     mt6897_i2s_hd_get, mt6897_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2SOUT1_KCONTROL_NAME, mt6897_i2s_enum[0],
		     mt6897_i2s_hd_get, mt6897_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2SOUT2_KCONTROL_NAME, mt6897_i2s_enum[0],
		     mt6897_i2s_hd_get, mt6897_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2SOUT4_KCONTROL_NAME, mt6897_i2s_enum[0],
		     mt6897_i2s_hd_get, mt6897_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2SOUT6_KCONTROL_NAME, mt6897_i2s_enum[0],
		     mt6897_i2s_hd_get, mt6897_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_FMI2S_MASTER_KCONTROL_NAME, mt6897_i2s_enum[0],
		     mt6897_i2s_hd_get, mt6897_i2s_hd_set),
...
static const struct snd_kcontrol_new mtk_i2sout1_ch1_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("DL24_CH1", AFE_CONN110_2, I_DL24_CH1, 1, 0),
...
static const struct snd_kcontrol_new mtk_i2sout1_ch2_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("DL24_CH2", AFE_CONN111_2, I_DL24_CH2, 1, 0),
...
static const struct snd_kcontrol_new mtk_i2sout2_ch1_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("DL24_CH1", AFE_CONN112_2, I_DL24_CH1, 1, 0),
...
static const struct snd_kcontrol_new mtk_i2sout2_ch2_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("DL24_CH2", AFE_CONN113_2, I_DL24_CH2, 1, 0),
			    ...
			    int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		mt6897_afe_gpio_request(afe, true, i2s_priv->id, 0);
		break;
	case SND_SOC_DAPM_POST_PMD:
		mt6897_afe_gpio_request(afe, false, i2s_priv->id, 0);
		break;
	default:
		break;
	}
			  ...
			  int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		if (strcmp(w->name, APLL1_W_NAME) == 0)
			mt6897_apll1_enable(afe);
		else
			mt6897_apll2_enable(afe);
		break;
	case SND_SOC_DAPM_POST_PMD:
		if (strcmp(w->name, APLL1_W_NAME) == 0)
			mt6897_apll1_disable(afe);
		else
			mt6897_apll2_disable(afe);
		break;
	default:
		break;
	}
			     ...
			     int event)
{
	...
	switch (event) {
	case SND_SOC_DAPM_PRE_PMU:
		mt6897_mck_enable(afe, i2s_priv->mclk_id, i2s_priv->mclk_rate);
		break;
	case SND_SOC_DAPM_POST_PMD:
		i2s_priv->mclk_rate = 0;
		mt6897_mck_disable(afe, i2s_priv->mclk_id);
		break;
	default:
		break;
	}
				    ...
				    struct snd_soc_dapm_widget *sink)
{
	...
	/* which apll */
	cur_apll = mt6897_get_apll_by_name(afe, source->name);

	/* choose APLL from i2s rate */
	i2s_need_apll = mt6897_get_apll_by_rate(afe, i2s_priv->rate);
...
static const struct snd_soc_dapm_route mtk_dai_i2s_routes[] = {
	...
	{"I2SOUT0_CH1", "ADDA_UL_CH2", "ADDA_UL_Mux"},
	{"I2SOUT0_CH2", "ADDA_UL_CH2", "ADDA_UL_Mux"},
	{"I2SOUT0_CH1", "ADDA_UL_CH3", "ADDA_CH34_UL_Mux"},
	{"I2SOUT0_CH2", "ADDA_UL_CH3", "ADDA_CH34_UL_Mux"},
	...
	{"I2SOUT1_CH1", "DL24_CH1", "DL24"},
	{"I2SOUT1_CH2", "DL24_CH2", "DL24"},
	...
	{"I2SOUT2_CH1", "DL24_CH1", "DL24"},
	{"I2SOUT2_CH2", "DL24_CH2", "DL24"},
		...
		struct snd_soc_dai *dai)
{
	...
	unsigned int rate_reg = mt6897_rate_transform(afe->dev,
				rate, dai->id);
				  ...
				  int clk_id, unsigned int freq, int dir)
{
	...
	apll = mt6897_get_apll_by_rate(afe, freq);
	apll_rate = mt6897_get_apll_rate(afe, apll);
...
static const struct mtk_afe_i2s_priv mt6897_i2s_priv[DAI_I2S_NUM] = {
	[DAI_I2SIN0] = {
		.id = MT6897_DAI_I2S_IN0,
		.mclk_id = MT6897_I2SIN0_MCK,
		.share_property_name = "i2sin0-share",
		.share_i2s_id = -1,
	},
	[DAI_I2SIN1] = {
		.id = MT6897_DAI_I2S_IN1,
		.mclk_id = MT6897_I2SIN1_MCK,
	...
	[DAI_I2SOUT0] = {
		...
		.share_i2s_id = MT6897_DAI_I2S_IN0,
	},
	[DAI_I2SOUT1] = {
		.id = MT6897_DAI_I2S_OUT1,
		.mclk_id = MT6897_I2SIN1_MCK,
		.share_property_name = "i2sout1-share",
		.share_i2s_id = MT6897_DAI_I2S_IN1,
	},
	[DAI_I2SOUT2] = {
		.id = MT6897_DAI_I2S_OUT2,
		.mclk_id = MT6897_I2SIN0_MCK,
		.share_property_name = "i2sout2-share",
		.share_i2s_id = MT6897_DAI_I2S_IN2,
	},
	[DAI_I2SOUT4] = {
		.id = MT6897_DAI_I2S_OUT4,
		.mclk_id = MT6897_I2SIN0_MCK,
		.share_property_name = "i2sout4-share",
		.share_i2s_id = MT6897_DAI_I2S_IN4,
	},
	[DAI_I2SOUT6] = {
		.id = MT6897_DAI_I2S_OUT6,
		.mclk_id = MT6897_I2SIN0_MCK,
		.share_property_name = "i2sout6-share",
		.share_i2s_id = MT6897_DAI_I2S_IN6,
	},
	[DAI_FMI2S_MASTER] = {
		.id = MT6897_DAI_FM_I2S_MASTER,
		.mclk_id = MT6897_FMI2S_MCK,
...
int mt6897_dai_i2s_get_share(struct mtk_base_afe *afe)
{
	struct mt6897_afe_private *afe_priv = afe->platform_priv;
	...
	for (i = 0; i < DAI_I2S_NUM; i++) {
		i2s_priv = afe_priv->dai_priv[mt6897_i2s_priv[i].id];
		property_name = mt6897_i2s_priv[i].share_property_name;
...
int mt6897_dai_i2s_set_priv(struct mtk_base_afe *afe)
{
	int i;
	int ret;

	for (i = 0; i < DAI_I2S_NUM; i++) {
		ret = mt6897_dai_set_priv(afe, mt6897_i2s_priv[i].id,
...
int mt6897_dai_i2s_register(struct mtk_base_afe *afe)
{
	...
	ret = mt6897_dai_i2s_set_priv(afe);
	if (ret)
		return ret;

	/* parse share i2s */
	ret = mt6897_dai_i2s_get_share(afe);
	if (ret)
		return ret;
