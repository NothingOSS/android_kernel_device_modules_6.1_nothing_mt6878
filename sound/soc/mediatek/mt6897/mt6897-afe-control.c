				   ...
				   unsigned int rate, int aud_blk)
{
	...
	default:
		return mt6897_general_rate_transform(dev, rate);
	}
}
...
EXPORT_SYMBOL(mt6897_enable_dc_compensation);
...
EXPORT_SYMBOL(mt6897_set_lch_dc_compensation);
...
EXPORT_SYMBOL(mt6897_set_rch_dc_compensation);
...
int mt6897_adda_dl_gain_control(bool mute)
{
	...
	regmap_update_bits(local_afe->regmap,
			   ...
			   AFE_DL_GAIN_CTL_PRE_MASK_SFT,
			   dl_gain_ctl << AFE_DL_GAIN_CTL_PRE_SFT);
...
EXPORT_SYMBOL(mt6897_adda_dl_gain_control);
