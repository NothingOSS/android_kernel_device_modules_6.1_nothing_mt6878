...
static int mt6897_gain0_get(struct snd_kcontrol *kcontrol,
...
static int mt6897_gain0_set(struct snd_kcontrol *kcontrol,
			       struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6897_gain1_get(struct snd_kcontrol *kcontrol,
			    struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6897_gain1_set(struct snd_kcontrol *kcontrol,
			    struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static const struct snd_kcontrol_new mtk_hw_gain_controls[] = {
	SOC_SINGLE_EXT("HW Gain 1", SND_SOC_NOPM, 0, 0xffffffff, 0,
		       mt6897_gain0_get, mt6897_gain0_set),
	SOC_SINGLE_EXT("HW Gain 2", SND_SOC_NOPM, 0, 0xffffffff, 0,
		       mt6897_gain1_get, mt6897_gain1_set),
