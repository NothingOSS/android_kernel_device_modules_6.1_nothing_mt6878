...
static const unsigned int src_iir_coeff_48_to_16[] = {
	0x06938cc3, 0xf96c0f9a, 0x06938cc3, 0x25aaa42c, 0xe06d6c44, 0x00000002,
	0x0bfecb02, 0xf46363ad, 0x0bfecb02, 0x25ddb9d0, 0xe16052cd, 0x00000002,
	0x0a316723, 0xf6eaa0a4, 0x0a316723, 0x26c35a9a, 0xe2a1c792, 0x00000002,
	0x0797fe74, 0xfa666f40, 0x0797fe74, 0x286e27bd, 0xe464fff4, 0x00000002,
	0x092c9581, 0xfc026133, 0x092c9581, 0x2ae28885, 0xe6c1eb45, 0x00000002,
	0x040097cb, 0x00a8d209, 0x040097cb, 0x2dd59b5f, 0xe9806302, 0x00000002,
	0x0124f372, 0x0164a358, 0x0124f372, 0x306e7b9f, 0xebe2fa25, 0x00000002,
	0x00000000, 0x39211a5c, 0x39211a5c, 0x0c5fc5b9, 0x00000000, 0x00000003
};
				  ...
				  struct snd_soc_dapm_widget *sink)
{
	...
	if (strcmp(w->name, HW_SRC_0_EN_W_NAME) == 0)
		src_priv = afe_priv->dai_priv[MT6897_DAI_SRC_0];
	else if (strcmp(w->name, HW_SRC_1_EN_W_NAME) == 0)
		src_priv = afe_priv->dai_priv[MT6897_DAI_SRC_1];
	else if (strcmp(w->name, HW_SRC_2_EN_W_NAME) == 0)
		src_priv = afe_priv->dai_priv[MT6897_DAI_SRC_2];
	else
		src_priv = afe_priv->dai_priv[MT6897_DAI_SRC_3];
				     ...
				     struct snd_soc_dapm_widget *sink)
{
	...
	need_apll = mt6897_get_apll_by_rate(afe, src_priv->ul_rate);
...
int mt6897_dai_src_register(struct mtk_base_afe *afe)
{
	...
	/* set dai priv */
	ret = mt6897_dai_set_priv(afe, MT6897_DAI_SRC_0,
				  sizeof(struct mtk_afe_src_priv), NULL);
	if (ret)
		return ret;

	ret = mt6897_dai_set_priv(afe, MT6897_DAI_SRC_1,
				  sizeof(struct mtk_afe_src_priv), NULL);
	if (ret)
		return ret;

	ret = mt6897_dai_set_priv(afe, MT6897_DAI_SRC_2,
				  sizeof(struct mtk_afe_src_priv), NULL);
	if (ret)
		return ret;

	ret = mt6897_dai_set_priv(afe, MT6897_DAI_SRC_3,
				  sizeof(struct mtk_afe_src_priv), NULL);
	if (ret)
		return ret;
