...
EXPORT_SYMBOL_GPL(mt6878_set_cm_rate);
static int mt6878_convert_cm_ch(unsigned int ch)
{
	return ch - 1;
}

int mt6878_set_cm(struct mtk_base_afe *afe, int id,
...
EXPORT_SYMBOL_GPL(mt6878_set_cm);
...
EXPORT_SYMBOL_GPL(mt6878_enable_cm_bypass);
...
EXPORT_SYMBOL_GPL(mt6878_enable_cm);
...
EXPORT_SYMBOL_GPL(mt6878_is_need_enable_cm);
