...
/*
 *  mt6878-afe-clk.c  --  Mediatek 6878 afe clock ctrl
 *
...
int mt6878_init_clock(struct mtk_base_afe *afe) { return 0; }
int mt6878_afe_enable_clock(struct mtk_base_afe *afe) { return 0; }
void mt6878_afe_disable_clock(struct mtk_base_afe *afe) {}
int mt6878_afe_sram_request(struct mtk_base_afe *afe) { return 0; }
void mt6878_afe_sram_release(struct mtk_base_afe *afe) {}
int mt6878_afe_dram_request(struct device *dev) { return 0; }
int mt6878_afe_dram_release(struct device *dev) { return 0; }
int mt6878_apll1_enable(struct mtk_base_afe *afe) { return 0; }
void mt6878_apll1_disable(struct mtk_base_afe *afe) {}
int mt6878_apll2_enable(struct mtk_base_afe *afe) { return 0; }
void mt6878_apll2_disable(struct mtk_base_afe *afe) {}
int mt6878_get_apll_rate(struct mtk_base_afe *afe, int apll) { return 0; }
int mt6878_get_apll_by_rate(struct mtk_base_afe *afe, int rate) { return 0; }
int mt6878_get_apll_by_name(struct mtk_base_afe *afe, const char *name) { return 0; }
int mt6878_mck_enable(struct mtk_base_afe *afe, int mck_id, int rate) { return 0; }
int mt6878_mck_disable(struct mtk_base_afe *afe, int mck_id) { return 0; }
int mt6878_set_audio_int_bus_parent(struct mtk_base_afe *afe, int clk_id) { return 0; }
#else
...
int mt6878_set_audio_int_bus_parent(struct mtk_base_afe *afe,
				    int clk_id)
{
...
int mt6878_set_audio_h_parent(struct mtk_base_afe *afe,
				    int clk_id)
{
	struct mt6878_afe_private *afe_priv = afe->platform_priv;
	int ret = 0;
...
static int apll1_mux_setting(struct mtk_base_afe *afe, bool enable)
{
	...
	if (enable) {
		...
		mt6878_set_audio_h_parent(afe, CLK_TOP_APLL1_D2);
	} else {
		ret = clk_set_parent(afe_priv->clk[CLK_TOP_MUX_AUD_ENG1],
...
static int apll2_mux_setting(struct mtk_base_afe *afe, bool enable)
{
	...
	if (enable) {
		...
		mt6878_set_audio_h_parent(afe, CLK_TOP_APLL2_D2);
	} else {
		ret = clk_set_parent(afe_priv->clk[CLK_TOP_MUX_AUD_ENG2],
				     afe_priv->clk[CLK_CLK26M]);
		if (ret) {
...
int mt6878_afe_enable_ao_clock(struct mtk_base_afe *afe)
{
	struct mt6878_afe_private *afe_priv = afe->platform_priv;
	int ret = 0;
...
int mt6878_afe_apll_init(struct mtk_base_afe *afe)
{
	struct mt6878_afe_private *afe_priv = afe->platform_priv;
...
int mt6878_afe_enable_clock(struct mtk_base_afe *afe)
{
	struct mt6878_afe_private *afe_priv = afe->platform_priv;
	int ret = 0;
...
int mt6878_afe_dram_request(struct device *dev)
{
...
int mt6878_afe_dram_release(struct device *dev)
{
	struct mtk_base_afe *afe = dev_get_drvdata(dev);
	struct mt6878_afe_private *afe_priv = afe->platform_priv;
#if !defined(SKIP_SMCC_SB)
...
int mt6878_afe_sram_request(struct mtk_base_afe *afe)
{
	struct arm_smccc_res res;
...
int mt6878_apll1_enable(struct mtk_base_afe *afe)
{
	struct mt6878_afe_private *afe_priv = afe->platform_priv;
	int ret;
...
int mt6878_apll2_enable(struct mtk_base_afe *afe)
{
	struct mt6878_afe_private *afe_priv = afe->platform_priv;
	int ret;
...
int mt6878_get_apll_rate(struct mtk_base_afe *afe, int apll)
{
	return (apll == MT6878_APLL1) ? 180633600 : 196608000;
}

int mt6878_get_apll_by_rate(struct mtk_base_afe *afe, int rate)
{
	return ((rate % 8000) == 0) ? MT6878_APLL2 : MT6878_APLL1;
}

int mt6878_get_apll_by_name(struct mtk_base_afe *afe, const char *name)
{
...
static const struct mt6878_mck_div mck_div[MT6878_MCK_NUM] = {
	[MT6878_I2SIN0_MCK] = {
...
int mt6878_mck_enable(struct mtk_base_afe *afe, int mck_id, int rate)
{
	struct mt6878_afe_private *afe_priv = afe->platform_priv;
	int apll = mt6878_get_apll_by_rate(afe, rate);
	int apll_clk_id = apll == MT6878_APLL1 ?
...
int mt6878_mck_disable(struct mtk_base_afe *afe, int mck_id)
{
	struct mt6878_afe_private *afe_priv = afe->platform_priv;
	int m_sel_id = 0;
	int div_clk_id = 0;
...
int mt6878_init_clock(struct mtk_base_afe *afe)
{
	struct mt6878_afe_private *afe_priv = afe->platform_priv;
	int i = 0;
	...
	mt6878_afe_apll_init(afe);
	mt6878_afe_enable_ao_clock(afe);
	return 0;
}
#endif
