...
/*
 * mt6985-afe-clk.h  --  Mediatek 6985 afe clock ctrl definition
 *
 * Copyright (c) 2021 MediaTek Inc.
 * Author: Ting-Fang Hou <Ting-Fang.Hou@mediatek.com>
 */

#ifndef _MT6985_AFE_CLOCK_CTRL_H_
#define _MT6985_AFE_CLOCK_CTRL_H_
...
#define APLL12_DIV_ETDM_IN1_PDN_SFT        11
#define APLL12_DIV_ETDM_IN1_PDN_MASK       0x1
#define APLL12_DIV_ETDM_IN1_PDN_MASK_SFT   (0x1 << 11)
#define APLL12_DIV_ETDM_OUT1_PDN_SFT       12
#define APLL12_DIV_ETDM_OUT1_PDN_MASK      0x1
#define APLL12_DIV_ETDM_OUT1_PDN_MASK_SFT  (0x1 << 12)
...
#define APLL_I2S8_MCK_SEL_MASK             0xf
#define APLL_I2S8_MCK_SEL_MASK_SFT         (0xf << 24)
#define APLL_I2S9_MCK_SEL_SFT              25
#define APLL_I2S9_MCK_SEL_MASK             0xf
#define APLL_I2S9_MCK_SEL_MASK_SFT         (0xf << 25)
#define APLL_ETDM_IN1_MCK_SEL_SFT          26
#define APLL_ETDM_IN1_MCK_SEL_MASK         0x1
#define APLL_ETDM_IN1_MCK_SEL_MASK_SFT     (0x1 << 26)
#define APLL_ETDM_OUT1_MCK_SEL_SFT         27
#define APLL_ETDM_OUT1_MCK_SEL_MASK        0x1
#define APLL_ETDM_OUT1_MCK_SEL_MASK_SFT    (0x1 << 27)
...
#define APLL12_DIV6_INV_SFT                7
#define APLL12_DIV6_INV_MASK               0x1
#define APLL12_DIV6_INV_MASK_SFT           (0x1 << 7)
#define APLL12_DIV7_INV_SFT                8
#define APLL12_DIV7_INV_MASK               0x1
#define APLL12_DIV7_INV_MASK_SFT           (0x1 << 8)
#define APLL12_DIV8_INV_SFT                9
#define APLL12_DIV8_INV_MASK               0x1
#define APLL12_DIV8_INV_MASK_SFT           (0x1 << 9)
#define APLL12_DIV9_INV_SFT                10
#define APLL12_DIV9_INV_MASK               0x1
#define APLL12_DIV9_INV_MASK_SFT           (0x1 << 10)
#define APLL12_DIV_ETDM_IN1_INV_SFT        11
#define APLL12_DIV_ETDM_IN1_INV_MASK       0x1
#define APLL12_DIV_ETDM_IN1_INV_MASK_SFT   (0x1 << 11)
#define APLL12_DIV_ETDM_OUT1_INV_SFT       12
#define APLL12_DIV_ETDM_OUT1_INV_MASK      0x1
#define APLL12_DIV_ETDM_OUT1_INV_MASK_SFT  (0x1 << 12)
...
#define APLL12_CK_DIV_ETDM_IN1_SFT         24
#define APLL12_CK_DIV_ETDM_IN1_MASK        0xff
#define APLL12_CK_DIV_ETDM_IN1_MASK_SFT    (0xff << 0)
