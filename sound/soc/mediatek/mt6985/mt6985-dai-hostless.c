...
static const struct snd_pcm_hardware mt6985_hostless_hardware = {
...
static const struct snd_soc_dapm_route mtk_dai_hostless_routes[] = {
	...
	{"PCM_2_PB_CH1", "HW_SRC_1_OUT_CH1", "Hostless_HW_SRC_1_IN_DL"},
	{"PCM_2_PB_CH2", "HW_SRC_1_OUT_CH2", "Hostless_HW_SRC_1_IN_DL"},
	...
	{"PCM_2_PB_CH1", "I2S8_CH1", "Hostless Speech DL"},
	{"PCM_2_PB_CH2", "I2S8_CH2", "Hostless Speech DL"},

	{"Hostless Speech UL", NULL, "PCM 1 Capture"},
	{"Hostless Speech UL", NULL, "PCM 2 Capture"},
	{"Hostless_HW_SRC_3_OUT_UL", NULL, "PCM 2 Capture"},
	{"Hostless Speech UL", NULL, "ADDA_UL_Mux"},
	{"Hostless_HW_SRC_1_OUT_UL", NULL, "ADDA_UL_Mux"},
	{"Hostless Speech UL", NULL, "ADDA_CH34_UL_Mux"},
	{"Hostless Speech UL", NULL, "I2S0"},
	{"Hostless Speech UL", NULL, "I2S8"},
	...
	{"HW_SRC_3_IN_CH1", "DL11_CH1", "Hostless_SRC_3_DL"},
	{"HW_SRC_3_IN_CH2", "DL11_CH2", "Hostless_SRC_3_DL"},
	...
	{"HW_SRC_3_IN_CH1", "PCM_2_CAP_CH1", "Hostless_HW_SRC_3_OUT_DL"},
	{"HW_SRC_3_IN_CH2", "PCM_2_CAP_CH1", "Hostless_HW_SRC_3_OUT_DL"},
	{"HW_SRC_3_IN_CH1", "DL1_CH1", "Hostless_HW_SRC_3_OUT_DL"},
	{"HW_SRC_3_IN_CH2", "DL1_CH2", "Hostless_HW_SRC_3_OUT_DL"},
	{"HW_SRC_3_IN_CH1", "DL4_CH1", "Hostless_HW_SRC_3_OUT_DL"},
				    ...
				    struct snd_soc_dai *dai)
{
	...
	snd_soc_set_runtime_hwparams(substream, &mt6985_hostless_hardware);
...
static struct snd_soc_dai_driver mtk_dai_hostless_driver[] = {
	...
	},
	{
		...
		.id = MT6985_DAI_HOSTLESS_SPH_ECHO_REF,
		.playback = {
	...
	},
	{
		...
		.id = MT6985_DAI_HOSTLESS_SPK_INIT,
		.playback = {
	...
	},
	{
		...
		.id = MT6985_DAI_HOSTLESS_IMPEDANCE,
		.playback = {
	...
	},
	{
		...
		.id = MT6985_DAI_HOSTLESS_HW_SRC_1_OUT,
		.playback = {
	...
	},
	{
		...
		.id = MT6985_DAI_HOSTLESS_HW_SRC_1_IN,
		.playback = {
	...
	},
	{
		...
		.id = MT6985_DAI_HOSTLESS_HW_SRC_2_OUT,
		.playback = {
	...
	},
	{
		...
		.id = MT6985_DAI_HOSTLESS_HW_SRC_2_IN,
		.playback = {
	...
	{
		.name = "Hostless_HW_SRC_3_OUT_DAI",
		.id = MT6985_DAI_HOSTLESS_HW_SRC_3_OUT,
		.playback = {
			.stream_name = "Hostless_HW_SRC_3_OUT_DL",
			.channels_min = 1,
			.channels_max = 2,
			.rates = MTK_HOSTLESS_RATES,
			.formats = MTK_HOSTLESS_FORMATS,
		...
		.capture = {
			.stream_name = "Hostless_HW_SRC_3_OUT_UL",
			.channels_min = 1,
			.channels_max = 2,
			.rates = MTK_HOSTLESS_RATES,
			.formats = MTK_HOSTLESS_FORMATS,
	...
	{
		.name = "Hostless_HW_SRC_3_IN_DAI",
		.id = MT6985_DAI_HOSTLESS_HW_SRC_3_IN,
		.playback = {
			.stream_name = "Hostless_HW_SRC_3_IN_DL",
			.channels_min = 1,
			.channels_max = 2,
			.rates = MTK_HOSTLESS_RATES,
			.formats = MTK_HOSTLESS_FORMATS,
		...
		.capture = {
			.stream_name = "Hostless_HW_SRC_3_IN_UL",
			.channels_min = 1,
			.channels_max = 2,
			.rates = MTK_HOSTLESS_RATES,
			.formats = MTK_HOSTLESS_FORMATS,
	...
	},
	{
		...
		.id = MT6985_DAI_HOSTLESS_SRC_BARGEIN,
		.playback = {
	...
	},
	{
		...
		.id = MT6985_DAI_HOSTLESS_HW_GAIN_AAUDIO,
		.capture = {
	...
	},
	{
		...
		.id = MT6985_DAI_HOSTLESS_SRC_AAUDIO,
		.playback = {
